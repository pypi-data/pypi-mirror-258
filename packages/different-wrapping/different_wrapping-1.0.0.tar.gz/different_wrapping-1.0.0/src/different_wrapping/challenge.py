...
class Challenge:
    def __init__(self, path: Path):
        ...
        if compose.exists():
            ...
            self._read_containers(compose)

    def _read_containers(self, compose_file):
