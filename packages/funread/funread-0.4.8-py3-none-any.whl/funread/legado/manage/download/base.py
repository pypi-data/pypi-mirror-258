...
class DownloadSource(object):
    def __init__(self, path='./funread-hub', cate1='book', *args, **kwargs):
        ...
        self.pkl_url = f".{path}/{cate1}/pkl/url_info.pkl.bz2"
        self.pkl_md5 = f'{path}/{cate1}/pkl/source_info.pkl.bz2'
        ...
        funos.makedirs(os.path.dirname(self.pkl_url))
    ...
    def loads(self):
        ...
        if os.path.exists(self.pkl_md5):
            ...
            self.md5_set = {info['md5']: info for info in json.loads(df.to_dict(orient='records'))}
