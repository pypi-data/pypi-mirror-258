...
@jsii.data_type(
    jsii_type="@aws/pdk.monorepo.Syncpack.GroupConfig",
    jsii_struct_bases=[],
    name_mapping={
...
class GroupConfig:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__1e7c4a00327620935f63cdfea9bfa99a32514a85364f096d6b2ef17916bafc8f)
...
def _typecheckingstub__1e7c4a00327620935f63cdfea9bfa99a32514a85364f096d6b2ef17916bafc8f(
    *,
    dependencies: typing.Optional[typing.Sequence[builtins.str]] = None,
    dependency_types: typing.Optional[typing.Sequence[builtins.str]] = None,
    label: typing.Optional[builtins.str] = None,
