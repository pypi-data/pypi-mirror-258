...
from .. import GroupConfig as _GroupConfig_02dd2fba


@jsii.data_type(
    jsii_type="@aws/pdk.monorepo.Syncpack.VersionGroupConfig.Banned",
    jsii_struct_bases=[_GroupConfig_02dd2fba],
    name_mapping={
...
class Banned(_GroupConfig_02dd2fba):
    def __init__(
        self,
        *,
...
class Ignored(_GroupConfig_02dd2fba):
    def __init__(
        self,
        *,
        dependencies: typing.Optional[typing.Sequence[builtins.str]] = None,
...
class Pinned(_GroupConfig_02dd2fba):
    def __init__(
        self,
        *,
        dependencies: typing.Optional[typing.Sequence[builtins.str]] = None,
...
class SameRange(_GroupConfig_02dd2fba):
    def __init__(
        self,
        *,
        dependencies: typing.Optional[typing.Sequence[builtins.str]] = None,
...
class SnappedTo(_GroupConfig_02dd2fba):
    def __init__(
        self,
        *,
        dependencies: typing.Optional[typing.Sequence[builtins.str]] = None,
...
class Standard(_GroupConfig_02dd2fba):
    def __init__(
        self,
        *,
        dependencies: typing.Optional[typing.Sequence[builtins.str]] = None,
