...
class BaseApi(api_client.Api):
    ...
    def _login_cloud_oapg(
        ...
        """
        Creates a new API work-session. <p>By default, API sessions last 6 minutes before expiring. Performing any authenticated operation will reset the expiry</p> </br> <p><em><b>Note:</b></em> The session created by this API Endpoint is unrelated to the Infinity Portal session conveyed via the 'cloudinfrJwt' bearer token</p> <p>To manually reset the expiry without performing any meaningful operations see the 'keepalive' operation</p>
