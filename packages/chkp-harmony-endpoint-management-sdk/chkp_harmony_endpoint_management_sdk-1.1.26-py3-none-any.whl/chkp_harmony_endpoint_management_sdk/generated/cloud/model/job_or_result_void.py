...
class JobOrResultVoid(
    ...
    Either an object containing a Job ID *OR* schema 'void'
...
<p>When set to '<em>OFF</em>', operations will run synchronously and return a concrete response of type <em>void</em></p>
    """
