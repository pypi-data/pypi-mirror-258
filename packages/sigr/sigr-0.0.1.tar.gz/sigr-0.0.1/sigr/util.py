...
def decorated_format_from_func(
    fn: Callable | None = None, *args, __format: DecoratedFormat = DecoratedFormat.decorated, **kwargs: P.kwargs
) -> DecoratedFormat:
    __format = kwargs.get('__format', __format)
    if fn is None: 
        __format = DecoratedFormat.decorator
    elif callable(fn): 
        __format = DecoratedFormat.called
    else: 
        __format = DecoratedFormat.error
    return __format
