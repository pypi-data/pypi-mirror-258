...
class KernelServiceApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.kernel_service_interrupt_kernel_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [],
                'endpoint_path': '/v1/{name}:interrupt',
                'operation_id': 'kernel_service_interrupt_kernel',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def kernel_service_create_kernel(
        ...
        **kwargs
        ...
        >>> thread = api.kernel_service_create_kernel(kernel, async_req=True)
        >>> result = thread.get()
    ...
    def kernel_service_delete_kernel(
        ...
        **kwargs
        ...
        Args:
            name_1 (str): Required. Kernel resource name. Format: kernels/{kernel}

        Keyword Args:
            allow_missing (bool): Optional. When set and the Kernel is not found, the request will succeed but no changes are made.. [optional]
    ...
    def kernel_service_get_kernel(
        ...
        **kwargs
        ...
        Args:
            name_1 (str): Required. The name of the Kernel to retrieve. Format: `kernels/{kernel}`
    ...
    def kernel_service_interrupt_kernel(
        self,
        name,
        body,
        **kwargs
    ):
        """Interrupt a Kernel. Interrupts the execution of the Kernel.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.kernel_service_interrupt_kernel(name, body, async_req=True)
        >>> result = thread.get()

        Args:
            name (str): Required. Kernel resource name. Format: kernels/{kernel}
        ...
        kwargs['body'] = \
            body
        return self.kernel_service_interrupt_kernel_endpoint.call_with_http_info(**kwargs)
    ...
    def kernel_service_list_kernels(
        ...
        **kwargs
        ...
        Keyword Args:
            ...
            order_by (str): Optional. Used to specify the sorting order.  When unset, Kernels are ordered by their time of creation in descending order. This is equivalent to \"create_time desc\".  When specified, the value must be a comma separated list of supported fields. The supported fields are: - TODO: name - TODO: image - TODO: template - TODO: notebook_kernel_spec - TODO: creator - TODO: creator_display_name - TODO: task_queue_size - TODO: last_activity_time - TODO: create_time  The default sorting order is ascending. For example: \"name\" and \"name asc\" are equivalent values.  To specify descending order for a field, append a \" desc\" suffix. For example: \"name desc\".  Redundant space characters are insignificant. For example these values are all equal: - \"  name, cpu     desc\" - \"name, cpu desc\" - \"name   , cpu desc   \"  Undefined (empty) time is interpreted as a zero time (0s since epoch, i.e. 1970-01-01T00:00:00Z).  Undefined (empty) duration is interpreted as a zero duration (0 seconds).. [optional]
            filter (str): Optional. Used to filter Kernels. When unset, no filtering is applied.  Filtering implements specification https://google.aip.dev/160.  Supported filter fields: - TODO: name - TODO: kernel_id - TODO: image - TODO: template - TODO: notebook_kernel_spec - TODO: creator - TODO: creator_display_name - TODO: state - TODO: type - TODO: task_queue_size - TODO: last_activity_time - TODO: create_time  Examples: - TODO: Examples. [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
