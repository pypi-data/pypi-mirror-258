...
class System(ABC):
    ...
    def create_entity(self, components: list[Component]) -> Entity:
        '''
        Creates and entity given it's components. This will go through the EcsAdmin to ensure component pools are updated.

        Args:
            components (list[Component]): a list of components that will be attached to the entity

        Returns:
            The New Entity instance with attached components.
        '''
