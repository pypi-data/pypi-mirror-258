...
import smbprotocol_legacy.create_contexts
import smbprotocol_legacy.query_info
from smbprotocol_legacy.exceptions import SMBException, SMBResponseException, \
    SMBUnsupportedFeature
from smbprotocol_legacy.structure import BytesField, DateTimeField, EnumField, \
    FlagField, IntField, ListField, Structure, StructureField
from smbprotocol_legacy.connection import Commands, Dialects, NtStatus
...
class SMB2CreateRequest(Structure):
    ...
    def __init__(self):
        ...
        create_con_req = smbprotocol_legacy.create_contexts.SMB2CreateContextRequest
    ...
    def _buffer_context_list(self, structure, data):
        ...
        while not last_context:
            create_context = \
                smbprotocol_legacy.create_contexts.SMB2CreateContextRequest()
...
class SMB2QueryDirectoryRequest(Structure):
    ...
    def unpack_response(file_information_class, buffer):
        ...
        """
        structs = smbprotocol_legacy.query_info
        resp_structure = {
...
class Open(object):
    ...
    def create(self, impersonation_level, desired_access, file_attributes,
        ...
        if create_contexts:
            create['buffer_contexts'] = smbprotocol_legacy.create_contexts.\
