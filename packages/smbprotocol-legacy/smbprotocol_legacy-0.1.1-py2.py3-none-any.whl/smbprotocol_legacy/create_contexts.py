...
import smbprotocol_legacy.open
from smbprotocol_legacy.structure import BoolField, BytesField, DateTimeField, \
    ...
    def __init__(self):
        self.fields = OrderedDict([
            ('query_status', EnumField(
                size=4,
                enum_type=smbprotocol_legacy.connection.NtStatus,
                enum_strict=False
            )),
