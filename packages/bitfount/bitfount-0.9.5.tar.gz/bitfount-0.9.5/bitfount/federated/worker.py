...
class _Worker:
    ...
    async def run(self) -> None:
        ...
        if self._pod_db_connector is not None:
            ...
            elif isinstance(self.datasource, _DataViewFromFileIterableSource):
                update_pod_db(
                    pod_name=self.parent_pod_identifier.split("/")[1],
                    connector=self._pod_db_connector,
        ...
        try:
            ...
            await worker_protocol.run(
                ...
                hook_kwargs={
                    ...
                    "db_con": self._get_project_db_con_if_allowed(protocol),
                    "table": table,
                },
            )
