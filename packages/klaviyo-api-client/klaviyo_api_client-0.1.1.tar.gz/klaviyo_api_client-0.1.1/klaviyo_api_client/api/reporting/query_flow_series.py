...
from ...models.flow_series_request_dto import FlowSeriesRequestDTO
from ...models.post_flow_series_response_dto import PostFlowSeriesResponseDTO
...
) -> Optional[Union[Any, PostFlowSeriesResponseDTO]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = PostFlowSeriesResponseDTO.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, PostFlowSeriesResponseDTO]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Query Flow Series
     ...
     Returns the requested flow analytics series data<br><br>*Rate limits*:<br>Burst: `1/s`<br>Steady:
    `2/m`<br>Daily: `225/d`
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, PostFlowSeriesResponseDTO]
    """
