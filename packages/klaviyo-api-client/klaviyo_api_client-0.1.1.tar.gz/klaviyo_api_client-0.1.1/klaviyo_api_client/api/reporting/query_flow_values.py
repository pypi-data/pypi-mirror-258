...
from ...models.flow_values_request_dto import FlowValuesRequestDTO
from ...models.post_flow_values_response_dto import PostFlowValuesResponseDTO
...
) -> Optional[Union[Any, PostFlowValuesResponseDTO]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = PostFlowValuesResponseDTO.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, PostFlowValuesResponseDTO]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Query Flow Values
     ...
     Returns the requested flow analytics values data<br><br>*Rate limits*:<br>Burst: `1/s`<br>Steady:
    `2/m`<br>Daily: `225/d`
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, PostFlowValuesResponseDTO]
    """
