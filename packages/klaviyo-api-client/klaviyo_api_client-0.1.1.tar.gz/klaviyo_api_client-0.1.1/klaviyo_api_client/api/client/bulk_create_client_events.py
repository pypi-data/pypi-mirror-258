...
from ...models.events_bulk_create_query import EventsBulkCreateQuery
...
def sync_detailed(
    *,
    ...
    Accepts a maximum of `1000` events per request.<br><br>*Rate limits*:<br>Burst: `10/s`<br>Steady:
    `150/m`
