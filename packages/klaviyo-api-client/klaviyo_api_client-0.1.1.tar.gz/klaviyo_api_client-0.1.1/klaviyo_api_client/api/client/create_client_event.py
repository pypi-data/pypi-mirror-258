...
from ...models.event_create_query_v2 import EventCreateQueryV2
...
def sync_detailed(
    *,
    ...
    environments only. To create events from server-based applications, please use [POST
    /api/events](https://developers.klaviyo.com/en/reference/create_event)<br><br>*Rate
