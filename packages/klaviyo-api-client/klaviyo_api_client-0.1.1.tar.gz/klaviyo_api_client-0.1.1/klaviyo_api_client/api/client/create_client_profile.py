...
from ...models.onsite_profile_create_query import OnsiteProfileCreateQuery
...
def sync_detailed(
    *,
    ...
    environments only. To create profiles from server applications (e.g. custom server-side scripts /
    applications), please use [POST
    /api/profiles](https://developers.klaviyo.com/en/reference/create_profile)<br><br>*Rate
