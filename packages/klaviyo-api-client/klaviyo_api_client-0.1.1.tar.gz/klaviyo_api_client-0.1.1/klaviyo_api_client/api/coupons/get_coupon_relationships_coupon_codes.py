...
from ...models.get_coupon_code_relationship_coupon_response import GetCouponCodeRelationshipCouponResponse
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/coupon-codes/{id}/relationships/coupon/",
    }
...
) -> Optional[Union[Any, GetCouponCodeRelationshipCouponResponse]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetCouponCodeRelationshipCouponResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetCouponCodeRelationshipCouponResponse]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Get Coupon Relationships Coupon Codes
     ...
     Gets the coupon relationship associated with the given coupon code id<br><br>*Rate
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, GetCouponCodeRelationshipCouponResponse]
    """
