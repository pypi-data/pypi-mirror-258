...
from ...models.get_coupon_for_coupon_code_fieldscoupon_item import GetCouponForCouponCodeFieldscouponItem
from ...models.get_coupon_response_collection import GetCouponResponseCollection
...
def _get_kwargs(
    id: str,
    *,
    fieldscoupon: Union[Unset, List[GetCouponForCouponCodeFieldscouponItem]] = UNSET,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/coupon-codes/{id}/coupon/",
        "params": params,
    }
...
) -> Optional[Union[Any, GetCouponResponseCollection]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetCouponResponseCollection.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetCouponResponseCollection]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Get Coupon For Coupon Code
     ...
     Gets a list of coupon codes associated with the given coupon id<br><br>*Rate limits*:<br>Burst:
    ...
    **Scopes:**
    ...
    Args:
        id (str):
        fieldscoupon (Union[Unset, List[GetCouponForCouponCodeFieldscouponItem]]):
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, GetCouponResponseCollection]
    """
