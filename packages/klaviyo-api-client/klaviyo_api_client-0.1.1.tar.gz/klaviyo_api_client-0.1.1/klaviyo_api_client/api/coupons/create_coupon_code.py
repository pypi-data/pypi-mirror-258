...
from ...models.coupon_code_create_query import CouponCodeCreateQuery
from ...models.post_coupon_code_response import PostCouponCodeResponse
...
) -> Optional[Union[Any, PostCouponCodeResponse]]:
    if response.status_code == HTTPStatus.CREATED:
        response_201 = PostCouponCodeResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, PostCouponCodeResponse]]:
    return Response(
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, PostCouponCodeResponse]
    """
