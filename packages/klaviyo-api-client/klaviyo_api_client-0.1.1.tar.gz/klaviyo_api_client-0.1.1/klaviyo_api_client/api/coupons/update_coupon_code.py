...
from ...models.coupon_code_update_query import CouponCodeUpdateQuery
from ...models.patch_coupon_code_response import PatchCouponCodeResponse
...
) -> Optional[Union[Any, PatchCouponCodeResponse]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = PatchCouponCodeResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, PatchCouponCodeResponse]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Update Coupon Code
     ...
     Updates a coupon code specified by the given identifier synchronously. We allow updating the
    'status' and
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, PatchCouponCodeResponse]
    """
