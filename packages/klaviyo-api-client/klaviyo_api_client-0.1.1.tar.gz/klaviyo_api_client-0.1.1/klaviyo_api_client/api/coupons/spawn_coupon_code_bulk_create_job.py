...
from ...models.coupon_code_create_job_create_query import CouponCodeCreateJobCreateQuery
from ...models.post_coupon_code_create_job_response import PostCouponCodeCreateJobResponse
...
) -> Optional[Union[Any, PostCouponCodeCreateJobResponse]]:
    if response.status_code == HTTPStatus.ACCEPTED:
        response_202 = PostCouponCodeCreateJobResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, PostCouponCodeCreateJobResponse]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Max number of jobs queued at once we allow for is 100.<br><br>*Rate limits*:<br>Burst:
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, PostCouponCodeCreateJobResponse]
    """
