...
from ...models.coupon_create_query import CouponCreateQuery
from ...models.post_coupon_response import PostCouponResponse
...
) -> Optional[Union[Any, PostCouponResponse]]:
    if response.status_code == HTTPStatus.CREATED:
        response_201 = PostCouponResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, PostCouponResponse]]:
    return Response(
