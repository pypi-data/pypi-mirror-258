...
from ...models.get_coupon_code_response_collection import GetCouponCodeResponseCollection
from ...models.get_coupon_codes_for_coupon_fieldscoupon_code_item import GetCouponCodesForCouponFieldscouponCodeItem
...
def _get_kwargs(
    id: str,
    *,
    fieldscoupon_code: Union[Unset, List[GetCouponCodesForCouponFieldscouponCodeItem]] = UNSET,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/coupons/{id}/coupon-codes/",
        "params": params,
    }
...
) -> Optional[Union[Any, GetCouponCodeResponseCollection]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetCouponCodeResponseCollection.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetCouponCodeResponseCollection]]:
    return Response(
...
def sync_detailed(
    ...
    **Scopes:**
    ...
    Args:
        id (str):
        fieldscoupon_code (Union[Unset, List[GetCouponCodesForCouponFieldscouponCodeItem]]):
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, GetCouponCodeResponseCollection]
    """
