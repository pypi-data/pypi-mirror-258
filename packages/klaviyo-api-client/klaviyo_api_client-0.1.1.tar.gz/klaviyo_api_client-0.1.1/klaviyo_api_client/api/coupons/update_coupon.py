...
from ...models.coupon_update_query import CouponUpdateQuery
from ...models.patch_coupon_response import PatchCouponResponse
...
) -> Optional[Union[Any, PatchCouponResponse]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = PatchCouponResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, PatchCouponResponse]]:
    return Response(
