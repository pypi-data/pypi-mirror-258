...
from ...models.get_coupon_code_response_collection_compound_document import (
    GetCouponCodeResponseCollectionCompoundDocument,
)
from ...models.get_coupon_codes_fieldscoupon_code_item import GetCouponCodesFieldscouponCodeItem
from ...models.get_coupon_codes_fieldscoupon_item import GetCouponCodesFieldscouponItem
from ...models.get_coupon_codes_include_item import GetCouponCodesIncludeItem
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    fieldscoupon_code: Union[Unset, List[GetCouponCodesFieldscouponCodeItem]] = UNSET,
    fieldscoupon: Union[Unset, List[GetCouponCodesFieldscouponItem]] = UNSET,
    filter_: Union[Unset, str] = UNSET,
    include: Union[Unset, List[GetCouponCodesIncludeItem]] = UNSET,
...
) -> Optional[Union[Any, GetCouponCodeResponseCollectionCompoundDocument]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetCouponCodeResponseCollectionCompoundDocument.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetCouponCodeResponseCollectionCompoundDocument]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    A coupon/coupons or a profile/profiles must be provided as required filter params.<br><br>*Rate
    limits*:<br>Burst: `350/s`<br>Steady: `3500/m`

    **Scopes:**
    `coupon-codes:read`

    Args:
        fieldscoupon_code (Union[Unset, List[GetCouponCodesFieldscouponCodeItem]]):
        fieldscoupon (Union[Unset, List[GetCouponCodesFieldscouponItem]]):
        filter_ (Union[Unset, str]):
        include (Union[Unset, List[GetCouponCodesIncludeItem]]):
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, GetCouponCodeResponseCollectionCompoundDocument]
    """
