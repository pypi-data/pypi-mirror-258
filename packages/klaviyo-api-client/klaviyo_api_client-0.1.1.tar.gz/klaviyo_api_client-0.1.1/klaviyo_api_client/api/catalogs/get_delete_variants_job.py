...
from ...models.get_catalog_variant_delete_job_response import GetCatalogVariantDeleteJobResponse
from ...models.get_delete_variants_job_fieldscatalog_variant_bulk_delete_job_item import (
...
def _get_kwargs(
    ...
    *,
    fieldscatalog_variant_bulk_delete_job: Union[
        Unset, List[GetDeleteVariantsJobFieldscatalogVariantBulkDeleteJobItem]
    ] = UNSET,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/catalog-variant-bulk-delete-jobs/{job_id}/",
        "params": params,
    }
...
) -> Optional[Union[Any, GetCatalogVariantDeleteJobResponse]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetCatalogVariantDeleteJobResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetCatalogVariantDeleteJobResponse]]:
    return Response(
    ...
    **Scopes:**
    ...
    Args:
        ...
        fieldscatalog_variant_bulk_delete_job (Union[Unset,
            List[GetDeleteVariantsJobFieldscatalogVariantBulkDeleteJobItem]]):
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, GetCatalogVariantDeleteJobResponse]
    """
