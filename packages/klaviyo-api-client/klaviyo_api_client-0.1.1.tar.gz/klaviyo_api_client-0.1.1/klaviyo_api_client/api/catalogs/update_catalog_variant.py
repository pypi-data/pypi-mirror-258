...
from ...models.catalog_variant_update_query import CatalogVariantUpdateQuery
from ...models.patch_catalog_variant_response import PatchCatalogVariantResponse
...
) -> Optional[Union[Any, PatchCatalogVariantResponse]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = PatchCatalogVariantResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, PatchCatalogVariantResponse]]:
    return Response(
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, PatchCatalogVariantResponse]
    """
