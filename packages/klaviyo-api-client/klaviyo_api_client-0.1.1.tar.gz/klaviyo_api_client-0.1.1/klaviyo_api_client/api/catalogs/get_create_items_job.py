...
from ...models.get_catalog_item_create_job_response_compound_document import (
    GetCatalogItemCreateJobResponseCompoundDocument,
)
from ...models.get_create_items_job_fieldscatalog_item_bulk_create_job_item import (
    GetCreateItemsJobFieldscatalogItemBulkCreateJobItem,
)
from ...models.get_create_items_job_fieldscatalog_item_item import GetCreateItemsJobFieldscatalogItemItem
from ...models.get_create_items_job_include_item import GetCreateItemsJobIncludeItem
...
def _get_kwargs(
    job_id: str,
    *,
    fieldscatalog_item_bulk_create_job: Union[Unset, List[GetCreateItemsJobFieldscatalogItemBulkCreateJobItem]] = UNSET,
    fieldscatalog_item: Union[Unset, List[GetCreateItemsJobFieldscatalogItemItem]] = UNSET,
    include: Union[Unset, List[GetCreateItemsJobIncludeItem]] = UNSET,
    ...
    json_fieldscatalog_item_bulk_create_job: Union[Unset, List[str]] = UNSET
    if not isinstance(fieldscatalog_item_bulk_create_job, Unset):
        json_fieldscatalog_item_bulk_create_job = []
        for fieldscatalog_item_bulk_create_job_item_data in fieldscatalog_item_bulk_create_job:
            fieldscatalog_item_bulk_create_job_item = fieldscatalog_item_bulk_create_job_item_data.value
            json_fieldscatalog_item_bulk_create_job.append(fieldscatalog_item_bulk_create_job_item)

    params["fields[catalog-item-bulk-create-job]"] = json_fieldscatalog_item_bulk_create_job
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/catalog-item-bulk-create-jobs/{job_id}/",
        "params": params,
    }
...
) -> Optional[Union[Any, GetCatalogItemCreateJobResponseCompoundDocument]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetCatalogItemCreateJobResponseCompoundDocument.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetCatalogItemCreateJobResponseCompoundDocument]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    `items`.<br><br>*Rate limits*:<br>Burst: `350/s`<br>Steady: `3500/m`
    ...
    **Scopes:**
    ...
    Args:
        ...
        fieldscatalog_item_bulk_create_job (Union[Unset,
            List[GetCreateItemsJobFieldscatalogItemBulkCreateJobItem]]):
        fieldscatalog_item (Union[Unset, List[GetCreateItemsJobFieldscatalogItemItem]]):
        include (Union[Unset, List[GetCreateItemsJobIncludeItem]]):
    ...
    kwargs = _get_kwargs(
        job_id=job_id,
        fieldscatalog_item_bulk_create_job=fieldscatalog_item_bulk_create_job,
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, GetCatalogItemCreateJobResponseCompoundDocument]
    """
