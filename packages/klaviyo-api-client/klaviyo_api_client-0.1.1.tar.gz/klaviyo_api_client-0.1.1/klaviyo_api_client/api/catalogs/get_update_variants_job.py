...
from ...models.get_catalog_variant_update_job_response_compound_document import (
    GetCatalogVariantUpdateJobResponseCompoundDocument,
)
from ...models.get_update_variants_job_fieldscatalog_variant_bulk_update_job_item import (
    GetUpdateVariantsJobFieldscatalogVariantBulkUpdateJobItem,
)
from ...models.get_update_variants_job_fieldscatalog_variant_item import GetUpdateVariantsJobFieldscatalogVariantItem
from ...models.get_update_variants_job_include_item import GetUpdateVariantsJobIncludeItem
...
def _get_kwargs(
    job_id: str,
    *,
    fieldscatalog_variant_bulk_update_job: Union[
        Unset, List[GetUpdateVariantsJobFieldscatalogVariantBulkUpdateJobItem]
    ] = UNSET,
    fieldscatalog_variant: Union[Unset, List[GetUpdateVariantsJobFieldscatalogVariantItem]] = UNSET,
    include: Union[Unset, List[GetUpdateVariantsJobIncludeItem]] = UNSET,
    ...
    json_fieldscatalog_variant_bulk_update_job: Union[Unset, List[str]] = UNSET
    if not isinstance(fieldscatalog_variant_bulk_update_job, Unset):
        json_fieldscatalog_variant_bulk_update_job = []
        for fieldscatalog_variant_bulk_update_job_item_data in fieldscatalog_variant_bulk_update_job:
            fieldscatalog_variant_bulk_update_job_item = fieldscatalog_variant_bulk_update_job_item_data.value
            json_fieldscatalog_variant_bulk_update_job.append(fieldscatalog_variant_bulk_update_job_item)

    params["fields[catalog-variant-bulk-update-job]"] = json_fieldscatalog_variant_bulk_update_job
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/catalog-variant-bulk-update-jobs/{job_id}/",
        "params": params,
    }
...
) -> Optional[Union[Any, GetCatalogVariantUpdateJobResponseCompoundDocument]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetCatalogVariantUpdateJobResponseCompoundDocument.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetCatalogVariantUpdateJobResponseCompoundDocument]]:
    return Response(
...
def sync_detailed(
    ...
    **Scopes:**
    ...
    Args:
        ...
        fieldscatalog_variant_bulk_update_job (Union[Unset,
            List[GetUpdateVariantsJobFieldscatalogVariantBulkUpdateJobItem]]):
        fieldscatalog_variant (Union[Unset, List[GetUpdateVariantsJobFieldscatalogVariantItem]]):
        include (Union[Unset, List[GetUpdateVariantsJobIncludeItem]]):
    ...
    kwargs = _get_kwargs(
        job_id=job_id,
        fieldscatalog_variant_bulk_update_job=fieldscatalog_variant_bulk_update_job,
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, GetCatalogVariantUpdateJobResponseCompoundDocument]
    """
