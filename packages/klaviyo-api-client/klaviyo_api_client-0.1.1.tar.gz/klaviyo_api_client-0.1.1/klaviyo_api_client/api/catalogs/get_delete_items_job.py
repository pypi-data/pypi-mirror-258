...
from ...models.get_catalog_item_delete_job_response import GetCatalogItemDeleteJobResponse
from ...models.get_delete_items_job_fieldscatalog_item_bulk_delete_job_item import (
...
def _get_kwargs(
    job_id: str,
    *,
    fieldscatalog_item_bulk_delete_job: Union[Unset, List[GetDeleteItemsJobFieldscatalogItemBulkDeleteJobItem]] = UNSET,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/catalog-item-bulk-delete-jobs/{job_id}/",
        "params": params,
    }
...
) -> Optional[Union[Any, GetCatalogItemDeleteJobResponse]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetCatalogItemDeleteJobResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetCatalogItemDeleteJobResponse]]:
    return Response(
    ...
    **Scopes:**
    ...
    Args:
        ...
        fieldscatalog_item_bulk_delete_job (Union[Unset,
            List[GetDeleteItemsJobFieldscatalogItemBulkDeleteJobItem]]):
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, GetCatalogItemDeleteJobResponse]
    """
