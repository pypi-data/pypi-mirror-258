...
from ...models.catalog_category_update_query import CatalogCategoryUpdateQuery
from ...models.patch_catalog_category_response import PatchCatalogCategoryResponse
...
) -> Optional[Union[Any, PatchCatalogCategoryResponse]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = PatchCatalogCategoryResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, PatchCatalogCategoryResponse]]:
    return Response(
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, PatchCatalogCategoryResponse]
    """
