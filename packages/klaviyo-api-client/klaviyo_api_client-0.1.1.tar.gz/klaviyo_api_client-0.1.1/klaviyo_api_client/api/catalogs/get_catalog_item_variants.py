...
from ...models.get_catalog_item_variants_fieldscatalog_variant_item import (
    GetCatalogItemVariantsFieldscatalogVariantItem,
)
from ...models.get_catalog_item_variants_sort import GetCatalogItemVariantsSort
from ...models.get_catalog_variant_response_collection import GetCatalogVariantResponseCollection
...
def _get_kwargs(
    id: str,
    *,
    fieldscatalog_variant: Union[Unset, List[GetCatalogItemVariantsFieldscatalogVariantItem]] = UNSET,
    filter_: Union[Unset, str] = UNSET,
    pagecursor: Union[Unset, str] = UNSET,
    sort: Union[Unset, GetCatalogItemVariantsSort] = UNSET,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/catalog-items/{id}/variants/",
        "params": params,
    }
...
) -> Optional[Union[Any, GetCatalogVariantResponseCollection]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetCatalogVariantResponseCollection.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetCatalogVariantResponseCollection]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Returns a maximum of 100 variants per request.<br><br>*Rate limits*:<br>Burst: `350/s`<br>Steady:
    `3500/m`
    ...
    **Scopes:**
    ...
    Args:
        ...
        fieldscatalog_variant (Union[Unset,
            List[GetCatalogItemVariantsFieldscatalogVariantItem]]):
        filter_ (Union[Unset, str]):
        pagecursor (Union[Unset, str]):
        sort (Union[Unset, GetCatalogItemVariantsSort]):
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, GetCatalogVariantResponseCollection]
    """
