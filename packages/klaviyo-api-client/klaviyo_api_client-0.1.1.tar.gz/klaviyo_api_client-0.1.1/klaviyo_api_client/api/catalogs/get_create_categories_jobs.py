...
from ...models.get_catalog_category_create_job_response_collection_compound_document import (
    GetCatalogCategoryCreateJobResponseCollectionCompoundDocument,
)
from ...models.get_create_categories_jobs_fieldscatalog_category_bulk_create_job_item import (
...
def _get_kwargs(
    *,
    fieldscatalog_category_bulk_create_job: Union[
        Unset, List[GetCreateCategoriesJobsFieldscatalogCategoryBulkCreateJobItem]
    ] = UNSET,
...
) -> Optional[Union[Any, GetCatalogCategoryCreateJobResponseCollectionCompoundDocument]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetCatalogCategoryCreateJobResponseCollectionCompoundDocument.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetCatalogCategoryCreateJobResponseCollectionCompoundDocument]]:
    return Response(
    ...
    **Scopes:**
    ...
    Args:
        fieldscatalog_category_bulk_create_job (Union[Unset,
            List[GetCreateCategoriesJobsFieldscatalogCategoryBulkCreateJobItem]]):
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, GetCatalogCategoryCreateJobResponseCollectionCompoundDocument]
    """
