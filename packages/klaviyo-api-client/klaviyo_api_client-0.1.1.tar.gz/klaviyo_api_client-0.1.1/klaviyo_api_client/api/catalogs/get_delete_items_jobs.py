...
from ...models.get_catalog_item_delete_job_response_collection import GetCatalogItemDeleteJobResponseCollection
from ...models.get_delete_items_jobs_fieldscatalog_item_bulk_delete_job_item import (
...
def _get_kwargs(
    *,
    fieldscatalog_item_bulk_delete_job: Union[
        Unset, List[GetDeleteItemsJobsFieldscatalogItemBulkDeleteJobItem]
    ] = UNSET,
    ...
    json_fieldscatalog_item_bulk_delete_job: Union[Unset, List[str]] = UNSET
    if not isinstance(fieldscatalog_item_bulk_delete_job, Unset):
        json_fieldscatalog_item_bulk_delete_job = []
        for fieldscatalog_item_bulk_delete_job_item_data in fieldscatalog_item_bulk_delete_job:
            fieldscatalog_item_bulk_delete_job_item = fieldscatalog_item_bulk_delete_job_item_data.value
            json_fieldscatalog_item_bulk_delete_job.append(fieldscatalog_item_bulk_delete_job_item)

    params["fields[catalog-item-bulk-delete-job]"] = json_fieldscatalog_item_bulk_delete_job
...
) -> Optional[Union[Any, GetCatalogItemDeleteJobResponseCollection]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetCatalogItemDeleteJobResponseCollection.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetCatalogItemDeleteJobResponseCollection]]:
    return Response(
...
def sync_detailed(
    ...
    **Scopes:**
    ...
    Args:
        fieldscatalog_item_bulk_delete_job (Union[Unset,
            List[GetDeleteItemsJobsFieldscatalogItemBulkDeleteJobItem]]):
    ...
    kwargs = _get_kwargs(
        fieldscatalog_item_bulk_delete_job=fieldscatalog_item_bulk_delete_job,
        filter_=filter_,
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, GetCatalogItemDeleteJobResponseCollection]
    """
