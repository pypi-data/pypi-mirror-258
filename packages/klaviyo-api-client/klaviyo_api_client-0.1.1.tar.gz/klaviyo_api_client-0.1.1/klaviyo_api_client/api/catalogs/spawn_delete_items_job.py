...
from ...models.catalog_item_delete_job_create_query import CatalogItemDeleteJobCreateQuery
from ...models.post_catalog_item_delete_job_response import PostCatalogItemDeleteJobResponse
...
) -> Optional[Union[Any, PostCatalogItemDeleteJobResponse]]:
    if response.status_code == HTTPStatus.ACCEPTED:
        response_202 = PostCatalogItemDeleteJobResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, PostCatalogItemDeleteJobResponse]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Accepts up to 100 catalog items per request. The maximum allowed payload size is 5MB.<br><br>*Rate
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, PostCatalogItemDeleteJobResponse]
    """
