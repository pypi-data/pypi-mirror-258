...
from ...models.get_catalog_variant_update_job_response_collection_compound_document import (
    GetCatalogVariantUpdateJobResponseCollectionCompoundDocument,
)
from ...models.get_update_variants_jobs_fieldscatalog_variant_bulk_update_job_item import (
...
def _get_kwargs(
    *,
    fieldscatalog_variant_bulk_update_job: Union[
        Unset, List[GetUpdateVariantsJobsFieldscatalogVariantBulkUpdateJobItem]
    ] = UNSET,
...
) -> Optional[Union[Any, GetCatalogVariantUpdateJobResponseCollectionCompoundDocument]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetCatalogVariantUpdateJobResponseCollectionCompoundDocument.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetCatalogVariantUpdateJobResponseCollectionCompoundDocument]]:
    return Response(
    ...
    **Scopes:**
    ...
    Args:
        fieldscatalog_variant_bulk_update_job (Union[Unset,
            List[GetUpdateVariantsJobsFieldscatalogVariantBulkUpdateJobItem]]):
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, GetCatalogVariantUpdateJobResponseCollectionCompoundDocument]
    """
