...
from ...models.get_catalog_item_fieldscatalog_item_item import GetCatalogItemFieldscatalogItemItem
from ...models.get_catalog_item_fieldscatalog_variant_item import GetCatalogItemFieldscatalogVariantItem
from ...models.get_catalog_item_include_item import GetCatalogItemIncludeItem
from ...models.get_catalog_item_response_compound_document import GetCatalogItemResponseCompoundDocument
...
def _get_kwargs(
    id: str,
    *,
    fieldscatalog_item: Union[Unset, List[GetCatalogItemFieldscatalogItemItem]] = UNSET,
    fieldscatalog_variant: Union[Unset, List[GetCatalogItemFieldscatalogVariantItem]] = UNSET,
    include: Union[Unset, List[GetCatalogItemIncludeItem]] = UNSET,
...
) -> Optional[Union[Any, GetCatalogItemResponseCompoundDocument]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetCatalogItemResponseCompoundDocument.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetCatalogItemResponseCompoundDocument]]:
    return Response(
    ...
    **Scopes:**
    ...
    Args:
        id (str): The catalog item ID is a compound ID (string), with format:
            `{integration}:::{catalog}:::{external_id}`. Currently, the only supported integration
            type is `$custom`, and the only supported catalog is `$default`. Example:
            $custom:::$default:::SAMPLE-DATA-ITEM-1.
        fieldscatalog_item (Union[Unset, List[GetCatalogItemFieldscatalogItemItem]]):
        fieldscatalog_variant (Union[Unset, List[GetCatalogItemFieldscatalogVariantItem]]):
        include (Union[Unset, List[GetCatalogItemIncludeItem]]):
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, GetCatalogItemResponseCompoundDocument]
    """
