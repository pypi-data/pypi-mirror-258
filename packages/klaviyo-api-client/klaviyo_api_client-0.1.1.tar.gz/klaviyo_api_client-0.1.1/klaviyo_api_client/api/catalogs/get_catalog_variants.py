...
from ...models.get_catalog_variants_fieldscatalog_variant_item import GetCatalogVariantsFieldscatalogVariantItem
from ...models.get_catalog_variants_sort import GetCatalogVariantsSort
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    fieldscatalog_variant: Union[Unset, List[GetCatalogVariantsFieldscatalogVariantItem]] = UNSET,
    filter_: Union[Unset, str] = UNSET,
    pagecursor: Union[Unset, str] = UNSET,
    sort: Union[Unset, GetCatalogVariantsSort] = UNSET,
...
def sync_detailed(
    ...
    **Scopes:**
    ...
    Args:
        fieldscatalog_variant (Union[Unset, List[GetCatalogVariantsFieldscatalogVariantItem]]):
        filter_ (Union[Unset, str]):
        pagecursor (Union[Unset, str]):
        sort (Union[Unset, GetCatalogVariantsSort]):
