...
from ...models.get_catalog_item_update_job_response_compound_document import (
    GetCatalogItemUpdateJobResponseCompoundDocument,
)
from ...models.get_update_items_job_fieldscatalog_item_bulk_update_job_item import (
    GetUpdateItemsJobFieldscatalogItemBulkUpdateJobItem,
)
from ...models.get_update_items_job_fieldscatalog_item_item import GetUpdateItemsJobFieldscatalogItemItem
from ...models.get_update_items_job_include_item import GetUpdateItemsJobIncludeItem
...
def _get_kwargs(
    job_id: str,
    *,
    fieldscatalog_item_bulk_update_job: Union[Unset, List[GetUpdateItemsJobFieldscatalogItemBulkUpdateJobItem]] = UNSET,
    fieldscatalog_item: Union[Unset, List[GetUpdateItemsJobFieldscatalogItemItem]] = UNSET,
    include: Union[Unset, List[GetUpdateItemsJobIncludeItem]] = UNSET,
    ...
    json_fieldscatalog_item_bulk_update_job: Union[Unset, List[str]] = UNSET
    if not isinstance(fieldscatalog_item_bulk_update_job, Unset):
        json_fieldscatalog_item_bulk_update_job = []
        for fieldscatalog_item_bulk_update_job_item_data in fieldscatalog_item_bulk_update_job:
            fieldscatalog_item_bulk_update_job_item = fieldscatalog_item_bulk_update_job_item_data.value
            json_fieldscatalog_item_bulk_update_job.append(fieldscatalog_item_bulk_update_job_item)

    params["fields[catalog-item-bulk-update-job]"] = json_fieldscatalog_item_bulk_update_job
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/catalog-item-bulk-update-jobs/{job_id}/",
        "params": params,
    }
...
) -> Optional[Union[Any, GetCatalogItemUpdateJobResponseCompoundDocument]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetCatalogItemUpdateJobResponseCompoundDocument.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetCatalogItemUpdateJobResponseCompoundDocument]]:
    return Response(
...
def sync_detailed(
    ...
    **Scopes:**
    ...
    Args:
        ...
        fieldscatalog_item_bulk_update_job (Union[Unset,
            List[GetUpdateItemsJobFieldscatalogItemBulkUpdateJobItem]]):
        fieldscatalog_item (Union[Unset, List[GetUpdateItemsJobFieldscatalogItemItem]]):
        include (Union[Unset, List[GetUpdateItemsJobIncludeItem]]):
    ...
    kwargs = _get_kwargs(
        job_id=job_id,
        fieldscatalog_item_bulk_update_job=fieldscatalog_item_bulk_update_job,
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, GetCatalogItemUpdateJobResponseCompoundDocument]
    """
