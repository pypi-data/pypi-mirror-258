...
from ...models.catalog_item_create_job_create_query import CatalogItemCreateJobCreateQuery
from ...models.post_catalog_item_create_job_response import PostCatalogItemCreateJobResponse
...
) -> Optional[Union[Any, PostCatalogItemCreateJobResponse]]:
    if response.status_code == HTTPStatus.ACCEPTED:
        response_202 = PostCatalogItemCreateJobResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, PostCatalogItemCreateJobResponse]]:
    return Response(
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, PostCatalogItemCreateJobResponse]
    """
