...
from ...models.catalog_category_update_job_create_query import CatalogCategoryUpdateJobCreateQuery
from ...models.post_catalog_category_update_job_response import PostCatalogCategoryUpdateJobResponse
...
) -> Optional[Union[Any, PostCatalogCategoryUpdateJobResponse]]:
    if response.status_code == HTTPStatus.ACCEPTED:
        response_202 = PostCatalogCategoryUpdateJobResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, PostCatalogCategoryUpdateJobResponse]]:
    return Response(
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, PostCatalogCategoryUpdateJobResponse]
    """
