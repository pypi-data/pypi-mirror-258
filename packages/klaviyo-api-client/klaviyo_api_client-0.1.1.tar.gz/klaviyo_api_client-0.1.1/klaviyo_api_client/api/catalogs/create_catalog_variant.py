...
from ...models.catalog_variant_create_query import CatalogVariantCreateQuery
from ...models.post_catalog_variant_response import PostCatalogVariantResponse
...
) -> Optional[Union[Any, PostCatalogVariantResponse]]:
    if response.status_code == HTTPStatus.CREATED:
        response_201 = PostCatalogVariantResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, PostCatalogVariantResponse]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Create Catalog Variant
     ...
     Create a new variant for a related catalog item.<br><br>*Rate limits*:<br>Burst: `75/s`<br>Steady:
    `700/m`
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, PostCatalogVariantResponse]
    """
