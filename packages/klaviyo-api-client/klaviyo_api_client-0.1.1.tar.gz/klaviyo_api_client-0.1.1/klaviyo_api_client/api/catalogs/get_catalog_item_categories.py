...
from ...models.get_catalog_category_response_collection import GetCatalogCategoryResponseCollection
from ...models.get_catalog_item_categories_fieldscatalog_category_item import (
    GetCatalogItemCategoriesFieldscatalogCategoryItem,
)
from ...models.get_catalog_item_categories_sort import GetCatalogItemCategoriesSort
...
def _get_kwargs(
    id: str,
    *,
    fieldscatalog_category: Union[Unset, List[GetCatalogItemCategoriesFieldscatalogCategoryItem]] = UNSET,
    filter_: Union[Unset, str] = UNSET,
    pagecursor: Union[Unset, str] = UNSET,
    sort: Union[Unset, GetCatalogItemCategoriesSort] = UNSET,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/catalog-items/{id}/categories/",
        "params": params,
    }
...
) -> Optional[Union[Any, GetCatalogCategoryResponseCollection]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetCatalogCategoryResponseCollection.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetCatalogCategoryResponseCollection]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Returns a maximum of 100 categories per request.<br><br>*Rate limits*:<br>Burst: `350/s`<br>Steady:
    `3500/m`
    ...
    **Scopes:**
    ...
    Args:
        ...
        fieldscatalog_category (Union[Unset,
            List[GetCatalogItemCategoriesFieldscatalogCategoryItem]]):
        filter_ (Union[Unset, str]):
        pagecursor (Union[Unset, str]):
        sort (Union[Unset, GetCatalogItemCategoriesSort]):
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, GetCatalogCategoryResponseCollection]
    """
