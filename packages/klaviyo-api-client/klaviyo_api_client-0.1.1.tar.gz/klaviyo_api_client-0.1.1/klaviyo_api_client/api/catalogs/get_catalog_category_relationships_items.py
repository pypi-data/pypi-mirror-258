...
from ...models.get_catalog_category_item_list_response_collection import GetCatalogCategoryItemListResponseCollection
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/catalog-categories/{id}/relationships/items/",
        "params": params,
    }
...
) -> Optional[Union[Any, GetCatalogCategoryItemListResponseCollection]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetCatalogCategoryItemListResponseCollection.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetCatalogCategoryItemListResponseCollection]]:
    return Response(
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, GetCatalogCategoryItemListResponseCollection]
    """
