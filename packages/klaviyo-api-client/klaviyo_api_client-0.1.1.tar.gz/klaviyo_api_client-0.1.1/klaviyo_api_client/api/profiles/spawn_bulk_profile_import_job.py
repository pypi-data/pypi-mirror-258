...
from ...models.post_profile_import_job_response import PostProfileImportJobResponse
from ...models.profile_import_job_create_query import ProfileImportJobCreateQuery
...
) -> Optional[Union[Any, PostProfileImportJobResponse]]:
    if response.status_code == HTTPStatus.ACCEPTED:
        response_202 = PostProfileImportJobResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, PostProfileImportJobResponse]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    To learn more, see our [Bulk Profile Import API
    guide](https://developers.klaviyo.com/en/docs/use_klaviyos_bulk_profile_import_api).<br><br>*Rate
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, PostProfileImportJobResponse]
    """
