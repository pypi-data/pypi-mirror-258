...
from ...models.post_profile_response import PostProfileResponse
from ...models.profile_upsert_query import ProfileUpsertQuery
...
) -> Optional[Union[Any, PostProfileResponse]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = PostProfileResponse.from_dict(response.json())

        return response_200
    if response.status_code == HTTPStatus.CREATED:
        response_201 = PostProfileResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, PostProfileResponse]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Returns 201 if a new profile was created, 200 if an existing profile was updated.<br><br>*Rate
