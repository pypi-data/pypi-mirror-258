...
from ...models.get_profile_segment_relationships_response_collection import (
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/profiles/{id}/relationships/segments/",
    }
...
) -> Optional[Union[Any, GetProfileSegmentRelationshipsResponseCollection]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetProfileSegmentRelationshipsResponseCollection.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetProfileSegmentRelationshipsResponseCollection]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Get Profile Relationships Segments
     ...
     Get segment membership relationships for a profile with the given profile ID.<br><br>*Rate
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, GetProfileSegmentRelationshipsResponseCollection]
    """
