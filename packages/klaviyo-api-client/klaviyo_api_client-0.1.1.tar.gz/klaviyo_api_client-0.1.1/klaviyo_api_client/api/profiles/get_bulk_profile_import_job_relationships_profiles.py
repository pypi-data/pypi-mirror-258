...
from ...models.get_profile_import_job_profile_relationships_response_collection import (
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/profile-bulk-import-jobs/{id}/relationships/profiles/",
        "params": params,
    }
...
) -> Optional[Union[Any, GetProfileImportJobProfileRelationshipsResponseCollection]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetProfileImportJobProfileRelationshipsResponseCollection.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetProfileImportJobProfileRelationshipsResponseCollection]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Get Bulk Profile Import Job Relationships Profiles
     ...
     Get profile relationships for the bulk profile import job with the given ID.<br><br>*Rate
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, GetProfileImportJobProfileRelationshipsResponseCollection]
    """
