...
from ...models.get_profile_import_job_list_relationships_response_collection import (
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/profile-bulk-import-jobs/{id}/relationships/lists/",
    }
...
) -> Optional[Union[Any, GetProfileImportJobListRelationshipsResponseCollection]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetProfileImportJobListRelationshipsResponseCollection.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetProfileImportJobListRelationshipsResponseCollection]]:
    return Response(
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, GetProfileImportJobListRelationshipsResponseCollection]
    """
