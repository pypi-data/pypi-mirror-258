...
from ...models.get_bulk_profile_import_job_fieldslist_item import GetBulkProfileImportJobFieldslistItem
from ...models.get_bulk_profile_import_job_fieldsprofile_bulk_import_job_item import (
    GetBulkProfileImportJobFieldsprofileBulkImportJobItem,
)
from ...models.get_bulk_profile_import_job_include_item import GetBulkProfileImportJobIncludeItem
from ...models.get_profile_import_job_response_compound_document import GetProfileImportJobResponseCompoundDocument
...
def _get_kwargs(
    job_id: str,
    *,
    fieldslist: Union[Unset, List[GetBulkProfileImportJobFieldslistItem]] = UNSET,
    fieldsprofile_bulk_import_job: Union[Unset, List[GetBulkProfileImportJobFieldsprofileBulkImportJobItem]] = UNSET,
    include: Union[Unset, List[GetBulkProfileImportJobIncludeItem]] = UNSET,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/profile-bulk-import-jobs/{job_id}/",
        "params": params,
    }
...
) -> Optional[Union[Any, GetProfileImportJobResponseCompoundDocument]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetProfileImportJobResponseCompoundDocument.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetProfileImportJobResponseCompoundDocument]]:
    return Response(
...
def sync_detailed(
    ...
    **Scopes:**
    ...
    Args:
        ...
        fieldslist (Union[Unset, List[GetBulkProfileImportJobFieldslistItem]]):
        fieldsprofile_bulk_import_job (Union[Unset,
            List[GetBulkProfileImportJobFieldsprofileBulkImportJobItem]]):
        include (Union[Unset, List[GetBulkProfileImportJobIncludeItem]]):
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, GetProfileImportJobResponseCompoundDocument]
    """
