...
from ...models.get_flow_message_flow_action_relationship_response import GetFlowMessageFlowActionRelationshipResponse
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/flow-messages/{id}/relationships/flow-action/",
    }
...
) -> Optional[Union[Any, GetFlowMessageFlowActionRelationshipResponse]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetFlowMessageFlowActionRelationshipResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetFlowMessageFlowActionRelationshipResponse]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Get Flow Message Relationships Action
     ...
     Get the [relationship](https://developers.klaviyo.com/en/reference/api_overview#relationships) for a
    flow message's flow action, given the flow ID.<br><br>*Rate limits*:<br>Burst: `3/s`<br>Steady:
    `60/m`
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, GetFlowMessageFlowActionRelationshipResponse]
    """
