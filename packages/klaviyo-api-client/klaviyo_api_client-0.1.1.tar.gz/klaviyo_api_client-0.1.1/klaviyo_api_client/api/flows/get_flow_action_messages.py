...
from ...models.get_flow_action_messages_fieldsflow_message_item import GetFlowActionMessagesFieldsflowMessageItem
from ...models.get_flow_action_messages_sort import GetFlowActionMessagesSort
from ...models.get_flow_message_response_collection import GetFlowMessageResponseCollection
...
def _get_kwargs(
    id: str,
    *,
    fieldsflow_message: Union[Unset, List[GetFlowActionMessagesFieldsflowMessageItem]] = UNSET,
    filter_: Union[Unset, str] = UNSET,
    pagesize: Union[Unset, int] = 50,
    sort: Union[Unset, GetFlowActionMessagesSort] = UNSET,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/flow-actions/{id}/flow-messages/",
        "params": params,
    }
...
) -> Optional[Union[Any, GetFlowMessageResponseCollection]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetFlowMessageResponseCollection.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetFlowMessageResponseCollection]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Returns a maximum of 50 flows per request, which can be paginated with offset pagination. Offset
    pagination uses the following parameters: `page[size]` and `page[number]`<br><br>*Rate
    ...
    **Scopes:**
    ...
    Args:
        id (str):
        fieldsflow_message (Union[Unset, List[GetFlowActionMessagesFieldsflowMessageItem]]):
        filter_ (Union[Unset, str]):
        pagesize (Union[Unset, int]):  Default: 50.
        sort (Union[Unset, GetFlowActionMessagesSort]):
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, GetFlowMessageResponseCollection]
    """
