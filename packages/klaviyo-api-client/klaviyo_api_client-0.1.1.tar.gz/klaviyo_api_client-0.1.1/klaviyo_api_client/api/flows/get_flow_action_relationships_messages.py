...
from ...models.get_flow_action_flow_message_relationship_response_collection import (
    GetFlowActionFlowMessageRelationshipResponseCollection,
)
from ...models.get_flow_action_relationships_messages_sort import GetFlowActionRelationshipsMessagesSort
...
def _get_kwargs(
    ...
    *,
    ...
    sort: Union[Unset, GetFlowActionRelationshipsMessagesSort] = UNSET,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/flow-actions/{id}/relationships/flow-messages/",
        "params": params,
    }
...
) -> Optional[Union[Any, GetFlowActionFlowMessageRelationshipResponseCollection]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetFlowActionFlowMessageRelationshipResponseCollection.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetFlowActionFlowMessageRelationshipResponseCollection]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Returns a maximum of 50 flow message relationships per request, which can be paginated with cursor-
    based pagination.<br><br>*Rate limits*:<br>Burst: `3/s`<br>Steady: `60/m`
    ...
    **Scopes:**
    ...
    Args:
        ...
        sort (Union[Unset, GetFlowActionRelationshipsMessagesSort]):
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, GetFlowActionFlowMessageRelationshipResponseCollection]
    """
