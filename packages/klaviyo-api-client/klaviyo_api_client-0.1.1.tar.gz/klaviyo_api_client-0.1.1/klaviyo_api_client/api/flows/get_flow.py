...
from ...models.get_flow_fieldsflow_action_item import GetFlowFieldsflowActionItem
from ...models.get_flow_fieldsflow_item import GetFlowFieldsflowItem
from ...models.get_flow_fieldstag_item import GetFlowFieldstagItem
from ...models.get_flow_include_item import GetFlowIncludeItem
from ...models.get_flow_response_compound_document import GetFlowResponseCompoundDocument
...
def _get_kwargs(
    id: str,
    *,
    fieldsflow_action: Union[Unset, List[GetFlowFieldsflowActionItem]] = UNSET,
    fieldsflow: Union[Unset, List[GetFlowFieldsflowItem]] = UNSET,
    fieldstag: Union[Unset, List[GetFlowFieldstagItem]] = UNSET,
    include: Union[Unset, List[GetFlowIncludeItem]] = UNSET,
...
) -> Optional[Union[Any, GetFlowResponseCompoundDocument]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetFlowResponseCompoundDocument.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetFlowResponseCompoundDocument]]:
    return Response(
...
def sync_detailed(
    ...
    **Scopes:**
    ...
    Args:
        id (str):
        fieldsflow_action (Union[Unset, List[GetFlowFieldsflowActionItem]]):
        fieldsflow (Union[Unset, List[GetFlowFieldsflowItem]]):
        fieldstag (Union[Unset, List[GetFlowFieldstagItem]]):
        include (Union[Unset, List[GetFlowIncludeItem]]):
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, GetFlowResponseCompoundDocument]
    """
