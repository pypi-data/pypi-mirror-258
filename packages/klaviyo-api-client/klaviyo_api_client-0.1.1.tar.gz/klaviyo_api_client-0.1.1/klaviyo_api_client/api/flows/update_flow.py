...
from ...models.flow_update_query import FlowUpdateQuery
from ...models.patch_flow_response import PatchFlowResponse
...
) -> Optional[Union[Any, PatchFlowResponse]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = PatchFlowResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, PatchFlowResponse]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Update Flow Status
     ...
     Update the status of a flow with the given flow ID, and all actions in that flow.<br><br>*Rate
