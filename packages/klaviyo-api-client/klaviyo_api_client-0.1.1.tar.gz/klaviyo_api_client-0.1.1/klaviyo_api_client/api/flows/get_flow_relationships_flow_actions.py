...
from ...models.get_flow_flow_action_relationship_list_response_collection import (
    GetFlowFlowActionRelationshipListResponseCollection,
)
from ...models.get_flow_relationships_flow_actions_sort import GetFlowRelationshipsFlowActionsSort
...
def _get_kwargs(
    ...
    *,
    ...
    sort: Union[Unset, GetFlowRelationshipsFlowActionsSort] = UNSET,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/flows/{id}/relationships/flow-actions/",
        "params": params,
    }
...
) -> Optional[Union[Any, GetFlowFlowActionRelationshipListResponseCollection]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetFlowFlowActionRelationshipListResponseCollection.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetFlowFlowActionRelationshipListResponseCollection]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Get Flow Relationships Flow Actions
     ...
     Get all [relationships](https://developers.klaviyo.com/en/reference/api_overview#relationships) for
    flow actions associated with the given flow ID.
    ...
    Returns a maximum of 50 flow action relationships per request, which can be paginated with offset
    pagination. Offset pagination uses the following parameters: `page[size]` and
    `page[number]`.<br><br>*Rate limits*:<br>Burst: `3/s`<br>Steady: `60/m`
    ...
    **Scopes:**
    ...
    Args:
        ...
        sort (Union[Unset, GetFlowRelationshipsFlowActionsSort]):
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, GetFlowFlowActionRelationshipListResponseCollection]
    """
