...
from ...models.get_flow_action_response import GetFlowActionResponse
from ...models.get_flow_message_action_fieldsflow_action_item import GetFlowMessageActionFieldsflowActionItem
...
def _get_kwargs(
    id: str,
    *,
    fieldsflow_action: Union[Unset, List[GetFlowMessageActionFieldsflowActionItem]] = UNSET,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/flow-messages/{id}/flow-action/",
        "params": params,
    }
...
) -> Optional[Union[Any, GetFlowActionResponse]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetFlowActionResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetFlowActionResponse]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Get Flow Action For Message
     ...
     Get the flow action for a flow message with the given message ID.<br><br>*Rate limits*:<br>Burst:
    `3/s`<br>Steady: `60/m`
    ...
    **Scopes:**
    ...
    Args:
        id (str):
        fieldsflow_action (Union[Unset, List[GetFlowMessageActionFieldsflowActionItem]]):
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, GetFlowActionResponse]
    """
