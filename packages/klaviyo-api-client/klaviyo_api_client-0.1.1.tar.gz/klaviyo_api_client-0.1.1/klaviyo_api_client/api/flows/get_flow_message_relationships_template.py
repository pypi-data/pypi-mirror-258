...
from ...models.get_flow_message_template_relationship_response import GetFlowMessageTemplateRelationshipResponse
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/flow-messages/{id}/relationships/template/",
    }
...
) -> Optional[Union[Any, GetFlowMessageTemplateRelationshipResponse]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetFlowMessageTemplateRelationshipResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetFlowMessageTemplateRelationshipResponse]]:
    return Response(
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, GetFlowMessageTemplateRelationshipResponse]
    """
