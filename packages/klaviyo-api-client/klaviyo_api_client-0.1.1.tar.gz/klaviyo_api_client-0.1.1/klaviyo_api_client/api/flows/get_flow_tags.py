...
from ...models.get_flow_tags_fieldstag_item import GetFlowTagsFieldstagItem
...
def _get_kwargs(
    id: str,
    *,
    fieldstag: Union[Unset, List[GetFlowTagsFieldstagItem]] = UNSET,
...
def sync_detailed(
    ...
    *,
    ...
    """Get Flow Tags
     ...
     Return all tags associated with the given flow ID.<br><br>*Rate limits*:<br>Burst: `3/s`<br>Steady:
    `60/m`
    ...
    **Scopes:**
    ...
    Args:
        id (str):
        fieldstag (Union[Unset, List[GetFlowTagsFieldstagItem]]):
