...
from ...models.get_list_relationships_profiles_sort import GetListRelationshipsProfilesSort
from ...models.get_list_relationships_response_collection import GetListRelationshipsResponseCollection
...
def _get_kwargs(
    ...
    *,
    ...
    sort: Union[Unset, GetListRelationshipsProfilesSort] = UNSET,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/lists/{id}/relationships/profiles/",
        "params": params,
    }
...
) -> Optional[Union[Any, GetListRelationshipsResponseCollection]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetListRelationshipsResponseCollection.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetListRelationshipsResponseCollection]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    [relationships](https://developers.klaviyo.com/en/reference/api_overview#relationships) for a list
    with the given list ID.<br><br>*Rate limits*:<br>Burst: `75/s`<br>Steady: `700/m`
    ...
    **Scopes:**
    ...
    Args:
        ...
        sort (Union[Unset, GetListRelationshipsProfilesSort]):
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, GetListRelationshipsResponseCollection]
    """
