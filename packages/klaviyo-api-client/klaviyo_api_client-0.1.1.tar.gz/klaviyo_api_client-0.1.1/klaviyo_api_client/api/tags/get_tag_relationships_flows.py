...
from ...models.get_tag_flow_relationships_response_collection import GetTagFlowRelationshipsResponseCollection
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/tags/{id}/relationships/flows/",
    }
...
) -> Optional[Union[Any, GetTagFlowRelationshipsResponseCollection]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetTagFlowRelationshipsResponseCollection.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetTagFlowRelationshipsResponseCollection]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Get Tag Relationships Flows
     ...
     Returns the IDs of all flows associated with the given tag.<br><br>*Rate limits*:<br>Burst:
    `3/s`<br>Steady: `60/m`
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, GetTagFlowRelationshipsResponseCollection]
    """
