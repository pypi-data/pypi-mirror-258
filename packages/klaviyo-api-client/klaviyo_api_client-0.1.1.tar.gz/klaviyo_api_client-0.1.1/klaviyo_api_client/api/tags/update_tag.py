...
from ...models.tag_update_query import TagUpdateQuery
...
def sync_detailed(
    ...
    *,
    ...
    Only a tag's `name` can be changed. A tag cannot be moved from one tag group to
    another.<br><br>*Rate limits*:<br>Burst: `3/s`<br>Steady: `60/m`
