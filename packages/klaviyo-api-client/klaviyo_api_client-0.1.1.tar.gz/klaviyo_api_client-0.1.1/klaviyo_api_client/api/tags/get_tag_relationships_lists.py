...
from ...models.get_tag_list_relationships_response_collection import GetTagListRelationshipsResponseCollection
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/tags/{id}/relationships/lists/",
    }
...
) -> Optional[Union[Any, GetTagListRelationshipsResponseCollection]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetTagListRelationshipsResponseCollection.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetTagListRelationshipsResponseCollection]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Get Tag Relationships Lists
     ...
     Returns the IDs of all lists associated with the given tag.<br><br>*Rate limits*:<br>Burst:
    `3/s`<br>Steady: `60/m`
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, GetTagListRelationshipsResponseCollection]
    """
