...
from ...models.get_tag_fieldstag_group_item import GetTagFieldstagGroupItem
from ...models.get_tag_fieldstag_item import GetTagFieldstagItem
from ...models.get_tag_include_item import GetTagIncludeItem
from ...models.get_tag_response_compound_document import GetTagResponseCompoundDocument
...
def _get_kwargs(
    id: str,
    *,
    fieldstag_group: Union[Unset, List[GetTagFieldstagGroupItem]] = UNSET,
    fieldstag: Union[Unset, List[GetTagFieldstagItem]] = UNSET,
    include: Union[Unset, List[GetTagIncludeItem]] = UNSET,
...
) -> Optional[Union[Any, GetTagResponseCompoundDocument]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetTagResponseCompoundDocument.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetTagResponseCompoundDocument]]:
    return Response(
...
def sync_detailed(
    ...
    **Scopes:**
    ...
    Args:
        ...
        fieldstag_group (Union[Unset, List[GetTagFieldstagGroupItem]]):
        fieldstag (Union[Unset, List[GetTagFieldstagItem]]):
        include (Union[Unset, List[GetTagIncludeItem]]):
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, GetTagResponseCompoundDocument]
    """
