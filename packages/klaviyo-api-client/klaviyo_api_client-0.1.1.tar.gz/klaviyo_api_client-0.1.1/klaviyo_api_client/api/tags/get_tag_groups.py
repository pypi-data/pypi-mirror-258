...
from ...models.get_tag_group_response_collection import GetTagGroupResponseCollection
from ...models.get_tag_groups_fieldstag_group_item import GetTagGroupsFieldstagGroupItem
from ...models.get_tag_groups_sort import GetTagGroupsSort
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    fieldstag_group: Union[Unset, List[GetTagGroupsFieldstagGroupItem]] = UNSET,
    filter_: Union[Unset, str] = UNSET,
    pagecursor: Union[Unset, str] = UNSET,
    sort: Union[Unset, GetTagGroupsSort] = UNSET,
...
) -> Optional[Union[Any, GetTagGroupResponseCollection]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetTagGroupResponseCollection.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetTagGroupResponseCollection]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Tag groups can be filtered by `name`, `exclusive`, and `default`, and sorted by `name` or `id` in
    ...
    **Scopes:**
    ...
    Args:
        fieldstag_group (Union[Unset, List[GetTagGroupsFieldstagGroupItem]]):
        filter_ (Union[Unset, str]):
        pagecursor (Union[Unset, str]):
        sort (Union[Unset, GetTagGroupsSort]):
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, GetTagGroupResponseCollection]
    """
