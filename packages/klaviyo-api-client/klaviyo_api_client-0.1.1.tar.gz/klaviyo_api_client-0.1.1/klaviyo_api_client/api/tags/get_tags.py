...
from ...models.get_tag_response_collection_compound_document import GetTagResponseCollectionCompoundDocument
from ...models.get_tags_fieldstag_group_item import GetTagsFieldstagGroupItem
from ...models.get_tags_fieldstag_item import GetTagsFieldstagItem
from ...models.get_tags_include_item import GetTagsIncludeItem
from ...models.get_tags_sort import GetTagsSort
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    fieldstag_group: Union[Unset, List[GetTagsFieldstagGroupItem]] = UNSET,
    fieldstag: Union[Unset, List[GetTagsFieldstagItem]] = UNSET,
    filter_: Union[Unset, str] = UNSET,
    include: Union[Unset, List[GetTagsIncludeItem]] = UNSET,
    pagecursor: Union[Unset, str] = UNSET,
    sort: Union[Unset, GetTagsSort] = UNSET,
    ...
    json_fieldstag_group: Union[Unset, List[str]] = UNSET
    if not isinstance(fieldstag_group, Unset):
        json_fieldstag_group = []
        for fieldstag_group_item_data in fieldstag_group:
            fieldstag_group_item = fieldstag_group_item_data.value
            json_fieldstag_group.append(fieldstag_group_item)

    params["fields[tag-group]"] = json_fieldstag_group
...
) -> Optional[Union[Any, GetTagResponseCollectionCompoundDocument]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetTagResponseCollectionCompoundDocument.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetTagResponseCollectionCompoundDocument]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    [cursor-based pagination](https://developers.klaviyo.com/en/v2022-10-
    17/reference/api_overview#pagination).<br><br>*Rate limits*:<br>Burst: `3/s`<br>Steady: `60/m`

    **Scopes:**
    `tags:read`

    Args:
        fieldstag_group (Union[Unset, List[GetTagsFieldstagGroupItem]]):
        fieldstag (Union[Unset, List[GetTagsFieldstagItem]]):
        filter_ (Union[Unset, str]):
        include (Union[Unset, List[GetTagsIncludeItem]]):
        pagecursor (Union[Unset, str]):
        sort (Union[Unset, GetTagsSort]):
    ...
    kwargs = _get_kwargs(
        fieldstag_group=fieldstag_group,
        fieldstag=fieldstag,
        filter_=filter_,
        include=include,
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, GetTagResponseCollectionCompoundDocument]
    """
