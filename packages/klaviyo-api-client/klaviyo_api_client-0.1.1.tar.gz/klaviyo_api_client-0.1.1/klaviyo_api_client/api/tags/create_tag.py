...
from ...models.post_tag_response import PostTagResponse
from ...models.tag_create_query import TagCreateQuery
...
) -> Optional[Union[Any, PostTagResponse]]:
    if response.status_code == HTTPStatus.CREATED:
        response_201 = PostTagResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, PostTagResponse]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    the tag is added to the account's default tag group.<br><br>*Rate limits*:<br>Burst:
    `3/s`<br>Steady: `60/m`
