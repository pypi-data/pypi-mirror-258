...
from ...models.get_tag_group_response import GetTagGroupResponse
from ...models.get_tag_tag_group_fieldstag_group_item import GetTagTagGroupFieldstagGroupItem
...
def _get_kwargs(
    id: str,
    *,
    fieldstag_group: Union[Unset, List[GetTagTagGroupFieldstagGroupItem]] = UNSET,
...
) -> Optional[Union[Any, GetTagGroupResponse]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetTagGroupResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetTagGroupResponse]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Get Tag Tag Group
     ...
     Returns the tag group resource for a given tag ID.<br><br>*Rate limits*:<br>Burst: `3/s`<br>Steady:
    `60/m`
    ...
    **Scopes:**
    ...
    Args:
        id (str):
        fieldstag_group (Union[Unset, List[GetTagTagGroupFieldstagGroupItem]]):
