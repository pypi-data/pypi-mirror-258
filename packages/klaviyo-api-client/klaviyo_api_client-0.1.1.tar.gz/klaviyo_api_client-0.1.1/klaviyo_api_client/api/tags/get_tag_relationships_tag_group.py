...
from ...models.get_tag_tag_group_relationships_response import GetTagTagGroupRelationshipsResponse
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/tags/{id}/relationships/tag-group/",
    }
...
) -> Optional[Union[Any, GetTagTagGroupRelationshipsResponse]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetTagTagGroupRelationshipsResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetTagTagGroupRelationshipsResponse]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Get Tag Relationships Tag Group
     ...
     Returns the id of the tag group related to the given tag.<br><br>*Rate limits*:<br>Burst:
    `3/s`<br>Steady: `60/m`
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, GetTagTagGroupRelationshipsResponse]
    """
