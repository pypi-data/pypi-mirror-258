...
from ...models.post_tag_group_response import PostTagGroupResponse
from ...models.tag_group_create_query import TagGroupCreateQuery
...
) -> Optional[Union[Any, PostTagGroupResponse]]:
    if response.status_code == HTTPStatus.CREATED:
        response_201 = PostTagGroupResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, PostTagGroupResponse]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    If a tag group is exclusive, any given related resource can only be linked to one tag from that tag
    group.<br><br>*Rate limits*:<br>Burst: `3/s`<br>Steady: `60/m`
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, PostTagGroupResponse]
    """
