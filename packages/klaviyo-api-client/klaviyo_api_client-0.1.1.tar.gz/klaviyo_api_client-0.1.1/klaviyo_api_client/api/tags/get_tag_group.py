...
from ...models.get_tag_group_fieldstag_group_item import GetTagGroupFieldstagGroupItem
...
def _get_kwargs(
    id: str,
    *,
    fieldstag_group: Union[Unset, List[GetTagGroupFieldstagGroupItem]] = UNSET,
...
def sync_detailed(
    ...
    *,
    ...
    """Get Tag Group
     ...
     Retrieve the tag group with the given tag group ID.<br><br>*Rate limits*:<br>Burst: `3/s`<br>Steady:
    `60/m`
    ...
    **Scopes:**
    ...
    Args:
        ...
        fieldstag_group (Union[Unset, List[GetTagGroupFieldstagGroupItem]]):
