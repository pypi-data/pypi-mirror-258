...
from ...models.template_clone_query import TemplateCloneQuery
...
def sync_detailed(
    *,
    ...
    If there are 1,000 or more templates in an account, cloning will fail as there is a limit of 1,000
    templates
