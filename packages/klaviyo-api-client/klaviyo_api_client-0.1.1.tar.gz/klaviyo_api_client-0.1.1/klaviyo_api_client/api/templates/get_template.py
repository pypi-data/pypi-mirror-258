...
from ...models.get_template_fieldstemplate_item import GetTemplateFieldstemplateItem
...
def _get_kwargs(
    id: str,
    *,
    fieldstemplate: Union[Unset, List[GetTemplateFieldstemplateItem]] = UNSET,
...
def sync_detailed(
    ...
    **Scopes:**
    ...
    Args:
        ...
        fieldstemplate (Union[Unset, List[GetTemplateFieldstemplateItem]]):
