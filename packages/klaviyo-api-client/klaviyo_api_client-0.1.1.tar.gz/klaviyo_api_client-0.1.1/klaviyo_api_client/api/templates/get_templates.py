...
from ...models.get_template_response_collection import GetTemplateResponseCollection
from ...models.get_templates_fieldstemplate_item import GetTemplatesFieldstemplateItem
from ...models.get_templates_sort import GetTemplatesSort
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    fieldstemplate: Union[Unset, List[GetTemplatesFieldstemplateItem]] = UNSET,
    filter_: Union[Unset, str] = UNSET,
    pagecursor: Union[Unset, str] = UNSET,
    sort: Union[Unset, GetTemplatesSort] = UNSET,
...
) -> Optional[Union[Any, GetTemplateResponseCollection]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetTemplateResponseCollection.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetTemplateResponseCollection]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Filter to request a subset of all templates. Templates can be sorted by the following fields, in
    ascending and descending order: `id`, `name`, `created`, `updated`
    ...
    **Scopes:**
    ...
    Args:
        fieldstemplate (Union[Unset, List[GetTemplatesFieldstemplateItem]]):
        filter_ (Union[Unset, str]):
        pagecursor (Union[Unset, str]):
        sort (Union[Unset, GetTemplatesSort]):
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, GetTemplateResponseCollection]
    """
