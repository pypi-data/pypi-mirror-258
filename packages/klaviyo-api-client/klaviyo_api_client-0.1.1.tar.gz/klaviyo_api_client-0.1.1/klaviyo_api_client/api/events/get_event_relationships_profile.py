...
from ...models.get_event_profiles_relationship_list_response import GetEventProfilesRelationshipListResponse
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/events/{id}/relationships/profile/",
    }
...
) -> Optional[Union[Any, GetEventProfilesRelationshipListResponse]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetEventProfilesRelationshipListResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetEventProfilesRelationshipListResponse]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Get Event Relationships Profile
     ...
     Get profile [relationships](https://developers.klaviyo.com/en/reference/api_overview#relationships)
    for an event with the given event ID.<br><br>*Rate limits*:<br>Burst: `350/s`<br>Steady: `3500/m`
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, GetEventProfilesRelationshipListResponse]
    """
