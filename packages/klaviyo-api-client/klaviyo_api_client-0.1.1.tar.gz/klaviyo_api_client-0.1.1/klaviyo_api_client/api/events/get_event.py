...
from ...models.get_event_fieldsevent_item import GetEventFieldseventItem
from ...models.get_event_fieldsmetric_item import GetEventFieldsmetricItem
from ...models.get_event_fieldsprofile_item import GetEventFieldsprofileItem
from ...models.get_event_include_item import GetEventIncludeItem
from ...models.get_event_response_compound_document import GetEventResponseCompoundDocument
...
def _get_kwargs(
    id: str,
    *,
    fieldsevent: Union[Unset, List[GetEventFieldseventItem]] = UNSET,
    fieldsmetric: Union[Unset, List[GetEventFieldsmetricItem]] = UNSET,
    fieldsprofile: Union[Unset, List[GetEventFieldsprofileItem]] = UNSET,
    include: Union[Unset, List[GetEventIncludeItem]] = UNSET,
...
) -> Optional[Union[Any, GetEventResponseCompoundDocument]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetEventResponseCompoundDocument.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetEventResponseCompoundDocument]]:
    return Response(
...
def sync_detailed(
    ...
    **Scopes:**
    ...
    Args:
        ...
        fieldsevent (Union[Unset, List[GetEventFieldseventItem]]):
        fieldsmetric (Union[Unset, List[GetEventFieldsmetricItem]]):
        fieldsprofile (Union[Unset, List[GetEventFieldsprofileItem]]):
        include (Union[Unset, List[GetEventIncludeItem]]):
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, GetEventResponseCompoundDocument]
    """
