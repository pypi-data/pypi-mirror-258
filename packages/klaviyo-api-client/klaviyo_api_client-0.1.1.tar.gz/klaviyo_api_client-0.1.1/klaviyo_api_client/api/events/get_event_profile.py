...
from ...models.get_event_profile_additional_fieldsprofile_item import GetEventProfileAdditionalFieldsprofileItem
from ...models.get_event_profile_fieldsprofile_item import GetEventProfileFieldsprofileItem
...
def _get_kwargs(
    id: str,
    *,
    additional_fieldsprofile: Union[Unset, List[GetEventProfileAdditionalFieldsprofileItem]] = UNSET,
    fieldsprofile: Union[Unset, List[GetEventProfileFieldsprofileItem]] = UNSET,
...
def sync_detailed(
    ...
    *,
    ...
    """Get Event Profile
     ...
     Get the profile associated with an event with the given event ID.<br><br>*Rate limits*:<br>Burst:
    ...
    **Scopes:**
    ...
    Args:
        id (str):
        additional_fieldsprofile (Union[Unset, List[GetEventProfileAdditionalFieldsprofileItem]]):
        fieldsprofile (Union[Unset, List[GetEventProfileFieldsprofileItem]]):
