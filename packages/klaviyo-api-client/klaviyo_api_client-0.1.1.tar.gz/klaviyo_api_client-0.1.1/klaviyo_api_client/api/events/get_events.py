...
from ...models.get_event_response_collection_compound_document import GetEventResponseCollectionCompoundDocument
from ...models.get_events_fieldsevent_item import GetEventsFieldseventItem
from ...models.get_events_fieldsmetric_item import GetEventsFieldsmetricItem
from ...models.get_events_fieldsprofile_item import GetEventsFieldsprofileItem
from ...models.get_events_include_item import GetEventsIncludeItem
...
def _get_kwargs(
    *,
    fieldsevent: Union[Unset, List[GetEventsFieldseventItem]] = UNSET,
    fieldsmetric: Union[Unset, List[GetEventsFieldsmetricItem]] = UNSET,
    fieldsprofile: Union[Unset, List[GetEventsFieldsprofileItem]] = UNSET,
    filter_: Union[Unset, str] = UNSET,
    include: Union[Unset, List[GetEventsIncludeItem]] = UNSET,
    pagecursor: Union[Unset, str] = UNSET,
    sort: Union[Unset, GetEventsSort] = UNSET,
    ...
    json_fieldsevent: Union[Unset, List[str]] = UNSET
    if not isinstance(fieldsevent, Unset):
        json_fieldsevent = []
        for fieldsevent_item_data in fieldsevent:
            fieldsevent_item = fieldsevent_item_data.value
            json_fieldsevent.append(fieldsevent_item)

    params["fields[event]"] = json_fieldsevent

    json_fieldsmetric: Union[Unset, List[str]] = UNSET
    if not isinstance(fieldsmetric, Unset):
        json_fieldsmetric = []
        for fieldsmetric_item_data in fieldsmetric:
            fieldsmetric_item = fieldsmetric_item_data.value
            json_fieldsmetric.append(fieldsmetric_item)

    params["fields[metric]"] = json_fieldsmetric
...
) -> Optional[Union[Any, GetEventResponseCollectionCompoundDocument]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetEventResponseCollectionCompoundDocument.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetEventResponseCollectionCompoundDocument]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Returns a maximum of 200 events per page.<br><br>*Rate limits*:<br>Burst: `350/s`<br>Steady:
    `3500/m`
    ...
    **Scopes:**
    ...
    Args:
        fieldsevent (Union[Unset, List[GetEventsFieldseventItem]]):
        fieldsmetric (Union[Unset, List[GetEventsFieldsmetricItem]]):
        fieldsprofile (Union[Unset, List[GetEventsFieldsprofileItem]]):
        filter_ (Union[Unset, str]):
        include (Union[Unset, List[GetEventsIncludeItem]]):
        pagecursor (Union[Unset, str]):
        sort (Union[Unset, GetEventsSort]):
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, GetEventResponseCollectionCompoundDocument]
    """
