...
from ...models.get_image_fieldsimage_item import GetImageFieldsimageItem
...
def _get_kwargs(
    id: str,
    *,
    fieldsimage: Union[Unset, List[GetImageFieldsimageItem]] = UNSET,
...
) -> Optional[Union[Any, GetImageResponse]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetImageResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetImageResponse]]:
    return Response(
...
def sync_detailed(
    ...
    **Scopes:**
    ...
    Args:
        ...
        fieldsimage (Union[Unset, List[GetImageFieldsimageItem]]):
