...
from ...models.image_partial_update_query import ImagePartialUpdateQuery
from ...models.patch_image_response import PatchImageResponse
...
) -> Optional[Union[Any, PatchImageResponse]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = PatchImageResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, PatchImageResponse]]:
    return Response(
