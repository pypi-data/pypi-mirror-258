...
from ...models.get_image_response_collection import GetImageResponseCollection
from ...models.get_images_fieldsimage_item import GetImagesFieldsimageItem
from ...models.get_images_sort import GetImagesSort
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    fieldsimage: Union[Unset, List[GetImagesFieldsimageItem]] = UNSET,
    filter_: Union[Unset, str] = UNSET,
    pagecursor: Union[Unset, str] = UNSET,
    pagesize: Union[Unset, int] = 20,
    sort: Union[Unset, GetImagesSort] = UNSET,
    ...
    json_fieldsimage: Union[Unset, List[str]] = UNSET
    if not isinstance(fieldsimage, Unset):
        json_fieldsimage = []
        for fieldsimage_item_data in fieldsimage:
            fieldsimage_item = fieldsimage_item_data.value
            json_fieldsimage.append(fieldsimage_item)

    params["fields[image]"] = json_fieldsimage
...
) -> Optional[Union[Any, GetImageResponseCollection]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetImageResponseCollection.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetImageResponseCollection]]:
    return Response(
...
def sync_detailed(
    ...
    **Scopes:**
    ...
    Args:
        fieldsimage (Union[Unset, List[GetImagesFieldsimageItem]]):
        filter_ (Union[Unset, str]):
        pagecursor (Union[Unset, str]):
        pagesize (Union[Unset, int]):  Default: 20.
        sort (Union[Unset, GetImagesSort]):
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, GetImageResponseCollection]
    """
