...
from ...models.image_create_query import ImageCreateQuery
...
def sync_detailed(
    *,
    ...
    If you want to upload an image from a file, use the Upload Image From File endpoint
    instead.<br><br>*Rate limits*:<br>Burst: `3/s`<br>Steady: `100/m`<br>Daily: `100/d`
