...
from ...models.get_campaign_tags_fieldstag_item import GetCampaignTagsFieldstagItem
from ...models.get_tag_response_collection import GetTagResponseCollection
...
def _get_kwargs(
    id: str,
    *,
    fieldstag: Union[Unset, List[GetCampaignTagsFieldstagItem]] = UNSET,
...
) -> Optional[Union[Any, GetTagResponseCollection]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetTagResponseCollection.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetTagResponseCollection]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Get Campaign Tags
     ...
     Return all tags that belong to the given campaign.<br><br>*Rate limits*:<br>Burst: `3/s`<br>Steady:
    `60/m`
    ...
    **Scopes:**
    ...
    Args:
        id (str):
        fieldstag (Union[Unset, List[GetCampaignTagsFieldstagItem]]):
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, GetTagResponseCollection]
    """
