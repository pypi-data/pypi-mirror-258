...
from ...models.get_campaign_send_job_fieldscampaign_send_job_item import GetCampaignSendJobFieldscampaignSendJobItem
from ...models.get_campaign_send_job_response import GetCampaignSendJobResponse
...
def _get_kwargs(
    id: str,
    *,
    fieldscampaign_send_job: Union[Unset, List[GetCampaignSendJobFieldscampaignSendJobItem]] = UNSET,
    ...
    json_fieldscampaign_send_job: Union[Unset, List[str]] = UNSET
    if not isinstance(fieldscampaign_send_job, Unset):
        json_fieldscampaign_send_job = []
        for fieldscampaign_send_job_item_data in fieldscampaign_send_job:
            fieldscampaign_send_job_item = fieldscampaign_send_job_item_data.value
            json_fieldscampaign_send_job.append(fieldscampaign_send_job_item)

    params["fields[campaign-send-job]"] = json_fieldscampaign_send_job

    params = {k: v for k, v in params.items() if v is not UNSET and v is not None}

    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/campaign-send-jobs/{id}/",
        "params": params,
    }
...
) -> Optional[Union[Any, GetCampaignSendJobResponse]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetCampaignSendJobResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetCampaignSendJobResponse]]:
    return Response(
...
def sync_detailed(
    ...
    **Scopes:**
    ...
    Args:
        ...
        fieldscampaign_send_job (Union[Unset, List[GetCampaignSendJobFieldscampaignSendJobItem]]):
    ...
    kwargs = _get_kwargs(
        id=id,
        fieldscampaign_send_job=fieldscampaign_send_job,
        revision=revision,
    )
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, GetCampaignSendJobResponse]
    """
