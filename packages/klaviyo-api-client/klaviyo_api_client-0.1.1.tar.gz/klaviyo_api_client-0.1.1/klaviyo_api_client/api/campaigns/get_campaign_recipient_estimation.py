...
from ...models.get_campaign_recipient_estimation_fieldscampaign_recipient_estimation_item import (
    GetCampaignRecipientEstimationFieldscampaignRecipientEstimationItem,
)
from ...models.get_campaign_recipient_estimation_response import GetCampaignRecipientEstimationResponse
...
def _get_kwargs(
    id: str,
    *,
    fieldscampaign_recipient_estimation: Union[
        Unset, List[GetCampaignRecipientEstimationFieldscampaignRecipientEstimationItem]
    ] = UNSET,
    ...
    json_fieldscampaign_recipient_estimation: Union[Unset, List[str]] = UNSET
    if not isinstance(fieldscampaign_recipient_estimation, Unset):
        json_fieldscampaign_recipient_estimation = []
        for fieldscampaign_recipient_estimation_item_data in fieldscampaign_recipient_estimation:
            fieldscampaign_recipient_estimation_item = fieldscampaign_recipient_estimation_item_data.value
            json_fieldscampaign_recipient_estimation.append(fieldscampaign_recipient_estimation_item)

    params["fields[campaign-recipient-estimation]"] = json_fieldscampaign_recipient_estimation

    params = {k: v for k, v in params.items() if v is not UNSET and v is not None}

    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/campaign-recipient-estimations/{id}/",
        "params": params,
    }
...
) -> Optional[Union[Any, GetCampaignRecipientEstimationResponse]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetCampaignRecipientEstimationResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetCampaignRecipientEstimationResponse]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    endpoint.<br><br>*Rate limits*:<br>Burst: `10/s`<br>Steady: `150/m`
    ...
    **Scopes:**
    ...
    Args:
        ...
        fieldscampaign_recipient_estimation (Union[Unset,
            List[GetCampaignRecipientEstimationFieldscampaignRecipientEstimationItem]]):
    ...
    kwargs = _get_kwargs(
        id=id,
        fieldscampaign_recipient_estimation=fieldscampaign_recipient_estimation,
        revision=revision,
    )
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, GetCampaignRecipientEstimationResponse]
    """
