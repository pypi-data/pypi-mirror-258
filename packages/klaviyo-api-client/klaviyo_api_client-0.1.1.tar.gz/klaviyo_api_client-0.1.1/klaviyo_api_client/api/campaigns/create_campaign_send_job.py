...
from ...models.campaign_send_job_create_query import CampaignSendJobCreateQuery
from ...models.post_campaign_send_job_response import PostCampaignSendJobResponse
...
) -> Optional[Union[Any, PostCampaignSendJobResponse]]:
    if response.status_code == HTTPStatus.ACCEPTED:
        response_202 = PostCampaignSendJobResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, PostCampaignSendJobResponse]]:
    return Response(
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, PostCampaignSendJobResponse]
    """
