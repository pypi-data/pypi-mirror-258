...
from ...models.campaign_recipient_estimation_job_create_query import CampaignRecipientEstimationJobCreateQuery
from ...models.post_campaign_recipient_estimation_job_response import PostCampaignRecipientEstimationJobResponse
...
) -> Optional[Union[Any, PostCampaignRecipientEstimationJobResponse]]:
    if response.status_code == HTTPStatus.ACCEPTED:
        response_202 = PostCampaignRecipientEstimationJobResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, PostCampaignRecipientEstimationJobResponse]]:
    return Response(
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, PostCampaignRecipientEstimationJobResponse]
    """
