...
from ...models.get_campaign_message_template_fieldstemplate_item import GetCampaignMessageTemplateFieldstemplateItem
...
def _get_kwargs(
    id: str,
    *,
    fieldstemplate: Union[Unset, List[GetCampaignMessageTemplateFieldstemplateItem]] = UNSET,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/campaign-messages/{id}/template/",
        "params": params,
    }
...
) -> Optional[Union[Any, GetTemplateResponse]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetTemplateResponse]]:
    return Response(
...
def sync_detailed(
    ...
    **Scopes:**
    ...
    Args:
        id (str):
        fieldstemplate (Union[Unset, List[GetCampaignMessageTemplateFieldstemplateItem]]):
