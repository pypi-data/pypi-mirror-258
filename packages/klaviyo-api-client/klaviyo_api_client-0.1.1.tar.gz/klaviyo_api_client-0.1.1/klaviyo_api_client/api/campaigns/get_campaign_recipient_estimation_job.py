...
from ...models.get_campaign_recipient_estimation_job_fieldscampaign_recipient_estimation_job_item import (
    GetCampaignRecipientEstimationJobFieldscampaignRecipientEstimationJobItem,
)
from ...models.get_campaign_recipient_estimation_job_response import GetCampaignRecipientEstimationJobResponse
...
def _get_kwargs(
    id: str,
    *,
    fieldscampaign_recipient_estimation_job: Union[
        Unset, List[GetCampaignRecipientEstimationJobFieldscampaignRecipientEstimationJobItem]
    ] = UNSET,
    ...
    json_fieldscampaign_recipient_estimation_job: Union[Unset, List[str]] = UNSET
    if not isinstance(fieldscampaign_recipient_estimation_job, Unset):
        json_fieldscampaign_recipient_estimation_job = []
        for fieldscampaign_recipient_estimation_job_item_data in fieldscampaign_recipient_estimation_job:
            fieldscampaign_recipient_estimation_job_item = fieldscampaign_recipient_estimation_job_item_data.value
            json_fieldscampaign_recipient_estimation_job.append(fieldscampaign_recipient_estimation_job_item)

    params["fields[campaign-recipient-estimation-job]"] = json_fieldscampaign_recipient_estimation_job

    params = {k: v for k, v in params.items() if v is not UNSET and v is not None}

    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/campaign-recipient-estimation-jobs/{id}/",
        "params": params,
    }
...
) -> Optional[Union[Any, GetCampaignRecipientEstimationJobResponse]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetCampaignRecipientEstimationJobResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetCampaignRecipientEstimationJobResponse]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    with the `Create Campaign Recipient Estimation Job` endpoint.<br><br>*Rate limits*:<br>Burst:
    ...
    **Scopes:**
    ...
    Args:
        ...
        fieldscampaign_recipient_estimation_job (Union[Unset,
            List[GetCampaignRecipientEstimationJobFieldscampaignRecipientEstimationJobItem]]):
    ...
    kwargs = _get_kwargs(
        id=id,
        fieldscampaign_recipient_estimation_job=fieldscampaign_recipient_estimation_job,
        revision=revision,
    )
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, GetCampaignRecipientEstimationJobResponse]
    """
