...
from ...models.get_campaign_tag_relationship_list_response_collection import (
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/campaigns/{id}/relationships/tags/",
    }
...
) -> Optional[Union[Any, GetCampaignTagRelationshipListResponseCollection]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetCampaignTagRelationshipListResponseCollection.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetCampaignTagRelationshipListResponseCollection]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Get Campaign Relationships Tags
     ...
     Returns the IDs of all tags associated with the given campaign.<br><br>*Rate limits*:<br>Burst:
    `3/s`<br>Steady: `60/m`
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, GetCampaignTagRelationshipListResponseCollection]
    """
