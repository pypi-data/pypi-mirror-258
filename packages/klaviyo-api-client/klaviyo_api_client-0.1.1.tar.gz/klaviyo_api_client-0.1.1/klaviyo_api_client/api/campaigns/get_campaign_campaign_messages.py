...
from ...models.get_campaign_campaign_messages_fieldscampaign_item import GetCampaignCampaignMessagesFieldscampaignItem
from ...models.get_campaign_campaign_messages_fieldscampaign_message_item import (
    GetCampaignCampaignMessagesFieldscampaignMessageItem,
)
from ...models.get_campaign_campaign_messages_fieldstemplate_item import GetCampaignCampaignMessagesFieldstemplateItem
from ...models.get_campaign_campaign_messages_include_item import GetCampaignCampaignMessagesIncludeItem
from ...models.get_campaign_message_response_collection_compound_document import (
...
def _get_kwargs(
    id: str,
    *,
    fieldscampaign_message: Union[Unset, List[GetCampaignCampaignMessagesFieldscampaignMessageItem]] = UNSET,
    fieldscampaign: Union[Unset, List[GetCampaignCampaignMessagesFieldscampaignItem]] = UNSET,
    fieldstemplate: Union[Unset, List[GetCampaignCampaignMessagesFieldstemplateItem]] = UNSET,
    include: Union[Unset, List[GetCampaignCampaignMessagesIncludeItem]] = UNSET,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/campaigns/{id}/campaign-messages/",
        "params": params,
    }
...
) -> Optional[Union[Any, GetCampaignMessageResponseCollectionCompoundDocument]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetCampaignMessageResponseCollectionCompoundDocument.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetCampaignMessageResponseCollectionCompoundDocument]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Get Campaign Campaign Messages
     ...
     Return all messages that belong to the given campaign.<br><br>*Rate limits*:<br>Burst:
    ...
    **Scopes:**
    ...
    Args:
        id (str):
        fieldscampaign_message (Union[Unset,
            List[GetCampaignCampaignMessagesFieldscampaignMessageItem]]):
        fieldscampaign (Union[Unset, List[GetCampaignCampaignMessagesFieldscampaignItem]]):
        fieldstemplate (Union[Unset, List[GetCampaignCampaignMessagesFieldstemplateItem]]):
        include (Union[Unset, List[GetCampaignCampaignMessagesIncludeItem]]):
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, GetCampaignMessageResponseCollectionCompoundDocument]
    """
