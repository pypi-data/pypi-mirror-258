...
from ...models.campaign_partial_update_query import CampaignPartialUpdateQuery
from ...models.patch_campaign_response import PatchCampaignResponse
...
) -> Optional[Union[Any, PatchCampaignResponse]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = PatchCampaignResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, PatchCampaignResponse]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Update Campaign
     ...
     Update a campaign with the given campaign ID.<br><br>*Rate limits*:<br>Burst: `10/s`<br>Steady:
    `150/m`
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, PatchCampaignResponse]
    """
