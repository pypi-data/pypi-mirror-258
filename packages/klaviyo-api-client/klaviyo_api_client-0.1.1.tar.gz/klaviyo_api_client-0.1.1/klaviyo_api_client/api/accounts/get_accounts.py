...
from ...models.get_account_response_collection import GetAccountResponseCollection
from ...models.get_accounts_fieldsaccount_item import GetAccountsFieldsaccountItem
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    fieldsaccount: Union[Unset, List[GetAccountsFieldsaccountItem]] = UNSET,
    ...
    json_fieldsaccount: Union[Unset, List[str]] = UNSET
    if not isinstance(fieldsaccount, Unset):
        json_fieldsaccount = []
        for fieldsaccount_item_data in fieldsaccount:
            fieldsaccount_item = fieldsaccount_item_data.value
            json_fieldsaccount.append(fieldsaccount_item)

    params["fields[account]"] = json_fieldsaccount
...
) -> Optional[Union[Any, GetAccountResponseCollection]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetAccountResponseCollection.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetAccountResponseCollection]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Get Accounts
     ...
     Retrieve the account(s) associated with a given private API key. This will return 1 account object
    within the array.

    You can use this to retrieve account-specific data (contact information, timezone, currency, Public
    API key, etc.) or test if a Private API Key belongs to the correct account prior to performing
    subsequent actions with the API.<br><br>*Rate limits*:<br>Burst: `1/s`<br>Steady: `15/m`

    **Scopes:**
    `accounts:read`

    Args:
        fieldsaccount (Union[Unset, List[GetAccountsFieldsaccountItem]]):
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, GetAccountResponseCollection]
    """
