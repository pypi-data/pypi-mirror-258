...
from ..models.flow_values_request_dto_resource_object_attributes_statistics_item import (
...
T = TypeVar("T", bound="FlowValuesRequestDTOResourceObjectAttributes")
...
class FlowValuesRequestDTOResourceObjectAttributes:
    """
    Attributes:
        statistics (List[FlowValuesRequestDTOResourceObjectAttributesStatisticsItem]): List of statistics to query for.
    ...
    statistics: List[FlowValuesRequestDTOResourceObjectAttributesStatisticsItem]
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for statistics_item_data in _statistics:
            statistics_item = FlowValuesRequestDTOResourceObjectAttributesStatisticsItem(statistics_item_data)
        ...
        flow_values_request_dto_resource_object_attributes = cls(
            statistics=statistics,
            timeframe=timeframe,
            conversion_metric_id=conversion_metric_id,
            filter_=filter_,
        ...
        flow_values_request_dto_resource_object_attributes.additional_properties = d
        return flow_values_request_dto_resource_object_attributes
