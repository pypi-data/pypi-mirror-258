...
T = TypeVar("T", bound="CatalogItemCategoryOpDataItem")


@_attrs_define
class CatalogItemCategoryOpDataItem:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        catalog_item_category_op_data_item = cls(
            type=type,
            id=id,
        )

        catalog_item_category_op_data_item.additional_properties = d
        return catalog_item_category_op_data_item
