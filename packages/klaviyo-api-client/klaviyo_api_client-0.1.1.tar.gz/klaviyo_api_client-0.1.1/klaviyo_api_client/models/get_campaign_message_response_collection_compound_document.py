...
if TYPE_CHECKING:
    ...
    from ..models.get_campaign_message_response_collection_compound_document_data_item import (
...
T = TypeVar("T", bound="GetCampaignMessageResponseCollectionCompoundDocument")
...
class GetCampaignMessageResponseCollectionCompoundDocument:
    """
    Attributes:
        data (List['GetCampaignMessageResponseCollectionCompoundDocumentDataItem']):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = GetCampaignMessageResponseCollectionCompoundDocumentDataItem.from_dict(data_item_data)
        ...
        get_campaign_message_response_collection_compound_document = cls(
            data=data,
            links=links,
            included=included,
        )

        get_campaign_message_response_collection_compound_document.additional_properties = d
        return get_campaign_message_response_collection_compound_document
