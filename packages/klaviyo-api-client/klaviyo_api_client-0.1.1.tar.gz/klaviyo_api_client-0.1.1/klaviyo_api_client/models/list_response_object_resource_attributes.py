...
from ..models.list_response_object_resource_attributes_opt_in_process import (
    ListResponseObjectResourceAttributesOptInProcess,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ListResponseObjectResourceAttributes")


@_attrs_define
class ListResponseObjectResourceAttributes:
    """
    Attributes:
        ...
        opt_in_process (Union[Unset, ListResponseObjectResourceAttributesOptInProcess]): The opt-in process for this
    ...
    opt_in_process: Union[Unset, ListResponseObjectResourceAttributesOptInProcess] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        opt_in_process: Union[Unset, ListResponseObjectResourceAttributesOptInProcess]
        if isinstance(_opt_in_process, Unset):
            opt_in_process = UNSET
        else:
            opt_in_process = ListResponseObjectResourceAttributesOptInProcess(_opt_in_process)

        list_response_object_resource_attributes = cls(
            name=name,
            created=created,
            updated=updated,
        ...
        list_response_object_resource_attributes.additional_properties = d
        return list_response_object_resource_attributes
