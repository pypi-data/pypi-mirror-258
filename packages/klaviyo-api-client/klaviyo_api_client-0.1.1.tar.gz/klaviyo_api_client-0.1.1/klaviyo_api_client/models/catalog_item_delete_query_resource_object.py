...
T = TypeVar("T", bound="CatalogItemDeleteQueryResourceObject")
...
class CatalogItemDeleteQueryResourceObject:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        catalog_item_delete_query_resource_object = cls(
            type=type,
            id=id,
        )

        catalog_item_delete_query_resource_object.additional_properties = d
        return catalog_item_delete_query_resource_object
