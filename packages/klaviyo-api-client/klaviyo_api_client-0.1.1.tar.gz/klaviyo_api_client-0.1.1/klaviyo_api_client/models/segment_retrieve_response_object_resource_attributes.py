...
T = TypeVar("T", bound="SegmentRetrieveResponseObjectResourceAttributes")
...
class SegmentRetrieveResponseObjectResourceAttributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        segment_retrieve_response_object_resource_attributes = cls(
            name=name,
            created=created,
            updated=updated,
        )

        segment_retrieve_response_object_resource_attributes.additional_properties = d
        return segment_retrieve_response_object_resource_attributes
