...
from ..models.catalog_variant_update_query_resource_object_attributes_inventory_policy import (
    CatalogVariantUpdateQueryResourceObjectAttributesInventoryPolicy,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.catalog_variant_update_query_resource_object_attributes_custom_metadata import (
        CatalogVariantUpdateQueryResourceObjectAttributesCustomMetadata,
    )


T = TypeVar("T", bound="CatalogVariantUpdateQueryResourceObjectAttributes")
...
class CatalogVariantUpdateQueryResourceObjectAttributes:
    ...
    Attributes:
        ...
        inventory_policy (Union[Unset, CatalogVariantUpdateQueryResourceObjectAttributesInventoryPolicy]): This field
        ...
        custom_metadata (Union[Unset, CatalogVariantUpdateQueryResourceObjectAttributesCustomMetadata]): Flat JSON blob
    ...
    inventory_policy: Union[Unset, CatalogVariantUpdateQueryResourceObjectAttributesInventoryPolicy] = UNSET
    ...
    custom_metadata: Union[Unset, "CatalogVariantUpdateQueryResourceObjectAttributesCustomMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        inventory_policy: Union[Unset, CatalogVariantUpdateQueryResourceObjectAttributesInventoryPolicy]
        if isinstance(_inventory_policy, Unset):
            inventory_policy = UNSET
        else:
            inventory_policy = CatalogVariantUpdateQueryResourceObjectAttributesInventoryPolicy(_inventory_policy)
        ...
        custom_metadata: Union[Unset, CatalogVariantUpdateQueryResourceObjectAttributesCustomMetadata]
        if isinstance(_custom_metadata, Unset):
            custom_metadata = UNSET
        else:
            custom_metadata = CatalogVariantUpdateQueryResourceObjectAttributesCustomMetadata.from_dict(
                _custom_metadata
            )

        published = d.pop("published", UNSET)

        catalog_variant_update_query_resource_object_attributes = cls(
            title=title,
        ...
        catalog_variant_update_query_resource_object_attributes.additional_properties = d
        return catalog_variant_update_query_resource_object_attributes
