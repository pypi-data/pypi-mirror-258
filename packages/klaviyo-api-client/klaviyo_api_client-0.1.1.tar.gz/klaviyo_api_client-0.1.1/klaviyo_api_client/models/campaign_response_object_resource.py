...
T = TypeVar("T", bound="CampaignResponseObjectResource")
...
class CampaignResponseObjectResource:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        campaign_response_object_resource = cls(
            type=type,
            id=id,
            attributes=attributes,
            links=links,
        ...
        campaign_response_object_resource.additional_properties = d
        return campaign_response_object_resource
