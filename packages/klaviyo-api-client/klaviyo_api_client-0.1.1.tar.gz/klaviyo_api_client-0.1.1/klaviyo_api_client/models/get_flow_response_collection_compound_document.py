...
if TYPE_CHECKING:
    ...
    from ..models.get_flow_response_collection_compound_document_data_item import (
...
T = TypeVar("T", bound="GetFlowResponseCollectionCompoundDocument")
...
class GetFlowResponseCollectionCompoundDocument:
    """
    Attributes:
        data (List['GetFlowResponseCollectionCompoundDocumentDataItem']):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = GetFlowResponseCollectionCompoundDocumentDataItem.from_dict(data_item_data)
        ...
        get_flow_response_collection_compound_document = cls(
            data=data,
            links=links,
            included=included,
        )

        get_flow_response_collection_compound_document.additional_properties = d
        return get_flow_response_collection_compound_document
