...
T = TypeVar("T", bound="OnsiteProfileCreateQuery")
...
class OnsiteProfileCreateQuery:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        onsite_profile_create_query = cls(
            data=data,
        )

        onsite_profile_create_query.additional_properties = d
        return onsite_profile_create_query
