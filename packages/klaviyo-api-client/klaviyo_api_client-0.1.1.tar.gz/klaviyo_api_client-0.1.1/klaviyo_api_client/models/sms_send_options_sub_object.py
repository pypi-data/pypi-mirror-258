...
T = TypeVar("T", bound="SMSSendOptionsSubObject")
...
class SMSSendOptionsSubObject:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        sms_send_options_sub_object = cls(
            use_smart_sending=use_smart_sending,
        )

        sms_send_options_sub_object.additional_properties = d
        return sms_send_options_sub_object
