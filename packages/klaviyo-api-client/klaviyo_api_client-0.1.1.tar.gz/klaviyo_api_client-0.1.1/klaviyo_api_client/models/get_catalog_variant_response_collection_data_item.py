...
if TYPE_CHECKING:
    ...
    from ..models.get_catalog_variant_response_collection_data_item_relationships import (
        GetCatalogVariantResponseCollectionDataItemRelationships,
    )
    from ..models.object_links import ObjectLinks


T = TypeVar("T", bound="GetCatalogVariantResponseCollectionDataItem")


@_attrs_define
class GetCatalogVariantResponseCollectionDataItem:
    """
    Attributes:
        ...
        links (ObjectLinks):
        relationships (Union[Unset, GetCatalogVariantResponseCollectionDataItemRelationships]):
    """
    ...
    attributes: "CatalogVariantResponseObjectResourceAttributes"
    links: "ObjectLinks"
    relationships: Union[Unset, "GetCatalogVariantResponseCollectionDataItemRelationships"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_relationships, Unset):
            ...
            relationships = GetCatalogVariantResponseCollectionDataItemRelationships.from_dict(_relationships)

        get_catalog_variant_response_collection_data_item = cls(
            type=type,
            id=id,
            attributes=attributes,
            links=links,
        ...
        get_catalog_variant_response_collection_data_item.additional_properties = d
        return get_catalog_variant_response_collection_data_item
