...
T = TypeVar("T", bound="TemplateResponseObjectResourceAttributes")
...
class TemplateResponseObjectResourceAttributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        template_response_object_resource_attributes = cls(
            name=name,
            editor_type=editor_type,
            html=html,
            text=text,
        ...
        template_response_object_resource_attributes.additional_properties = d
        return template_response_object_resource_attributes
