...
from ..models.catalog_item_delete_job_response_object_resource_attributes_status import (
...
T = TypeVar("T", bound="CatalogItemDeleteJobResponseObjectResourceAttributes")


@_attrs_define
class CatalogItemDeleteJobResponseObjectResourceAttributes:
    """
    Attributes:
        status (CatalogItemDeleteJobResponseObjectResourceAttributesStatus): Status of the asynchronous job. Example:
            processing.
    ...
    status: CatalogItemDeleteJobResponseObjectResourceAttributesStatus
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        status = CatalogItemDeleteJobResponseObjectResourceAttributesStatus(d.pop("status"))
        ...
        catalog_item_delete_job_response_object_resource_attributes = cls(
            status=status,
            created_at=created_at,
            total_count=total_count,
        ...
        catalog_item_delete_job_response_object_resource_attributes.additional_properties = d
        return catalog_item_delete_job_response_object_resource_attributes
