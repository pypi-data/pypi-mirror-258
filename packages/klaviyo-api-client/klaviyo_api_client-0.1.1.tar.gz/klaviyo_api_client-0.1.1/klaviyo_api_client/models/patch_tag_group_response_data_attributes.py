...
T = TypeVar("T", bound="PatchTagGroupResponseDataAttributes")


@_attrs_define
class PatchTagGroupResponseDataAttributes:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        patch_tag_group_response_data_attributes = cls(
            name=name,
            exclusive=exclusive,
            default=default,
        )

        patch_tag_group_response_data_attributes.additional_properties = d
        return patch_tag_group_response_data_attributes
