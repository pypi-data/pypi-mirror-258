...
T = TypeVar("T", bound="CatalogCategoryUpdateJobResponseObjectResource")
...
class CatalogCategoryUpdateJobResponseObjectResource:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        catalog_category_update_job_response_object_resource = cls(
            type=type,
            id=id,
            attributes=attributes,
            links=links,
        ...
        catalog_category_update_job_response_object_resource.additional_properties = d
        return catalog_category_update_job_response_object_resource
