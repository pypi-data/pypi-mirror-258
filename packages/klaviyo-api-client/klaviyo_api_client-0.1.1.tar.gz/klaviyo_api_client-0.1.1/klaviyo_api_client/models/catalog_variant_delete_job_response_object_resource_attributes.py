...
from ..models.catalog_variant_delete_job_response_object_resource_attributes_status import (
...
T = TypeVar("T", bound="CatalogVariantDeleteJobResponseObjectResourceAttributes")


@_attrs_define
class CatalogVariantDeleteJobResponseObjectResourceAttributes:
    """
    Attributes:
        status (CatalogVariantDeleteJobResponseObjectResourceAttributesStatus): Status of the asynchronous job. Example:
            processing.
    ...
    status: CatalogVariantDeleteJobResponseObjectResourceAttributesStatus
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        status = CatalogVariantDeleteJobResponseObjectResourceAttributesStatus(d.pop("status"))
        ...
        catalog_variant_delete_job_response_object_resource_attributes = cls(
            status=status,
            created_at=created_at,
            total_count=total_count,
        ...
        catalog_variant_delete_job_response_object_resource_attributes.additional_properties = d
        return catalog_variant_delete_job_response_object_resource_attributes
