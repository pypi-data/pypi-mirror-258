...
if TYPE_CHECKING:
    ...
    from ..models.get_catalog_category_response_data_relationships import GetCatalogCategoryResponseDataRelationships
    from ..models.object_links import ObjectLinks


T = TypeVar("T", bound="GetCatalogCategoryResponseData")


@_attrs_define
class GetCatalogCategoryResponseData:
    """
    Attributes:
        ...
        links (ObjectLinks):
        relationships (Union[Unset, GetCatalogCategoryResponseDataRelationships]):
    """
    ...
    attributes: "CatalogCategoryResponseObjectResourceAttributes"
    links: "ObjectLinks"
    relationships: Union[Unset, "GetCatalogCategoryResponseDataRelationships"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        from ..models.get_catalog_category_response_data_relationships import (
        ...
        if isinstance(_relationships, Unset):
            ...
            relationships = GetCatalogCategoryResponseDataRelationships.from_dict(_relationships)

        get_catalog_category_response_data = cls(
            type=type,
            id=id,
            attributes=attributes,
            links=links,
        ...
        get_catalog_category_response_data.additional_properties = d
        return get_catalog_category_response_data
