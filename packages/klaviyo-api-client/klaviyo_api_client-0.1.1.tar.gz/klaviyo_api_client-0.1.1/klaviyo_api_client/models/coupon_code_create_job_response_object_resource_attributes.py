...
from ..models.coupon_code_create_job_response_object_resource_attributes_status import (
...
T = TypeVar("T", bound="CouponCodeCreateJobResponseObjectResourceAttributes")
...
class CouponCodeCreateJobResponseObjectResourceAttributes:
    """
    Attributes:
        status (CouponCodeCreateJobResponseObjectResourceAttributesStatus): Status of the asynchronous job. Example:
            processing.
    ...
    status: CouponCodeCreateJobResponseObjectResourceAttributesStatus
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        status = CouponCodeCreateJobResponseObjectResourceAttributesStatus(d.pop("status"))
        ...
        coupon_code_create_job_response_object_resource_attributes = cls(
            status=status,
            created_at=created_at,
            total_count=total_count,
        ...
        coupon_code_create_job_response_object_resource_attributes.additional_properties = d
        return coupon_code_create_job_response_object_resource_attributes
