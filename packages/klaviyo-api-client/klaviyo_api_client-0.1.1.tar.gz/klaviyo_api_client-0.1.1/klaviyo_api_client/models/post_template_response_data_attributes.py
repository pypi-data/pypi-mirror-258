...
T = TypeVar("T", bound="PostTemplateResponseDataAttributes")


@_attrs_define
class PostTemplateResponseDataAttributes:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        post_template_response_data_attributes = cls(
            name=name,
            editor_type=editor_type,
            html=html,
            text=text,
        ...
        post_template_response_data_attributes.additional_properties = d
        return post_template_response_data_attributes
