...
from ..models.catalog_variant_create_job_response_object_resource_attributes_status import (
...
T = TypeVar("T", bound="CatalogVariantCreateJobResponseObjectResourceAttributes")


@_attrs_define
class CatalogVariantCreateJobResponseObjectResourceAttributes:
    """
    Attributes:
        status (CatalogVariantCreateJobResponseObjectResourceAttributesStatus): Status of the asynchronous job. Example:
            processing.
    ...
    status: CatalogVariantCreateJobResponseObjectResourceAttributesStatus
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        status = CatalogVariantCreateJobResponseObjectResourceAttributesStatus(d.pop("status"))
        ...
        catalog_variant_create_job_response_object_resource_attributes = cls(
            status=status,
            created_at=created_at,
            total_count=total_count,
        ...
        catalog_variant_create_job_response_object_resource_attributes.additional_properties = d
        return catalog_variant_create_job_response_object_resource_attributes
