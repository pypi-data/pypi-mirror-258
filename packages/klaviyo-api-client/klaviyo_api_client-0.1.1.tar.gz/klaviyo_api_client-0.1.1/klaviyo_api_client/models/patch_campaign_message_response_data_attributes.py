...
T = TypeVar("T", bound="PatchCampaignMessageResponseDataAttributes")


@_attrs_define
class PatchCampaignMessageResponseDataAttributes:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        patch_campaign_message_response_data_attributes = cls(
            label=label,
            channel=channel,
            content=content,
        ...
        patch_campaign_message_response_data_attributes.additional_properties = d
        return patch_campaign_message_response_data_attributes
