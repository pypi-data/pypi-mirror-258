...
T = TypeVar("T", bound="SMSSubscriptionParameters")
...
class SMSSubscriptionParameters:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        sms_subscription_parameters = cls(
            marketing=marketing,
        )

        sms_subscription_parameters.additional_properties = d
        return sms_subscription_parameters
