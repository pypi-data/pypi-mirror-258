...
T = TypeVar("T", bound="FlowResponseObjectResource")
...
class FlowResponseObjectResource:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        flow_response_object_resource = cls(
            type=type,
            id=id,
            attributes=attributes,
            links=links,
        ...
        flow_response_object_resource.additional_properties = d
        return flow_response_object_resource
