...
if TYPE_CHECKING:
    from ..models.profile_create_query_resource_object_attributes_properties import (
        ProfileCreateQueryResourceObjectAttributesProperties,
    )
    from ..models.profile_location import ProfileLocation


T = TypeVar("T", bound="ProfileCreateQueryResourceObjectAttributes")
...
class ProfileCreateQueryResourceObjectAttributes:
    ...
    Attributes:
        ...
        properties (Union[Unset, ProfileCreateQueryResourceObjectAttributesProperties]): An object containing key/value
    ...
    properties: Union[Unset, "ProfileCreateQueryResourceObjectAttributesProperties"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        properties: Union[Unset, ProfileCreateQueryResourceObjectAttributesProperties]
        if isinstance(_properties, Unset):
            properties = UNSET
        else:
            properties = ProfileCreateQueryResourceObjectAttributesProperties.from_dict(_properties)

        profile_create_query_resource_object_attributes = cls(
            email=email,
        ...
        profile_create_query_resource_object_attributes.additional_properties = d
        return profile_create_query_resource_object_attributes
