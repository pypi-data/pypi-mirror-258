...
T = TypeVar("T", bound="PostCampaignResponseDataAttributes")


@_attrs_define
class PostCampaignResponseDataAttributes:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        post_campaign_response_data_attributes = cls(
            name=name,
            status=status,
            archived=archived,
            audiences=audiences,
        ...
        post_campaign_response_data_attributes.additional_properties = d
        return post_campaign_response_data_attributes
