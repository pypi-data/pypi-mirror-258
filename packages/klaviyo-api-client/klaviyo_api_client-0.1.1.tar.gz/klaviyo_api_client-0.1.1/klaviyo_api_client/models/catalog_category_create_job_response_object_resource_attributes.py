...
from ..models.catalog_category_create_job_response_object_resource_attributes_status import (
...
T = TypeVar("T", bound="CatalogCategoryCreateJobResponseObjectResourceAttributes")


@_attrs_define
class CatalogCategoryCreateJobResponseObjectResourceAttributes:
    """
    Attributes:
        status (CatalogCategoryCreateJobResponseObjectResourceAttributesStatus): Status of the asynchronous job.
            Example: processing.
    ...
    status: CatalogCategoryCreateJobResponseObjectResourceAttributesStatus
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        status = CatalogCategoryCreateJobResponseObjectResourceAttributesStatus(d.pop("status"))
        ...
        catalog_category_create_job_response_object_resource_attributes = cls(
            status=status,
            created_at=created_at,
            total_count=total_count,
        ...
        catalog_category_create_job_response_object_resource_attributes.additional_properties = d
        return catalog_category_create_job_response_object_resource_attributes
