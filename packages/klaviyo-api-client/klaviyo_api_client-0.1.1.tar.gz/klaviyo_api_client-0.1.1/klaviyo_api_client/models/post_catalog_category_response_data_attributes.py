...
T = TypeVar("T", bound="PostCatalogCategoryResponseDataAttributes")


@_attrs_define
class PostCatalogCategoryResponseDataAttributes:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        post_catalog_category_response_data_attributes = cls(
            external_id=external_id,
            name=name,
            updated=updated,
        )

        post_catalog_category_response_data_attributes.additional_properties = d
        return post_catalog_category_response_data_attributes
