...
T = TypeVar("T", bound="PatchSegmentPartialUpdateResponseDataAttributes")


@_attrs_define
class PatchSegmentPartialUpdateResponseDataAttributes:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        patch_segment_partial_update_response_data_attributes = cls(
            name=name,
            created=created,
            updated=updated,
        )

        patch_segment_partial_update_response_data_attributes.additional_properties = d
        return patch_segment_partial_update_response_data_attributes
