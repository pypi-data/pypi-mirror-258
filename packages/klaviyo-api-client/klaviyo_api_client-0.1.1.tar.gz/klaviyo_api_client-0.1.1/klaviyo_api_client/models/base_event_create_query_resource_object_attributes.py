...
if TYPE_CHECKING:
    from ..models.base_event_create_query_resource_object_attributes_metric import (
        BaseEventCreateQueryResourceObjectAttributesMetric,
    )
    from ..models.base_event_create_query_resource_object_attributes_properties import (
        BaseEventCreateQueryResourceObjectAttributesProperties,
    )


T = TypeVar("T", bound="BaseEventCreateQueryResourceObjectAttributes")
...
class BaseEventCreateQueryResourceObjectAttributes:
    """
    Attributes:
        properties (BaseEventCreateQueryResourceObjectAttributesProperties): Properties of this event. Any top level
    ...
    properties: "BaseEventCreateQueryResourceObjectAttributesProperties"
    metric: "BaseEventCreateQueryResourceObjectAttributesMetric"
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        properties = BaseEventCreateQueryResourceObjectAttributesProperties.from_dict(d.pop("properties"))

        metric = BaseEventCreateQueryResourceObjectAttributesMetric.from_dict(d.pop("metric"))
        ...
        base_event_create_query_resource_object_attributes = cls(
            properties=properties,
            metric=metric,
            time=time,
            value=value,
        ...
        base_event_create_query_resource_object_attributes.additional_properties = d
        return base_event_create_query_resource_object_attributes
