...
T = TypeVar("T", bound="FlowMessageResponseObjectResource")
...
class FlowMessageResponseObjectResource:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        flow_message_response_object_resource = cls(
            type=type,
            id=id,
            attributes=attributes,
            links=links,
        ...
        flow_message_response_object_resource.additional_properties = d
        return flow_message_response_object_resource
