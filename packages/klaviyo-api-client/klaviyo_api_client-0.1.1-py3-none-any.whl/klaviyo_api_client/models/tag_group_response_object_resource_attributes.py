...
T = TypeVar("T", bound="TagGroupResponseObjectResourceAttributes")
...
class TagGroupResponseObjectResourceAttributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        tag_group_response_object_resource_attributes = cls(
            name=name,
            exclusive=exclusive,
            default=default,
        )

        tag_group_response_object_resource_attributes.additional_properties = d
        return tag_group_response_object_resource_attributes
