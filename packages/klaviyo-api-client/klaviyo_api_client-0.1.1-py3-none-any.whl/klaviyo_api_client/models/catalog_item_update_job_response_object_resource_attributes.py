...
from ..models.catalog_item_update_job_response_object_resource_attributes_status import (
...
T = TypeVar("T", bound="CatalogItemUpdateJobResponseObjectResourceAttributes")


@_attrs_define
class CatalogItemUpdateJobResponseObjectResourceAttributes:
    """
    Attributes:
        status (CatalogItemUpdateJobResponseObjectResourceAttributesStatus): Status of the asynchronous job. Example:
            processing.
    ...
    status: CatalogItemUpdateJobResponseObjectResourceAttributesStatus
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        status = CatalogItemUpdateJobResponseObjectResourceAttributesStatus(d.pop("status"))
        ...
        catalog_item_update_job_response_object_resource_attributes = cls(
            status=status,
            created_at=created_at,
            total_count=total_count,
        ...
        catalog_item_update_job_response_object_resource_attributes.additional_properties = d
        return catalog_item_update_job_response_object_resource_attributes
