...
from ..models.post_coupon_code_create_job_response_data_attributes_status import (
...
T = TypeVar("T", bound="PostCouponCodeCreateJobResponseDataAttributes")


@_attrs_define
class PostCouponCodeCreateJobResponseDataAttributes:
    """
    Attributes:
        status (PostCouponCodeCreateJobResponseDataAttributesStatus): Status of the asynchronous job. Example:
            processing.
    ...
    status: PostCouponCodeCreateJobResponseDataAttributesStatus
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        status = PostCouponCodeCreateJobResponseDataAttributesStatus(d.pop("status"))
        ...
        post_coupon_code_create_job_response_data_attributes = cls(
            status=status,
            created_at=created_at,
            total_count=total_count,
        ...
        post_coupon_code_create_job_response_data_attributes.additional_properties = d
        return post_coupon_code_create_job_response_data_attributes
