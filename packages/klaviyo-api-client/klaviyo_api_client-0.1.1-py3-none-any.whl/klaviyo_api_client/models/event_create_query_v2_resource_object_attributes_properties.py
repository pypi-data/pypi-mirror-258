...
T = TypeVar("T", bound="EventCreateQueryV2ResourceObjectAttributesProperties")


@_attrs_define
class EventCreateQueryV2ResourceObjectAttributesProperties:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        event_create_query_v2_resource_object_attributes_properties = cls()

        event_create_query_v2_resource_object_attributes_properties.additional_properties = d
        return event_create_query_v2_resource_object_attributes_properties
