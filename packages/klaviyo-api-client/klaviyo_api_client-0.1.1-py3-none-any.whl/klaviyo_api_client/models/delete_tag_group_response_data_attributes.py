...
T = TypeVar("T", bound="DeleteTagGroupResponseDataAttributes")


@_attrs_define
class DeleteTagGroupResponseDataAttributes:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        delete_tag_group_response_data_attributes = cls(
            name=name,
            exclusive=exclusive,
            default=default,
        )

        delete_tag_group_response_data_attributes.additional_properties = d
        return delete_tag_group_response_data_attributes
