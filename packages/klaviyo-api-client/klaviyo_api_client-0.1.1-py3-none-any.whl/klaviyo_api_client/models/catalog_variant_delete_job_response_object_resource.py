...
T = TypeVar("T", bound="CatalogVariantDeleteJobResponseObjectResource")
...
class CatalogVariantDeleteJobResponseObjectResource:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        catalog_variant_delete_job_response_object_resource = cls(
            type=type,
            id=id,
            attributes=attributes,
            links=links,
        ...
        catalog_variant_delete_job_response_object_resource.additional_properties = d
        return catalog_variant_delete_job_response_object_resource
