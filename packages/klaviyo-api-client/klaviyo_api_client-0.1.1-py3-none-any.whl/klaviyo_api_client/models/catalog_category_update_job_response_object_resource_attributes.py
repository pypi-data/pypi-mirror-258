...
from ..models.catalog_category_update_job_response_object_resource_attributes_status import (
...
T = TypeVar("T", bound="CatalogCategoryUpdateJobResponseObjectResourceAttributes")


@_attrs_define
class CatalogCategoryUpdateJobResponseObjectResourceAttributes:
    """
    Attributes:
        status (CatalogCategoryUpdateJobResponseObjectResourceAttributesStatus): Status of the asynchronous job.
            Example: processing.
    ...
    status: CatalogCategoryUpdateJobResponseObjectResourceAttributesStatus
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        status = CatalogCategoryUpdateJobResponseObjectResourceAttributesStatus(d.pop("status"))
        ...
        catalog_category_update_job_response_object_resource_attributes = cls(
            status=status,
            created_at=created_at,
            total_count=total_count,
        ...
        catalog_category_update_job_response_object_resource_attributes.additional_properties = d
        return catalog_category_update_job_response_object_resource_attributes
