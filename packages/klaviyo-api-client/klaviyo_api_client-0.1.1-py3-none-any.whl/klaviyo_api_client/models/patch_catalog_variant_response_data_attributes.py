...
from ..models.patch_catalog_variant_response_data_attributes_inventory_policy import (
    PatchCatalogVariantResponseDataAttributesInventoryPolicy,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.patch_catalog_variant_response_data_attributes_custom_metadata import (
        PatchCatalogVariantResponseDataAttributesCustomMetadata,
    )


T = TypeVar("T", bound="PatchCatalogVariantResponseDataAttributes")


@_attrs_define
class PatchCatalogVariantResponseDataAttributes:
    """
    Attributes:
        ...
        inventory_policy (Union[Unset, PatchCatalogVariantResponseDataAttributesInventoryPolicy]): This field controls
            the visibility of this catalog item variant in product feeds/blocks. This field supports the following values:
        ...
        custom_metadata (Union[Unset, PatchCatalogVariantResponseDataAttributesCustomMetadata]): Flat JSON blob to
    ...
    inventory_policy: Union[Unset, PatchCatalogVariantResponseDataAttributesInventoryPolicy] = UNSET
    ...
    custom_metadata: Union[Unset, "PatchCatalogVariantResponseDataAttributesCustomMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        inventory_policy: Union[Unset, PatchCatalogVariantResponseDataAttributesInventoryPolicy]
        if isinstance(_inventory_policy, Unset):
            inventory_policy = UNSET
        else:
            inventory_policy = PatchCatalogVariantResponseDataAttributesInventoryPolicy(_inventory_policy)
        ...
        custom_metadata: Union[Unset, PatchCatalogVariantResponseDataAttributesCustomMetadata]
        if isinstance(_custom_metadata, Unset):
            custom_metadata = UNSET
        else:
            custom_metadata = PatchCatalogVariantResponseDataAttributesCustomMetadata.from_dict(_custom_metadata)
        ...
        patch_catalog_variant_response_data_attributes = cls(
        ...
        patch_catalog_variant_response_data_attributes.additional_properties = d
        return patch_catalog_variant_response_data_attributes
