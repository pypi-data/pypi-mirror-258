...
if TYPE_CHECKING:
    from ..models.post_catalog_item_response_data_attributes_custom_metadata import (
        PostCatalogItemResponseDataAttributesCustomMetadata,
    )


T = TypeVar("T", bound="PostCatalogItemResponseDataAttributes")


@_attrs_define
class PostCatalogItemResponseDataAttributes:
    """
    Attributes:
        ...
        images (Union[Unset, List[str]]): List of URLs pointing to the locations of images of the catalog item. Example:
            ['https://via.placeholder.com/150'].
        custom_metadata (Union[Unset, PostCatalogItemResponseDataAttributesCustomMetadata]): Flat JSON blob to provide
    ...
    custom_metadata: Union[Unset, "PostCatalogItemResponseDataAttributesCustomMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        custom_metadata: Union[Unset, PostCatalogItemResponseDataAttributesCustomMetadata]
        if isinstance(_custom_metadata, Unset):
            custom_metadata = UNSET
        else:
            custom_metadata = PostCatalogItemResponseDataAttributesCustomMetadata.from_dict(_custom_metadata)
        ...
        post_catalog_item_response_data_attributes = cls(
        ...
        post_catalog_item_response_data_attributes.additional_properties = d
        return post_catalog_item_response_data_attributes
