...
T = TypeVar("T", bound="EventResponseObjectResource")
...
class EventResponseObjectResource:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        event_response_object_resource = cls(
            type=type,
            id=id,
            attributes=attributes,
            links=links,
        ...
        event_response_object_resource.additional_properties = d
        return event_response_object_resource
