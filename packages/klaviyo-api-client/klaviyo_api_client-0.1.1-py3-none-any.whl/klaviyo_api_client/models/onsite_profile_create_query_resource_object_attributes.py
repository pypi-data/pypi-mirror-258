...
if TYPE_CHECKING:
    from ..models.onsite_profile_create_query_resource_object_attributes_properties import (
        OnsiteProfileCreateQueryResourceObjectAttributesProperties,
    )
    from ..models.profile_location import ProfileLocation


T = TypeVar("T", bound="OnsiteProfileCreateQueryResourceObjectAttributes")
...
class OnsiteProfileCreateQueryResourceObjectAttributes:
    ...
    Attributes:
        ...
        properties (Union[Unset, OnsiteProfileCreateQueryResourceObjectAttributesProperties]): An object containing
    ...
    properties: Union[Unset, "OnsiteProfileCreateQueryResourceObjectAttributesProperties"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        properties: Union[Unset, OnsiteProfileCreateQueryResourceObjectAttributesProperties]
        if isinstance(_properties, Unset):
            properties = UNSET
        else:
            properties = OnsiteProfileCreateQueryResourceObjectAttributesProperties.from_dict(_properties)

        onsite_profile_create_query_resource_object_attributes = cls(
            email=email,
        ...
        onsite_profile_create_query_resource_object_attributes.additional_properties = d
        return onsite_profile_create_query_resource_object_attributes
