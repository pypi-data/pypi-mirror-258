...
if TYPE_CHECKING:
    ...
    from ..models.get_catalog_item_response_compound_document_data_relationships import (
        GetCatalogItemResponseCompoundDocumentDataRelationships,
    )
    from ..models.object_links import ObjectLinks


T = TypeVar("T", bound="GetCatalogItemResponseCompoundDocumentData")


@_attrs_define
class GetCatalogItemResponseCompoundDocumentData:
    """
    Attributes:
        ...
        links (ObjectLinks):
        relationships (Union[Unset, GetCatalogItemResponseCompoundDocumentDataRelationships]):
    """
    ...
    attributes: "CatalogItemResponseObjectResourceAttributes"
    links: "ObjectLinks"
    relationships: Union[Unset, "GetCatalogItemResponseCompoundDocumentDataRelationships"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_relationships, Unset):
            ...
            relationships = GetCatalogItemResponseCompoundDocumentDataRelationships.from_dict(_relationships)

        get_catalog_item_response_compound_document_data = cls(
            type=type,
            id=id,
            attributes=attributes,
            links=links,
        ...
        get_catalog_item_response_compound_document_data.additional_properties = d
        return get_catalog_item_response_compound_document_data
