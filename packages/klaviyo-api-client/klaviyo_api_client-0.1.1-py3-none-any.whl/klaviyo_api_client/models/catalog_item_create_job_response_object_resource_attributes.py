...
from ..models.catalog_item_create_job_response_object_resource_attributes_status import (
...
T = TypeVar("T", bound="CatalogItemCreateJobResponseObjectResourceAttributes")


@_attrs_define
class CatalogItemCreateJobResponseObjectResourceAttributes:
    """
    Attributes:
        status (CatalogItemCreateJobResponseObjectResourceAttributesStatus): Status of the asynchronous job. Example:
            processing.
    ...
    status: CatalogItemCreateJobResponseObjectResourceAttributesStatus
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        status = CatalogItemCreateJobResponseObjectResourceAttributesStatus(d.pop("status"))
        ...
        catalog_item_create_job_response_object_resource_attributes = cls(
            status=status,
            created_at=created_at,
            total_count=total_count,
        ...
        catalog_item_create_job_response_object_resource_attributes.additional_properties = d
        return catalog_item_create_job_response_object_resource_attributes
