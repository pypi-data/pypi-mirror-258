...
T = TypeVar("T", bound="SegmentListResponseObjectResourceAttributes")
...
class SegmentListResponseObjectResourceAttributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        segment_list_response_object_resource_attributes = cls(
            name=name,
            created=created,
            updated=updated,
        )

        segment_list_response_object_resource_attributes.additional_properties = d
        return segment_list_response_object_resource_attributes
