...
from ..models.post_catalog_variant_response_data_attributes_inventory_policy import (
    PostCatalogVariantResponseDataAttributesInventoryPolicy,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.post_catalog_variant_response_data_attributes_custom_metadata import (
        PostCatalogVariantResponseDataAttributesCustomMetadata,
    )


T = TypeVar("T", bound="PostCatalogVariantResponseDataAttributes")


@_attrs_define
class PostCatalogVariantResponseDataAttributes:
    """
    Attributes:
        ...
        inventory_policy (Union[Unset, PostCatalogVariantResponseDataAttributesInventoryPolicy]): This field controls
        ...
        custom_metadata (Union[Unset, PostCatalogVariantResponseDataAttributesCustomMetadata]): Flat JSON blob to
    ...
    inventory_policy: Union[Unset, PostCatalogVariantResponseDataAttributesInventoryPolicy] = UNSET
    ...
    custom_metadata: Union[Unset, "PostCatalogVariantResponseDataAttributesCustomMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        inventory_policy: Union[Unset, PostCatalogVariantResponseDataAttributesInventoryPolicy]
        if isinstance(_inventory_policy, Unset):
            inventory_policy = UNSET
        else:
            inventory_policy = PostCatalogVariantResponseDataAttributesInventoryPolicy(_inventory_policy)
        ...
        custom_metadata: Union[Unset, PostCatalogVariantResponseDataAttributesCustomMetadata]
        if isinstance(_custom_metadata, Unset):
            custom_metadata = UNSET
        else:
            custom_metadata = PostCatalogVariantResponseDataAttributesCustomMetadata.from_dict(_custom_metadata)
        ...
        post_catalog_variant_response_data_attributes = cls(
        ...
        post_catalog_variant_response_data_attributes.additional_properties = d
        return post_catalog_variant_response_data_attributes
