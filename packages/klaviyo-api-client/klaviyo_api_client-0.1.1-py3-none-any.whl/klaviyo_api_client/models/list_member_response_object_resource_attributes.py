...
if TYPE_CHECKING:
    from ..models.list_member_response_object_resource_attributes_properties import (
        ListMemberResponseObjectResourceAttributesProperties,
    )
    from ..models.profile_location import ProfileLocation


T = TypeVar("T", bound="ListMemberResponseObjectResourceAttributes")
...
class ListMemberResponseObjectResourceAttributes:
    """
    Attributes:
        joined_group_at (datetime.datetime): The datetime when this profile most recently joined the list. Example:
            2022-11-08T00:00:00.
        ...
        properties (Union[Unset, ListMemberResponseObjectResourceAttributesProperties]): An object containing key/value
    ...
    properties: Union[Unset, "ListMemberResponseObjectResourceAttributesProperties"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        properties: Union[Unset, ListMemberResponseObjectResourceAttributesProperties]
        if isinstance(_properties, Unset):
            properties = UNSET
        else:
            properties = ListMemberResponseObjectResourceAttributesProperties.from_dict(_properties)

        list_member_response_object_resource_attributes = cls(
            joined_group_at=joined_group_at,
            email=email,
        ...
        list_member_response_object_resource_attributes.additional_properties = d
        return list_member_response_object_resource_attributes
