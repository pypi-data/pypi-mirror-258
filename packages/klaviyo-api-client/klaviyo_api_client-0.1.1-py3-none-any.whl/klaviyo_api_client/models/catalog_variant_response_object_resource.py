...
T = TypeVar("T", bound="CatalogVariantResponseObjectResource")
...
class CatalogVariantResponseObjectResource:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        catalog_variant_response_object_resource = cls(
            type=type,
            id=id,
            attributes=attributes,
            links=links,
        ...
        catalog_variant_response_object_resource.additional_properties = d
        return catalog_variant_response_object_resource
