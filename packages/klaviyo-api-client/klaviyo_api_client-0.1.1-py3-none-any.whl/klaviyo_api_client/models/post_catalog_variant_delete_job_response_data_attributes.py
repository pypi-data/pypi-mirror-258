...
from ..models.post_catalog_variant_delete_job_response_data_attributes_status import (
...
T = TypeVar("T", bound="PostCatalogVariantDeleteJobResponseDataAttributes")


@_attrs_define
class PostCatalogVariantDeleteJobResponseDataAttributes:
    """
    Attributes:
        status (PostCatalogVariantDeleteJobResponseDataAttributesStatus): Status of the asynchronous job. Example:
            processing.
    ...
    status: PostCatalogVariantDeleteJobResponseDataAttributesStatus
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        status = PostCatalogVariantDeleteJobResponseDataAttributesStatus(d.pop("status"))
        ...
        post_catalog_variant_delete_job_response_data_attributes = cls(
            status=status,
            created_at=created_at,
            total_count=total_count,
        ...
        post_catalog_variant_delete_job_response_data_attributes.additional_properties = d
        return post_catalog_variant_delete_job_response_data_attributes
