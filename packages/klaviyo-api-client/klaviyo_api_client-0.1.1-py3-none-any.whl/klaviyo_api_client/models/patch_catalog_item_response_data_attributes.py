...
if TYPE_CHECKING:
    from ..models.patch_catalog_item_response_data_attributes_custom_metadata import (
        PatchCatalogItemResponseDataAttributesCustomMetadata,
    )


T = TypeVar("T", bound="PatchCatalogItemResponseDataAttributes")


@_attrs_define
class PatchCatalogItemResponseDataAttributes:
    """
    Attributes:
        ...
        images (Union[Unset, List[str]]): List of URLs pointing to the locations of images of the catalog item. Example:
            ['https://via.placeholder.com/150'].
        custom_metadata (Union[Unset, PatchCatalogItemResponseDataAttributesCustomMetadata]): Flat JSON blob to provide
            custom metadata about the catalog item. May not exceed 100kb. Example: {'Top Pick': True}.
    ...
    custom_metadata: Union[Unset, "PatchCatalogItemResponseDataAttributesCustomMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        custom_metadata: Union[Unset, PatchCatalogItemResponseDataAttributesCustomMetadata]
        if isinstance(_custom_metadata, Unset):
            custom_metadata = UNSET
        else:
            custom_metadata = PatchCatalogItemResponseDataAttributesCustomMetadata.from_dict(_custom_metadata)
        ...
        patch_catalog_item_response_data_attributes = cls(
        ...
        patch_catalog_item_response_data_attributes.additional_properties = d
        return patch_catalog_item_response_data_attributes
