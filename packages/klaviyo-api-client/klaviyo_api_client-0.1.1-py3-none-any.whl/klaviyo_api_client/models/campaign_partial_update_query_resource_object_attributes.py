...
T = TypeVar("T", bound="CampaignPartialUpdateQueryResourceObjectAttributes")
...
class CampaignPartialUpdateQueryResourceObjectAttributes:
    """
    Attributes:
        name (Union[Unset, str]): The campaign name Example: My new campaign.
        audiences (Union[Unset, AudiencesSubObject]):
    ...
    audiences: Union[Unset, "AudiencesSubObject"] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        audiences: Union[Unset, Dict[str, Any]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        audiences: Union[Unset, AudiencesSubObject]
        if isinstance(_audiences, Unset):
            audiences = UNSET
        else:
            audiences = AudiencesSubObject.from_dict(_audiences)
        ...
        campaign_partial_update_query_resource_object_attributes = cls(
            name=name,
            audiences=audiences,
        ...
        campaign_partial_update_query_resource_object_attributes.additional_properties = d
        return campaign_partial_update_query_resource_object_attributes
