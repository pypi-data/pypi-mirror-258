...
T = TypeVar("T", bound="CatalogVariantDeleteQueryResourceObject")
...
class CatalogVariantDeleteQueryResourceObject:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        catalog_variant_delete_query_resource_object = cls(
            type=type,
            id=id,
        )

        catalog_variant_delete_query_resource_object.additional_properties = d
        return catalog_variant_delete_query_resource_object
