...
if TYPE_CHECKING:
    ...
    from ..models.segment_member_response_object_resource_attributes_properties import (
        SegmentMemberResponseObjectResourceAttributesProperties,
    )


T = TypeVar("T", bound="SegmentMemberResponseObjectResourceAttributes")
...
class SegmentMemberResponseObjectResourceAttributes:
    """
    Attributes:
        joined_group_at (datetime.datetime): The datetime when this profile most recently joined the segment. Example:
            2022-11-08T00:00:00.
        ...
        properties (Union[Unset, SegmentMemberResponseObjectResourceAttributesProperties]): An object containing
            key/value pairs for any custom properties assigned to this profile Example: {'pseudonym': 'Dr. Octopus'}.
    """

    joined_group_at: datetime.datetime
    ...
    properties: Union[Unset, "SegmentMemberResponseObjectResourceAttributesProperties"] = UNSET
    additional_properties: Dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> Dict[str, Any]:
        joined_group_at = self.joined_group_at.isoformat()
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        joined_group_at = isoparse(d.pop("joined_group_at"))
        ...
        properties: Union[Unset, SegmentMemberResponseObjectResourceAttributesProperties]
        if isinstance(_properties, Unset):
            properties = UNSET
        else:
            properties = SegmentMemberResponseObjectResourceAttributesProperties.from_dict(_properties)

        segment_member_response_object_resource_attributes = cls(
            joined_group_at=joined_group_at,
            email=email,
        ...
        segment_member_response_object_resource_attributes.additional_properties = d
        return segment_member_response_object_resource_attributes
