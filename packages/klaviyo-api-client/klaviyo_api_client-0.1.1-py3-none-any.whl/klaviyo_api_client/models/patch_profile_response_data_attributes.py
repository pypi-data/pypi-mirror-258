...
if TYPE_CHECKING:
    from ..models.patch_profile_response_data_attributes_properties import PatchProfileResponseDataAttributesProperties
    from ..models.predictive_analytics import PredictiveAnalytics
    from ..models.profile_location import ProfileLocation
    from ..models.subscriptions import Subscriptions


T = TypeVar("T", bound="PatchProfileResponseDataAttributes")


@_attrs_define
class PatchProfileResponseDataAttributes:
    """
    Attributes:
        ...
        properties (Union[Unset, PatchProfileResponseDataAttributesProperties]): An object containing key/value pairs
            for any custom properties assigned to this profile Example: {'pseudonym': 'Dr. Octopus'}.
    ...
    properties: Union[Unset, "PatchProfileResponseDataAttributesProperties"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        from ..models.patch_profile_response_data_attributes_properties import (
        ...
        properties: Union[Unset, PatchProfileResponseDataAttributesProperties]
        if isinstance(_properties, Unset):
            properties = UNSET
        else:
            properties = PatchProfileResponseDataAttributesProperties.from_dict(_properties)
        ...
        patch_profile_response_data_attributes = cls(
            email=email,
        ...
        patch_profile_response_data_attributes.additional_properties = d
        return patch_profile_response_data_attributes
