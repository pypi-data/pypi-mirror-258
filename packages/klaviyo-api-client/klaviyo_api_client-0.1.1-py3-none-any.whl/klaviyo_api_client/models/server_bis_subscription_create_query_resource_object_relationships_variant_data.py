...
T = TypeVar("T", bound="ServerBISSubscriptionCreateQueryResourceObjectRelationshipsVariantData")
...
class ServerBISSubscriptionCreateQueryResourceObjectRelationshipsVariantData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        server_bis_subscription_create_query_resource_object_relationships_variant_data = cls(
            type=type,
            id=id,
        )

        server_bis_subscription_create_query_resource_object_relationships_variant_data.additional_properties = d
        return server_bis_subscription_create_query_resource_object_relationships_variant_data
