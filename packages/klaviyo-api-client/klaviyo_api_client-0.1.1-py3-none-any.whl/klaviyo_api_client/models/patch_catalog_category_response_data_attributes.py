...
T = TypeVar("T", bound="PatchCatalogCategoryResponseDataAttributes")


@_attrs_define
class PatchCatalogCategoryResponseDataAttributes:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        patch_catalog_category_response_data_attributes = cls(
            external_id=external_id,
            name=name,
            updated=updated,
        )

        patch_catalog_category_response_data_attributes.additional_properties = d
        return patch_catalog_category_response_data_attributes
