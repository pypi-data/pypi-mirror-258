...
T = TypeVar("T", bound="CampaignMessageResponseObjectResourceAttributes")
...
class CampaignMessageResponseObjectResourceAttributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        campaign_message_response_object_resource_attributes = cls(
            label=label,
            channel=channel,
            content=content,
        ...
        campaign_message_response_object_resource_attributes.additional_properties = d
        return campaign_message_response_object_resource_attributes
