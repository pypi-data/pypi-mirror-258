...
T = TypeVar("T", bound="CampaignMessageCreateQueryResourceObjectAttributes")
...
class CampaignMessageCreateQueryResourceObjectAttributes:
    """
    Attributes:
        channel (str): The channel the message is to be sent on (email or sms, for example) Example: email.
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        campaign_message_create_query_resource_object_attributes = cls(
            channel=channel,
            label=label,
            content=content,
        ...
        campaign_message_create_query_resource_object_attributes.additional_properties = d
        return campaign_message_create_query_resource_object_attributes
