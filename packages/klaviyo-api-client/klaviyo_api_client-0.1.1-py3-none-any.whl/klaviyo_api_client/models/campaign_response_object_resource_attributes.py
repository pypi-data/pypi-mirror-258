...
T = TypeVar("T", bound="CampaignResponseObjectResourceAttributes")
...
class CampaignResponseObjectResourceAttributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        campaign_response_object_resource_attributes = cls(
            name=name,
            status=status,
            archived=archived,
            audiences=audiences,
        ...
        campaign_response_object_resource_attributes.additional_properties = d
        return campaign_response_object_resource_attributes
