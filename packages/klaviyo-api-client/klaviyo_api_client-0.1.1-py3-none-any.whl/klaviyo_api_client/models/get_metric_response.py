...
T = TypeVar("T", bound="GetMetricResponse")
...
class GetMetricResponse:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        data = MetricResponseObjectResource.from_dict(d.pop("data"))

        get_metric_response = cls(
            data=data,
        )

        get_metric_response.additional_properties = d
