...
from ..models.post_profile_import_job_response_data_attributes_status import (
    PostProfileImportJobResponseDataAttributesStatus,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PostProfileImportJobResponseDataAttributes")


@_attrs_define
class PostProfileImportJobResponseDataAttributes:
    """
    Attributes:
        status (PostProfileImportJobResponseDataAttributesStatus): Status of the asynchronous job. Example: processing.
    ...
    status: PostProfileImportJobResponseDataAttributesStatus
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        status = PostProfileImportJobResponseDataAttributesStatus(d.pop("status"))
        ...
        post_profile_import_job_response_data_attributes = cls(
            status=status,
            created_at=created_at,
            total_count=total_count,
        ...
        post_profile_import_job_response_data_attributes.additional_properties = d
        return post_profile_import_job_response_data_attributes
