...
from ...models.get_coupons_fieldscoupon_item import GetCouponsFieldscouponItem
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    fieldscoupon: Union[Unset, List[GetCouponsFieldscouponItem]] = UNSET,
...
def sync_detailed(
    *,
    ...
    To learn more, see our [Coupons API
    guide](https://developers.klaviyo.com/en/docs/use_klaviyos_coupons_api).<br><br>*Rate
    limits*:<br>Burst: `75/s`<br>Steady: `700/m`

    **Scopes:**
    `coupons:read`

    Args:
        fieldscoupon (Union[Unset, List[GetCouponsFieldscouponItem]]):
