...
from ...models.get_coupon_fieldscoupon_item import GetCouponFieldscouponItem
from ...models.get_coupon_response import GetCouponResponse
...
def _get_kwargs(
    id: str,
    *,
    fieldscoupon: Union[Unset, List[GetCouponFieldscouponItem]] = UNSET,
...
) -> Optional[Union[Any, GetCouponResponse]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetCouponResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetCouponResponse]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Get Coupon
     ...
     Get a specific coupon with the given coupon ID.<br><br>*Rate limits*:<br>Burst: `75/s`<br>Steady:
    `700/m`
    ...
    **Scopes:**
    ...
    Args:
        id (str): The internal id of a Coupon is equivalent to its external id stored within an
            integration. Example: 10OFF.
        fieldscoupon (Union[Unset, List[GetCouponFieldscouponItem]]):
