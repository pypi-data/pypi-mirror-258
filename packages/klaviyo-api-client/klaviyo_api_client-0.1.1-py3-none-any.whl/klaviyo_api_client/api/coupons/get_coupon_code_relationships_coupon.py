...
from ...models.get_coupon_relationship_coupon_codes_list_response_collection import (
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/coupons/{id}/relationships/coupon-codes/",
        "params": params,
    }
...
) -> Optional[Union[Any, GetCouponRelationshipCouponCodesListResponseCollection]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetCouponRelationshipCouponCodesListResponseCollection.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetCouponRelationshipCouponCodesListResponseCollection]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Get Coupon Code Relationships Coupon
     ...
     Gets a list of coupon code relationships associated with the given coupon id<br><br>*Rate
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, GetCouponRelationshipCouponCodesListResponseCollection]
    """
