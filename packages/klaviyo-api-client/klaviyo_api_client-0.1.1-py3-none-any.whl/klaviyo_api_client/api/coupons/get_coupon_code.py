...
from ...models.get_coupon_code_fieldscoupon_code_item import GetCouponCodeFieldscouponCodeItem
from ...models.get_coupon_code_fieldscoupon_item import GetCouponCodeFieldscouponItem
from ...models.get_coupon_code_include_item import GetCouponCodeIncludeItem
from ...models.get_coupon_code_response_compound_document import GetCouponCodeResponseCompoundDocument
...
def _get_kwargs(
    id: str,
    *,
    fieldscoupon_code: Union[Unset, List[GetCouponCodeFieldscouponCodeItem]] = UNSET,
    fieldscoupon: Union[Unset, List[GetCouponCodeFieldscouponItem]] = UNSET,
    include: Union[Unset, List[GetCouponCodeIncludeItem]] = UNSET,
    ...
    json_fieldscoupon: Union[Unset, List[str]] = UNSET
    if not isinstance(fieldscoupon, Unset):
        json_fieldscoupon = []
        for fieldscoupon_item_data in fieldscoupon:
            fieldscoupon_item = fieldscoupon_item_data.value
            json_fieldscoupon.append(fieldscoupon_item)

    params["fields[coupon]"] = json_fieldscoupon
...
) -> Optional[Union[Any, GetCouponCodeResponseCompoundDocument]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetCouponCodeResponseCompoundDocument.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetCouponCodeResponseCompoundDocument]]:
    return Response(
...
def sync_detailed(
    ...
    **Scopes:**
    ...
    Args:
        id (str): The id of a coupon code is a combination of its unique code and the id of the
            coupon it is associated with. Example: 10OFF-ASD325FHK324UJDOI2M3JNES99.
        fieldscoupon_code (Union[Unset, List[GetCouponCodeFieldscouponCodeItem]]):
        fieldscoupon (Union[Unset, List[GetCouponCodeFieldscouponItem]]):
        include (Union[Unset, List[GetCouponCodeIncludeItem]]):
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, GetCouponCodeResponseCompoundDocument]
    """
