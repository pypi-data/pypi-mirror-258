...
from ...models.patch_template_response import PatchTemplateResponse
from ...models.template_update_query import TemplateUpdateQuery
...
) -> Optional[Union[Any, PatchTemplateResponse]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = PatchTemplateResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, PatchTemplateResponse]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Update Template
     ...
     Update a template with the given template ID. Does not currently update drag & drop
    templates.<br><br>*Rate limits*:<br>Burst: `10/s`<br>Steady: `150/m`
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, PatchTemplateResponse]
    """
