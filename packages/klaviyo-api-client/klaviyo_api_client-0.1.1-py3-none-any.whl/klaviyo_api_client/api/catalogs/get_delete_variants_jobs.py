...
from ...models.get_catalog_variant_delete_job_response_collection import GetCatalogVariantDeleteJobResponseCollection
from ...models.get_delete_variants_jobs_fieldscatalog_variant_bulk_delete_job_item import (
...
def _get_kwargs(
    *,
    fieldscatalog_variant_bulk_delete_job: Union[
        Unset, List[GetDeleteVariantsJobsFieldscatalogVariantBulkDeleteJobItem]
    ] = UNSET,
    ...
    json_fieldscatalog_variant_bulk_delete_job: Union[Unset, List[str]] = UNSET
    if not isinstance(fieldscatalog_variant_bulk_delete_job, Unset):
        json_fieldscatalog_variant_bulk_delete_job = []
        for fieldscatalog_variant_bulk_delete_job_item_data in fieldscatalog_variant_bulk_delete_job:
            fieldscatalog_variant_bulk_delete_job_item = fieldscatalog_variant_bulk_delete_job_item_data.value
            json_fieldscatalog_variant_bulk_delete_job.append(fieldscatalog_variant_bulk_delete_job_item)

    params["fields[catalog-variant-bulk-delete-job]"] = json_fieldscatalog_variant_bulk_delete_job
...
) -> Optional[Union[Any, GetCatalogVariantDeleteJobResponseCollection]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetCatalogVariantDeleteJobResponseCollection.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetCatalogVariantDeleteJobResponseCollection]]:
    return Response(
...
def sync_detailed(
    ...
    **Scopes:**
    ...
    Args:
        fieldscatalog_variant_bulk_delete_job (Union[Unset,
            List[GetDeleteVariantsJobsFieldscatalogVariantBulkDeleteJobItem]]):
    ...
    kwargs = _get_kwargs(
        fieldscatalog_variant_bulk_delete_job=fieldscatalog_variant_bulk_delete_job,
        filter_=filter_,
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, GetCatalogVariantDeleteJobResponseCollection]
    """
