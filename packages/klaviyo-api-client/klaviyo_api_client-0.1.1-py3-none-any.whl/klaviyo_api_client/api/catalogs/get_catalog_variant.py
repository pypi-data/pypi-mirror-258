...
from ...models.get_catalog_variant_fieldscatalog_variant_item import GetCatalogVariantFieldscatalogVariantItem
from ...models.get_catalog_variant_response import GetCatalogVariantResponse
...
def _get_kwargs(
    id: str,
    *,
    fieldscatalog_variant: Union[Unset, List[GetCatalogVariantFieldscatalogVariantItem]] = UNSET,
...
) -> Optional[Union[Any, GetCatalogVariantResponse]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetCatalogVariantResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetCatalogVariantResponse]]:
    return Response(
...
def sync_detailed(
    ...
    **Scopes:**
    ...
    Args:
        ...
        fieldscatalog_variant (Union[Unset, List[GetCatalogVariantFieldscatalogVariantItem]]):
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, GetCatalogVariantResponse]
    """
