...
from ...models.get_catalog_item_category_list_response_collection import GetCatalogItemCategoryListResponseCollection
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/catalog-items/{id}/relationships/categories/",
        "params": params,
    }
...
) -> Optional[Union[Any, GetCatalogItemCategoryListResponseCollection]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetCatalogItemCategoryListResponseCollection.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetCatalogItemCategoryListResponseCollection]]:
    return Response(
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, GetCatalogItemCategoryListResponseCollection]
    """
