...
from ...models.get_catalog_item_create_job_response_collection_compound_document import (
    GetCatalogItemCreateJobResponseCollectionCompoundDocument,
)
from ...models.get_create_items_jobs_fieldscatalog_item_bulk_create_job_item import (
...
def _get_kwargs(
    *,
    fieldscatalog_item_bulk_create_job: Union[
        Unset, List[GetCreateItemsJobsFieldscatalogItemBulkCreateJobItem]
    ] = UNSET,
...
) -> Optional[Union[Any, GetCatalogItemCreateJobResponseCollectionCompoundDocument]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetCatalogItemCreateJobResponseCollectionCompoundDocument.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetCatalogItemCreateJobResponseCollectionCompoundDocument]]:
    return Response(
    ...
    **Scopes:**
    ...
    Args:
        fieldscatalog_item_bulk_create_job (Union[Unset,
            List[GetCreateItemsJobsFieldscatalogItemBulkCreateJobItem]]):
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, GetCatalogItemCreateJobResponseCollectionCompoundDocument]
    """
