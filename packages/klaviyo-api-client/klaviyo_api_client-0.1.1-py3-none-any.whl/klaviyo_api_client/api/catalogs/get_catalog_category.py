...
from ...models.get_catalog_category_fieldscatalog_category_item import GetCatalogCategoryFieldscatalogCategoryItem
from ...models.get_catalog_category_response import GetCatalogCategoryResponse
...
def _get_kwargs(
    id: str,
    *,
    fieldscatalog_category: Union[Unset, List[GetCatalogCategoryFieldscatalogCategoryItem]] = UNSET,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/catalog-categories/{id}/",
        "params": params,
    }
...
) -> Optional[Union[Any, GetCatalogCategoryResponse]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetCatalogCategoryResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetCatalogCategoryResponse]]:
    return Response(
...
def sync_detailed(
    ...
    **Scopes:**
    ...
    Args:
        ...
        fieldscatalog_category (Union[Unset, List[GetCatalogCategoryFieldscatalogCategoryItem]]):
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, GetCatalogCategoryResponse]
    """
