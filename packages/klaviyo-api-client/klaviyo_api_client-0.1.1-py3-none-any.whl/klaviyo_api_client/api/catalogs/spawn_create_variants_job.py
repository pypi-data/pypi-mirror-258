...
from ...models.catalog_variant_create_job_create_query import CatalogVariantCreateJobCreateQuery
from ...models.post_catalog_variant_create_job_response import PostCatalogVariantCreateJobResponse
...
) -> Optional[Union[Any, PostCatalogVariantCreateJobResponse]]:
    if response.status_code == HTTPStatus.ACCEPTED:
        response_202 = PostCatalogVariantCreateJobResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, PostCatalogVariantCreateJobResponse]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Accepts up to 100 catalog variants per request. The maximum allowed payload size is
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, PostCatalogVariantCreateJobResponse]
    """
