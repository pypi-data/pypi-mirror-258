...
from ...models.catalog_variant_update_job_create_query import CatalogVariantUpdateJobCreateQuery
from ...models.post_catalog_variant_update_job_response import PostCatalogVariantUpdateJobResponse
...
) -> Optional[Union[Any, PostCatalogVariantUpdateJobResponse]]:
    if response.status_code == HTTPStatus.ACCEPTED:
        response_202 = PostCatalogVariantUpdateJobResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, PostCatalogVariantUpdateJobResponse]]:
    return Response(
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, PostCatalogVariantUpdateJobResponse]
    """
