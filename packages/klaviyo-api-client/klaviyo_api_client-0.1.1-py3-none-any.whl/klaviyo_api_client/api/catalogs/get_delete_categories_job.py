...
from ...models.get_catalog_category_delete_job_response import GetCatalogCategoryDeleteJobResponse
from ...models.get_delete_categories_job_fieldscatalog_category_bulk_delete_job_item import (
...
def _get_kwargs(
    ...
    *,
    fieldscatalog_category_bulk_delete_job: Union[
        Unset, List[GetDeleteCategoriesJobFieldscatalogCategoryBulkDeleteJobItem]
    ] = UNSET,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/catalog-category-bulk-delete-jobs/{job_id}/",
        "params": params,
    }
...
) -> Optional[Union[Any, GetCatalogCategoryDeleteJobResponse]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetCatalogCategoryDeleteJobResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetCatalogCategoryDeleteJobResponse]]:
    return Response(
    ...
    **Scopes:**
    ...
    Args:
        ...
        fieldscatalog_category_bulk_delete_job (Union[Unset,
            List[GetDeleteCategoriesJobFieldscatalogCategoryBulkDeleteJobItem]]):
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, GetCatalogCategoryDeleteJobResponse]
    """
