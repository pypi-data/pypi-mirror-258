...
from ...models.get_catalog_item_update_job_response_collection_compound_document import (
    GetCatalogItemUpdateJobResponseCollectionCompoundDocument,
)
from ...models.get_update_items_jobs_fieldscatalog_item_bulk_update_job_item import (
...
def _get_kwargs(
    *,
    fieldscatalog_item_bulk_update_job: Union[
        Unset, List[GetUpdateItemsJobsFieldscatalogItemBulkUpdateJobItem]
    ] = UNSET,
...
) -> Optional[Union[Any, GetCatalogItemUpdateJobResponseCollectionCompoundDocument]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetCatalogItemUpdateJobResponseCollectionCompoundDocument.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetCatalogItemUpdateJobResponseCollectionCompoundDocument]]:
    return Response(
    ...
    **Scopes:**
    ...
    Args:
        fieldscatalog_item_bulk_update_job (Union[Unset,
            List[GetUpdateItemsJobsFieldscatalogItemBulkUpdateJobItem]]):
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, GetCatalogItemUpdateJobResponseCollectionCompoundDocument]
    """
