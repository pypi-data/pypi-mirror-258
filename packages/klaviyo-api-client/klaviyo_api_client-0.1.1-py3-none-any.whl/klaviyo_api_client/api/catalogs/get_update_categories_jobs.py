...
from ...models.get_catalog_category_update_job_response_collection_compound_document import (
    GetCatalogCategoryUpdateJobResponseCollectionCompoundDocument,
)
from ...models.get_update_categories_jobs_fieldscatalog_category_bulk_update_job_item import (
...
def _get_kwargs(
    *,
    fieldscatalog_category_bulk_update_job: Union[
        Unset, List[GetUpdateCategoriesJobsFieldscatalogCategoryBulkUpdateJobItem]
    ] = UNSET,
...
) -> Optional[Union[Any, GetCatalogCategoryUpdateJobResponseCollectionCompoundDocument]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetCatalogCategoryUpdateJobResponseCollectionCompoundDocument.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetCatalogCategoryUpdateJobResponseCollectionCompoundDocument]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Returns a maximum of 100 jobs per request.<br><br>*Rate limits*:<br>Burst: `350/s`<br>Steady:
    `3500/m`
    ...
    **Scopes:**
    ...
    Args:
        fieldscatalog_category_bulk_update_job (Union[Unset,
            List[GetUpdateCategoriesJobsFieldscatalogCategoryBulkUpdateJobItem]]):
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, GetCatalogCategoryUpdateJobResponseCollectionCompoundDocument]
    """
