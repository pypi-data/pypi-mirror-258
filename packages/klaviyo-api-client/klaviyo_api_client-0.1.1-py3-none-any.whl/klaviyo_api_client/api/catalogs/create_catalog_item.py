...
from ...models.catalog_item_create_query import CatalogItemCreateQuery
from ...models.post_catalog_item_response import PostCatalogItemResponse
...
) -> Optional[Union[Any, PostCatalogItemResponse]]:
    if response.status_code == HTTPStatus.CREATED:
        response_201 = PostCatalogItemResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, PostCatalogItemResponse]]:
    return Response(
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, PostCatalogItemResponse]
    """
