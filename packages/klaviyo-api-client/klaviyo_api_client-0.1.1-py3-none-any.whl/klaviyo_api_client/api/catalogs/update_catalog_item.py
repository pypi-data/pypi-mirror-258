...
from ...models.catalog_item_update_query import CatalogItemUpdateQuery
from ...models.patch_catalog_item_response import PatchCatalogItemResponse
...
) -> Optional[Union[Any, PatchCatalogItemResponse]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = PatchCatalogItemResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, PatchCatalogItemResponse]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Update Catalog Item
     ...
     Update a catalog item with the given item ID.<br><br>*Rate limits*:<br>Burst: `75/s`<br>Steady:
    `700/m`
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, PatchCatalogItemResponse]
    """
