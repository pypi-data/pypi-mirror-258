...
from ...models.catalog_category_create_job_create_query import CatalogCategoryCreateJobCreateQuery
from ...models.post_catalog_category_create_job_response import PostCatalogCategoryCreateJobResponse
...
) -> Optional[Union[Any, PostCatalogCategoryCreateJobResponse]]:
    if response.status_code == HTTPStatus.ACCEPTED:
        response_202 = PostCatalogCategoryCreateJobResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, PostCatalogCategoryCreateJobResponse]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Accepts up to 100 catalog categories per request. The maximum allowed payload size is
    5MB.<br><br>*Rate limits*:<br>Burst: `75/s`<br>Steady: `700/m`
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, PostCatalogCategoryCreateJobResponse]
    """
