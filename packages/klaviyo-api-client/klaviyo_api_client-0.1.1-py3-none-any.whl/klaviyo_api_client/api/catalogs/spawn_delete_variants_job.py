...
from ...models.catalog_variant_delete_job_create_query import CatalogVariantDeleteJobCreateQuery
from ...models.post_catalog_variant_delete_job_response import PostCatalogVariantDeleteJobResponse
...
) -> Optional[Union[Any, PostCatalogVariantDeleteJobResponse]]:
    if response.status_code == HTTPStatus.ACCEPTED:
        response_202 = PostCatalogVariantDeleteJobResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, PostCatalogVariantDeleteJobResponse]]:
    return Response(
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, PostCatalogVariantDeleteJobResponse]
    """
