...
from ...models.catalog_item_category_op import CatalogItemCategoryOp
...
def sync_detailed(
    ...
    *,
    ...
    """Create Catalog Item Relationships Categories
     ...
     Create a new catalog category relationship for the given item ID.<br><br>*Rate limits*:<br>Burst:
