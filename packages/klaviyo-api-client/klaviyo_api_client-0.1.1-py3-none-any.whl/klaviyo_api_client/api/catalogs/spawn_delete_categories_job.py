...
from ...models.catalog_category_delete_job_create_query import CatalogCategoryDeleteJobCreateQuery
from ...models.post_catalog_category_delete_job_response import PostCatalogCategoryDeleteJobResponse
...
) -> Optional[Union[Any, PostCatalogCategoryDeleteJobResponse]]:
    if response.status_code == HTTPStatus.ACCEPTED:
        response_202 = PostCatalogCategoryDeleteJobResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, PostCatalogCategoryDeleteJobResponse]]:
    return Response(
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, PostCatalogCategoryDeleteJobResponse]
    """
