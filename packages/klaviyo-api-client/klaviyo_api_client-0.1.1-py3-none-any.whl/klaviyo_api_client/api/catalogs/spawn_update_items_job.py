...
from ...models.catalog_item_update_job_create_query import CatalogItemUpdateJobCreateQuery
from ...models.post_catalog_item_update_job_response import PostCatalogItemUpdateJobResponse
...
) -> Optional[Union[Any, PostCatalogItemUpdateJobResponse]]:
    if response.status_code == HTTPStatus.ACCEPTED:
        response_202 = PostCatalogItemUpdateJobResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, PostCatalogItemUpdateJobResponse]]:
    return Response(
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, PostCatalogItemUpdateJobResponse]
    """
