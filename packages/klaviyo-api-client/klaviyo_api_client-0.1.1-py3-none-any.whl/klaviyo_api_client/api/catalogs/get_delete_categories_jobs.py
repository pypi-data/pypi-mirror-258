...
from ...models.get_catalog_category_delete_job_response_collection import GetCatalogCategoryDeleteJobResponseCollection
from ...models.get_delete_categories_jobs_fieldscatalog_category_bulk_delete_job_item import (
...
def _get_kwargs(
    *,
    fieldscatalog_category_bulk_delete_job: Union[
        Unset, List[GetDeleteCategoriesJobsFieldscatalogCategoryBulkDeleteJobItem]
    ] = UNSET,
    ...
    json_fieldscatalog_category_bulk_delete_job: Union[Unset, List[str]] = UNSET
    if not isinstance(fieldscatalog_category_bulk_delete_job, Unset):
        json_fieldscatalog_category_bulk_delete_job = []
        for fieldscatalog_category_bulk_delete_job_item_data in fieldscatalog_category_bulk_delete_job:
            fieldscatalog_category_bulk_delete_job_item = fieldscatalog_category_bulk_delete_job_item_data.value
            json_fieldscatalog_category_bulk_delete_job.append(fieldscatalog_category_bulk_delete_job_item)

    params["fields[catalog-category-bulk-delete-job]"] = json_fieldscatalog_category_bulk_delete_job
...
) -> Optional[Union[Any, GetCatalogCategoryDeleteJobResponseCollection]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetCatalogCategoryDeleteJobResponseCollection.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetCatalogCategoryDeleteJobResponseCollection]]:
    return Response(
...
def sync_detailed(
    ...
    **Scopes:**
    ...
    Args:
        fieldscatalog_category_bulk_delete_job (Union[Unset,
            List[GetDeleteCategoriesJobsFieldscatalogCategoryBulkDeleteJobItem]]):
    ...
    kwargs = _get_kwargs(
        fieldscatalog_category_bulk_delete_job=fieldscatalog_category_bulk_delete_job,
        filter_=filter_,
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, GetCatalogCategoryDeleteJobResponseCollection]
    """
