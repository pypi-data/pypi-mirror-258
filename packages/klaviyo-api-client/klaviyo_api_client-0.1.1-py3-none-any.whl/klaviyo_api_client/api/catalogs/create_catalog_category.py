...
from ...models.catalog_category_create_query import CatalogCategoryCreateQuery
from ...models.post_catalog_category_response import PostCatalogCategoryResponse
...
) -> Optional[Union[Any, PostCatalogCategoryResponse]]:
    if response.status_code == HTTPStatus.CREATED:
        response_201 = PostCatalogCategoryResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, PostCatalogCategoryResponse]]:
    return Response(
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, PostCatalogCategoryResponse]
    """
