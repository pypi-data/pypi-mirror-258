...
from ...models.get_catalog_variant_create_job_response_collection_compound_document import (
    GetCatalogVariantCreateJobResponseCollectionCompoundDocument,
)
from ...models.get_create_variants_jobs_fieldscatalog_variant_bulk_create_job_item import (
...
def _get_kwargs(
    *,
    fieldscatalog_variant_bulk_create_job: Union[
        Unset, List[GetCreateVariantsJobsFieldscatalogVariantBulkCreateJobItem]
    ] = UNSET,
...
) -> Optional[Union[Any, GetCatalogVariantCreateJobResponseCollectionCompoundDocument]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetCatalogVariantCreateJobResponseCollectionCompoundDocument.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetCatalogVariantCreateJobResponseCollectionCompoundDocument]]:
    return Response(
    ...
    **Scopes:**
    ...
    Args:
        fieldscatalog_variant_bulk_create_job (Union[Unset,
            List[GetCreateVariantsJobsFieldscatalogVariantBulkCreateJobItem]]):
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, GetCatalogVariantCreateJobResponseCollectionCompoundDocument]
    """
