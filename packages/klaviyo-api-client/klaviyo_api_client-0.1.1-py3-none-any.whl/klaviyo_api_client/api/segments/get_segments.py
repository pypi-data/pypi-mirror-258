...
from ...models.get_segment_list_response_collection_compound_document import (
    GetSegmentListResponseCollectionCompoundDocument,
)
from ...models.get_segments_fieldssegment_item import GetSegmentsFieldssegmentItem
from ...models.get_segments_fieldstag_item import GetSegmentsFieldstagItem
from ...models.get_segments_include_item import GetSegmentsIncludeItem
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    fieldssegment: Union[Unset, List[GetSegmentsFieldssegmentItem]] = UNSET,
    fieldstag: Union[Unset, List[GetSegmentsFieldstagItem]] = UNSET,
    filter_: Union[Unset, str] = UNSET,
    include: Union[Unset, List[GetSegmentsIncludeItem]] = UNSET,
...
) -> Optional[Union[Any, GetSegmentListResponseCollectionCompoundDocument]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetSegmentListResponseCollectionCompoundDocument.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetSegmentListResponseCollectionCompoundDocument]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Filter to request a subset of all segments. Segments can be filtered by `name`, `created`, and
    `updated` fields.
    ...
    **Scopes:**
    ...
    Args:
        fieldssegment (Union[Unset, List[GetSegmentsFieldssegmentItem]]):
        fieldstag (Union[Unset, List[GetSegmentsFieldstagItem]]):
        filter_ (Union[Unset, str]):
        include (Union[Unset, List[GetSegmentsIncludeItem]]):
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, GetSegmentListResponseCollectionCompoundDocument]
    """
