...
from ...models.patch_segment_partial_update_response import PatchSegmentPartialUpdateResponse
from ...models.segment_partial_update_query import SegmentPartialUpdateQuery
...
) -> Optional[Union[Any, PatchSegmentPartialUpdateResponse]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = PatchSegmentPartialUpdateResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, PatchSegmentPartialUpdateResponse]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Update Segment
     ...
     Update the name of a segment with the given segment ID.<br><br>*Rate limits*:<br>Burst:
    `1/s`<br>Steady: `15/m`
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, PatchSegmentPartialUpdateResponse]
    """
