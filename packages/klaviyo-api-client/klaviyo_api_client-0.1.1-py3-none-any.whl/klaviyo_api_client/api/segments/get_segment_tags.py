...
from ...models.get_segment_tags_fieldstag_item import GetSegmentTagsFieldstagItem
...
def _get_kwargs(
    id: str,
    *,
    fieldstag: Union[Unset, List[GetSegmentTagsFieldstagItem]] = UNSET,
...
def sync_detailed(
    ...
    *,
    ...
    """Get Segment Tags
     ...
     Return all tags associated with the given segment ID.<br><br>*Rate limits*:<br>Burst:
    `3/s`<br>Steady: `60/m`
    ...
    **Scopes:**
    ...
    Args:
        id (str):
        fieldstag (Union[Unset, List[GetSegmentTagsFieldstagItem]]):
