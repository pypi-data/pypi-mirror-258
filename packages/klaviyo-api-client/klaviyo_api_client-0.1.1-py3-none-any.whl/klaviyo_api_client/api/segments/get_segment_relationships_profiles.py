...
from ...models.get_segment_relationships_profiles_sort import GetSegmentRelationshipsProfilesSort
from ...models.get_segment_relationships_response_collection import GetSegmentRelationshipsResponseCollection
...
def _get_kwargs(
    ...
    *,
    ...
    sort: Union[Unset, GetSegmentRelationshipsProfilesSort] = UNSET,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/segments/{id}/relationships/profiles/",
        "params": params,
    }
...
) -> Optional[Union[Any, GetSegmentRelationshipsResponseCollection]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetSegmentRelationshipsResponseCollection.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetSegmentRelationshipsResponseCollection]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Get Segment Relationships Profiles
     ...
     Get all profile membership
    [relationships](https://developers.klaviyo.com/en/reference/api_overview#relationships) for the
    given segment ID.<br><br>*Rate limits*:<br>Burst: `75/s`<br>Steady: `700/m`
    ...
    **Scopes:**
    ...
    Args:
        ...
        sort (Union[Unset, GetSegmentRelationshipsProfilesSort]):
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, GetSegmentRelationshipsResponseCollection]
    """
