...
from ...models.get_bulk_profile_import_job_import_errors_fieldsimport_error_item import (
    GetBulkProfileImportJobImportErrorsFieldsimportErrorItem,
)
from ...models.get_import_error_response_collection import GetImportErrorResponseCollection
...
def _get_kwargs(
    id: str,
    *,
    fieldsimport_error: Union[Unset, List[GetBulkProfileImportJobImportErrorsFieldsimportErrorItem]] = UNSET,
    ...
    json_fieldsimport_error: Union[Unset, List[str]] = UNSET
    if not isinstance(fieldsimport_error, Unset):
        json_fieldsimport_error = []
        for fieldsimport_error_item_data in fieldsimport_error:
            fieldsimport_error_item = fieldsimport_error_item_data.value
            json_fieldsimport_error.append(fieldsimport_error_item)

    params["fields[import-error]"] = json_fieldsimport_error
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/profile-bulk-import-jobs/{id}/import-errors/",
        "params": params,
    }
...
) -> Optional[Union[Any, GetImportErrorResponseCollection]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetImportErrorResponseCollection.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetImportErrorResponseCollection]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Get Bulk Profile Import Job Errors
     ...
     Get import errors for the bulk profile import job with the given ID.<br><br>*Rate limits*:<br>Burst:
    ...
    **Scopes:**
    ...
    Args:
        id (str):
        fieldsimport_error (Union[Unset,
            List[GetBulkProfileImportJobImportErrorsFieldsimportErrorItem]]):
    ...
    kwargs = _get_kwargs(
        id=id,
        fieldsimport_error=fieldsimport_error,
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, GetImportErrorResponseCollection]
    """
