...
from ...models.get_profile_lists_fieldslist_item import GetProfileListsFieldslistItem
...
def _get_kwargs(
    id: str,
    *,
    fieldslist: Union[Unset, List[GetProfileListsFieldslistItem]] = UNSET,
...
def sync_detailed(
    ...
    *,
    ...
    """Get Profile Lists
     ...
     Get list memberships for a profile with the given profile ID.<br><br>*Rate limits*:<br>Burst:
    `3/s`<br>Steady: `60/m`
    ...
    **Scopes:**
    ...
    Args:
        id (str):
        fieldslist (Union[Unset, List[GetProfileListsFieldslistItem]]):
