...
from ...models.get_profile_list_relationships_response_collection import GetProfileListRelationshipsResponseCollection
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/profiles/{id}/relationships/lists/",
    }
...
) -> Optional[Union[Any, GetProfileListRelationshipsResponseCollection]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetProfileListRelationshipsResponseCollection.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetProfileListRelationshipsResponseCollection]]:
    return Response(
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, GetProfileListRelationshipsResponseCollection]
    """
