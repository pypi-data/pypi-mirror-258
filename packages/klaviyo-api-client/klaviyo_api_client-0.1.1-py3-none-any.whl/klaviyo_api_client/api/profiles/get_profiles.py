...
from ...models.get_profiles_additional_fieldsprofile_item import GetProfilesAdditionalFieldsprofileItem
from ...models.get_profiles_fieldsprofile_item import GetProfilesFieldsprofileItem
from ...models.get_profiles_sort import GetProfilesSort
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    additional_fieldsprofile: Union[Unset, List[GetProfilesAdditionalFieldsprofileItem]] = UNSET,
    fieldsprofile: Union[Unset, List[GetProfilesFieldsprofileItem]] = UNSET,
    filter_: Union[Unset, str] = UNSET,
    pagecursor: Union[Unset, str] = UNSET,
    pagesize: Union[Unset, int] = 20,
    sort: Union[Unset, GetProfilesSort] = UNSET,
...
def sync_detailed(
    *,
    ...
    Profiles can be sorted by the following fields in ascending and descending order: `id`, `created`,
    `updated`, `email`, `subscriptions.email.marketing.suppression.timestamp`,
    `subscriptions.email.marketing.list_suppressions.timestamp`<br><br>*Rate limits*:<br>Burst:
    `75/s`<br>Steady: `700/m`<br><br>Rate limits when using the `additional-
    fields[profile]=predictive_analytics` parameter in your API request:<br>Burst: `10/s`<br>Steady:
    `150/m`<br><br>To learn more about how the `additional-fields` parameter impacts rate limits, check
    out our [Rate limits, status codes, and
    ...
    **Scopes:**
    ...
    Args:
        additional_fieldsprofile (Union[Unset, List[GetProfilesAdditionalFieldsprofileItem]]):
        fieldsprofile (Union[Unset, List[GetProfilesFieldsprofileItem]]):
        filter_ (Union[Unset, str]):
        pagecursor (Union[Unset, str]):
        pagesize (Union[Unset, int]):  Default: 20.
        sort (Union[Unset, GetProfilesSort]):
