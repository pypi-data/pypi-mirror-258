...
from ...models.patch_profile_response import PatchProfileResponse
from ...models.profile_partial_update_query import ProfilePartialUpdateQuery
...
) -> Optional[Union[Any, PatchProfileResponse]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = PatchProfileResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, PatchProfileResponse]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    in addition to the `phone_number` attribute for the API call to work.<br><br>*Rate
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, PatchProfileResponse]
    """
