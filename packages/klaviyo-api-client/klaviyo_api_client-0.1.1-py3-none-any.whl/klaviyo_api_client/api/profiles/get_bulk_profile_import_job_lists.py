...
from ...models.get_bulk_profile_import_job_lists_fieldslist_item import GetBulkProfileImportJobListsFieldslistItem
from ...models.get_list_response_collection import GetListResponseCollection
...
def _get_kwargs(
    id: str,
    *,
    fieldslist: Union[Unset, List[GetBulkProfileImportJobListsFieldslistItem]] = UNSET,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/profile-bulk-import-jobs/{id}/lists/",
        "params": params,
    }
...
) -> Optional[Union[Any, GetListResponseCollection]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetListResponseCollection.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetListResponseCollection]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Get Bulk Profile Import Job Lists
     ...
     Get list for the bulk profile import job with the given ID.<br><br>*Rate limits*:<br>Burst:
    ...
    **Scopes:**
    ...
    Args:
        id (str):
        fieldslist (Union[Unset, List[GetBulkProfileImportJobListsFieldslistItem]]):
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, GetListResponseCollection]
    """
