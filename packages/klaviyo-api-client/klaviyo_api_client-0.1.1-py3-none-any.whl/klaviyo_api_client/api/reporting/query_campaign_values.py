...
from ...models.campaign_values_request_dto import CampaignValuesRequestDTO
from ...models.post_campaign_values_response_dto import PostCampaignValuesResponseDTO
...
) -> Optional[Union[Any, PostCampaignValuesResponseDTO]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = PostCampaignValuesResponseDTO.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, PostCampaignValuesResponseDTO]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    `1/s`<br>Steady: `2/m`<br>Daily: `225/d`
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, PostCampaignValuesResponseDTO]
    """
