...
from ...models.get_campaign_message_template_relationship_list_response import (
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/campaign-messages/{id}/relationships/template/",
    }
...
) -> Optional[Union[Any, GetCampaignMessageTemplateRelationshipListResponse]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetCampaignMessageTemplateRelationshipListResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetCampaignMessageTemplateRelationshipListResponse]]:
    return Response(
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, GetCampaignMessageTemplateRelationshipListResponse]
    """
