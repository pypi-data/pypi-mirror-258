...
from ...models.campaign_clone_query import CampaignCloneQuery
from ...models.post_campaign_response import PostCampaignResponse
...
) -> Optional[Union[Any, PostCampaignResponse]]:
    if response.status_code == HTTPStatus.CREATED:
        response_201 = PostCampaignResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, PostCampaignResponse]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Create Campaign Clone
     ...
     Clones an existing campaign, returning a new campaign based on the original with a new ID and
    name.<br><br>*Rate limits*:<br>Burst: `10/s`<br>Steady: `150/m`
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, PostCampaignResponse]
    """
