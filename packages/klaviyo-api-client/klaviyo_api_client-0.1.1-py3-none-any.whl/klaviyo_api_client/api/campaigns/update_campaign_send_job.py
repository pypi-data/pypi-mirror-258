...
from ...models.campaign_send_job_partial_update_query import CampaignSendJobPartialUpdateQuery
...
def sync_detailed(
    ...
    *,
    ...
    revert the campaign, setting the status back to DRAFT<br><br>*Rate limits*:<br>Burst:
