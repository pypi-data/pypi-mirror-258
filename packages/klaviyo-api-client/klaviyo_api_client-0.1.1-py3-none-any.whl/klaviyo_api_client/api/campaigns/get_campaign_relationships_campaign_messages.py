...
from ...models.get_campaign_messages_relationship_list_response_collection import (
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/campaigns/{id}/relationships/campaign-messages/",
    }
...
) -> Optional[Union[Any, GetCampaignMessagesRelationshipListResponseCollection]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetCampaignMessagesRelationshipListResponseCollection.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetCampaignMessagesRelationshipListResponseCollection]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Get Campaign Relationships Campaign Messages
     ...
     Returns the IDs of all messages associated with the given campaign.<br><br>*Rate limits*:<br>Burst:
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, GetCampaignMessagesRelationshipListResponseCollection]
    """
