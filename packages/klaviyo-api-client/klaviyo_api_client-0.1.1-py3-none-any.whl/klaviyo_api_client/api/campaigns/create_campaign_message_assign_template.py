...
from ...models.campaign_message_assign_template_query import CampaignMessageAssignTemplateQuery
from ...models.post_campaign_message_response import PostCampaignMessageResponse
...
) -> Optional[Union[Any, PostCampaignMessageResponse]]:
    if response.status_code == HTTPStatus.CREATED:
        response_201 = PostCampaignMessageResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, PostCampaignMessageResponse]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Assign Campaign Message Template
     ...
     Creates a non-reusable version of the template and assigns it to the message.<br><br>*Rate
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, PostCampaignMessageResponse]
    """
