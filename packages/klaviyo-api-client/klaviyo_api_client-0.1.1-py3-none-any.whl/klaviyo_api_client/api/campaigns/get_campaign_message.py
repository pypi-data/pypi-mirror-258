...
from ...models.get_campaign_message_fieldscampaign_item import GetCampaignMessageFieldscampaignItem
from ...models.get_campaign_message_fieldscampaign_message_item import GetCampaignMessageFieldscampaignMessageItem
from ...models.get_campaign_message_fieldstemplate_item import GetCampaignMessageFieldstemplateItem
from ...models.get_campaign_message_include_item import GetCampaignMessageIncludeItem
from ...models.get_campaign_message_response_compound_document import GetCampaignMessageResponseCompoundDocument
...
def _get_kwargs(
    id: str,
    *,
    fieldscampaign_message: Union[Unset, List[GetCampaignMessageFieldscampaignMessageItem]] = UNSET,
    fieldscampaign: Union[Unset, List[GetCampaignMessageFieldscampaignItem]] = UNSET,
    fieldstemplate: Union[Unset, List[GetCampaignMessageFieldstemplateItem]] = UNSET,
    include: Union[Unset, List[GetCampaignMessageIncludeItem]] = UNSET,
...
) -> Optional[Union[Any, GetCampaignMessageResponseCompoundDocument]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetCampaignMessageResponseCompoundDocument.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetCampaignMessageResponseCompoundDocument]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Get Campaign Message
     ...
     Returns a specific message based on a required id.<br><br>*Rate limits*:<br>Burst: `10/s`<br>Steady:
    `150/m`
    ...
    **Scopes:**
    ...
    Args:
        ...
        fieldscampaign_message (Union[Unset, List[GetCampaignMessageFieldscampaignMessageItem]]):
        fieldscampaign (Union[Unset, List[GetCampaignMessageFieldscampaignItem]]):
        fieldstemplate (Union[Unset, List[GetCampaignMessageFieldstemplateItem]]):
        include (Union[Unset, List[GetCampaignMessageIncludeItem]]):
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, GetCampaignMessageResponseCompoundDocument]
    """
