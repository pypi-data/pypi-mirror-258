...
from ...models.get_campaign_message_campaign_fieldscampaign_item import GetCampaignMessageCampaignFieldscampaignItem
from ...models.get_campaign_response import GetCampaignResponse
...
def _get_kwargs(
    id: str,
    *,
    fieldscampaign: Union[Unset, List[GetCampaignMessageCampaignFieldscampaignItem]] = UNSET,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/campaign-messages/{id}/campaign/",
        "params": params,
    }
...
) -> Optional[Union[Any, GetCampaignResponse]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetCampaignResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetCampaignResponse]]:
    return Response(
...
def sync_detailed(
    ...
    **Scopes:**
    ...
    Args:
        id (str):
        fieldscampaign (Union[Unset, List[GetCampaignMessageCampaignFieldscampaignItem]]):
