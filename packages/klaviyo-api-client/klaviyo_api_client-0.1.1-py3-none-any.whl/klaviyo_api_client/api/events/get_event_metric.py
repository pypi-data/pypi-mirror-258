...
from ...models.get_event_metric_fieldsmetric_item import GetEventMetricFieldsmetricItem
...
def _get_kwargs(
    id: str,
    *,
    fieldsmetric: Union[Unset, List[GetEventMetricFieldsmetricItem]] = UNSET,
...
) -> Optional[Union[Any, GetMetricResponse]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetMetricResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetMetricResponse]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Get Event Metric
     ...
     Get the metric for an event with the given event ID.<br><br>*Rate limits*:<br>Burst:
    ...
    **Scopes:**
    ...
    Args:
        id (str):
        fieldsmetric (Union[Unset, List[GetEventMetricFieldsmetricItem]]):
