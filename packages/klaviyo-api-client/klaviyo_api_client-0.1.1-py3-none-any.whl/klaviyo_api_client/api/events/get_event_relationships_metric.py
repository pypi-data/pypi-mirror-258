...
from ...models.get_event_metrics_relationship_list_response import GetEventMetricsRelationshipListResponse
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/events/{id}/relationships/metric/",
    }
...
) -> Optional[Union[Any, GetEventMetricsRelationshipListResponse]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetEventMetricsRelationshipListResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetEventMetricsRelationshipListResponse]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Get Event Relationships Metric
     ...
     Get a list of related Metrics for an Event<br><br>*Rate limits*:<br>Burst: `350/s`<br>Steady:
    `3500/m`
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, GetEventMetricsRelationshipListResponse]
    """
