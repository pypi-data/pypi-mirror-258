...
from ...models.get_account_fieldsaccount_item import GetAccountFieldsaccountItem
...
def _get_kwargs(
    id: str,
    *,
    fieldsaccount: Union[Unset, List[GetAccountFieldsaccountItem]] = UNSET,
...
) -> Optional[Union[Any, GetAccountResponse]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetAccountResponse]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Get Account
     ...
     Retrieve a single account object by its account ID. You can only request the account by which the
    private API key was generated.<br><br>*Rate limits*:<br>Burst: `1/s`<br>Steady: `15/m`

    **Scopes:**
    `accounts:read`

    Args:
        id (str): The ID of the account Example: AbC123.
        fieldsaccount (Union[Unset, List[GetAccountFieldsaccountItem]]):
