...
from ...models.get_list_list_response_collection_compound_document import GetListListResponseCollectionCompoundDocument
from ...models.get_lists_fieldslist_item import GetListsFieldslistItem
from ...models.get_lists_fieldstag_item import GetListsFieldstagItem
from ...models.get_lists_include_item import GetListsIncludeItem
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    fieldslist: Union[Unset, List[GetListsFieldslistItem]] = UNSET,
    fieldstag: Union[Unset, List[GetListsFieldstagItem]] = UNSET,
    filter_: Union[Unset, str] = UNSET,
    include: Union[Unset, List[GetListsIncludeItem]] = UNSET,
...
) -> Optional[Union[Any, GetListListResponseCollectionCompoundDocument]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetListListResponseCollectionCompoundDocument.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetListListResponseCollectionCompoundDocument]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Filter to request a subset of all lists. Lists can be filtered by `id`, `name`, `created`, and
    `updated` fields.
    ...
    **Scopes:**
    ...
    Args:
        fieldslist (Union[Unset, List[GetListsFieldslistItem]]):
        fieldstag (Union[Unset, List[GetListsFieldstagItem]]):
        filter_ (Union[Unset, str]):
        include (Union[Unset, List[GetListsIncludeItem]]):
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, GetListListResponseCollectionCompoundDocument]
    """
