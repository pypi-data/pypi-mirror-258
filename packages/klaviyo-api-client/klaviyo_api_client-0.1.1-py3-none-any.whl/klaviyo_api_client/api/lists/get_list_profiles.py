...
from ...models.get_list_profiles_additional_fieldsprofile_item import GetListProfilesAdditionalFieldsprofileItem
from ...models.get_list_profiles_fieldsprofile_item import GetListProfilesFieldsprofileItem
from ...models.get_list_profiles_sort import GetListProfilesSort
...
def _get_kwargs(
    id: str,
    *,
    additional_fieldsprofile: Union[Unset, List[GetListProfilesAdditionalFieldsprofileItem]] = UNSET,
    fieldsprofile: Union[Unset, List[GetListProfilesFieldsprofileItem]] = UNSET,
    filter_: Union[Unset, str] = UNSET,
    pagecursor: Union[Unset, str] = UNSET,
    pagesize: Union[Unset, int] = 20,
    sort: Union[Unset, GetListProfilesSort] = UNSET,
...
def sync_detailed(
    ...
    *,
    ...
    `700/m`<br><br>Rate limits when using the `additional-fields[profile]=predictive_analytics`
    parameter in your API request:<br>Burst: `10/s`<br>Steady: `150/m`<br><br>To learn more about how
    the `additional-fields` parameter impacts rate limits, check out our [Rate limits, status codes, and
    ...
    **Scopes:**
    ...
    Args:
        id (str):
        additional_fieldsprofile (Union[Unset, List[GetListProfilesAdditionalFieldsprofileItem]]):
        fieldsprofile (Union[Unset, List[GetListProfilesFieldsprofileItem]]):
        filter_ (Union[Unset, str]):
        pagecursor (Union[Unset, str]):
        pagesize (Union[Unset, int]):  Default: 20.
        sort (Union[Unset, GetListProfilesSort]):
