...
from ...models.get_list_tags_fieldstag_item import GetListTagsFieldstagItem
...
def _get_kwargs(
    id: str,
    *,
    fieldstag: Union[Unset, List[GetListTagsFieldstagItem]] = UNSET,
...
def sync_detailed(
    ...
    *,
    ...
    """Get List Tags
     ...
     Return all tags associated with the given list ID.<br><br>*Rate limits*:<br>Burst: `3/s`<br>Steady:
    `60/m`
    ...
    **Scopes:**
    ...
    Args:
        id (str):
        fieldstag (Union[Unset, List[GetListTagsFieldstagItem]]):
