...
from ...models.list_create_query import ListCreateQuery
from ...models.post_list_create_response import PostListCreateResponse
...
) -> Optional[Union[Any, PostListCreateResponse]]:
    if response.status_code == HTTPStatus.CREATED:
        response_201 = PostListCreateResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, PostListCreateResponse]]:
    return Response(
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, PostListCreateResponse]
    """
