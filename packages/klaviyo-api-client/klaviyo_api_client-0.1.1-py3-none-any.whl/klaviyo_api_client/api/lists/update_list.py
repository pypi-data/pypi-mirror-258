...
from ...models.list_partial_update_query import ListPartialUpdateQuery
from ...models.patch_list_partial_update_response import PatchListPartialUpdateResponse
...
) -> Optional[Union[Any, PatchListPartialUpdateResponse]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = PatchListPartialUpdateResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, PatchListPartialUpdateResponse]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Update List
     ...
     Update the name of a list with the given list ID.<br><br>*Rate limits*:<br>Burst: `10/s`<br>Steady:
    `150/m`
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, PatchListPartialUpdateResponse]
    """
