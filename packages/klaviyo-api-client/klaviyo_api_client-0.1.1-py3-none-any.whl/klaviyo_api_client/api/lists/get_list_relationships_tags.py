...
from ...models.get_list_tag_relationship_list_response_collection import GetListTagRelationshipListResponseCollection
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/lists/{id}/relationships/tags/",
    }
...
) -> Optional[Union[Any, GetListTagRelationshipListResponseCollection]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetListTagRelationshipListResponseCollection.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetListTagRelationshipListResponseCollection]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Get List Relationships Tags
     ...
     Returns the tag IDs of all tags associated with the given list.<br><br>*Rate limits*:<br>Burst:
    `3/s`<br>Steady: `60/m`
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, GetListTagRelationshipListResponseCollection]
    """
