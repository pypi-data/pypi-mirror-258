...
from ...models.get_metric_fieldsmetric_item import GetMetricFieldsmetricItem
...
def _get_kwargs(
    id: str,
    *,
    fieldsmetric: Union[Unset, List[GetMetricFieldsmetricItem]] = UNSET,
...
def sync_detailed(
    ...
    **Scopes:**
    ...
    Args:
        id (str): Metric ID
        fieldsmetric (Union[Unset, List[GetMetricFieldsmetricItem]]):
