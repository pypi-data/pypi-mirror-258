...
from ...models.get_metric_response_collection import GetMetricResponseCollection
from ...models.get_metrics_fieldsmetric_item import GetMetricsFieldsmetricItem
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    fieldsmetric: Union[Unset, List[GetMetricsFieldsmetricItem]] = UNSET,
...
) -> Optional[Union[Any, GetMetricResponseCollection]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetMetricResponseCollection.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetMetricResponseCollection]]:
    return Response(
...
def sync_detailed(
    ...
    **Scopes:**
    ...
    Args:
        fieldsmetric (Union[Unset, List[GetMetricsFieldsmetricItem]]):
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, GetMetricResponseCollection]
    """
