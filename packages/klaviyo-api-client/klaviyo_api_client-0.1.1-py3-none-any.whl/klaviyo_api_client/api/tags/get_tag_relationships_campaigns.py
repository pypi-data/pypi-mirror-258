...
from ...models.get_tag_campaign_relationships_response_collection import GetTagCampaignRelationshipsResponseCollection
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/tags/{id}/relationships/campaigns/",
    }
...
) -> Optional[Union[Any, GetTagCampaignRelationshipsResponseCollection]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetTagCampaignRelationshipsResponseCollection.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetTagCampaignRelationshipsResponseCollection]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Get Tag Relationships Campaigns
     ...
     Returns the IDs of all campaigns associated with the given tag.<br><br>*Rate limits*:<br>Burst:
    `3/s`<br>Steady: `60/m`
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, GetTagCampaignRelationshipsResponseCollection]
    """
