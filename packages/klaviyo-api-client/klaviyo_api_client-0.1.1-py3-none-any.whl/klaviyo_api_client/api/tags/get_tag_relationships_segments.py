...
from ...models.get_tag_segment_relationships_response_collection import GetTagSegmentRelationshipsResponseCollection
...
) -> Optional[Union[Any, GetTagSegmentRelationshipsResponseCollection]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetTagSegmentRelationshipsResponseCollection.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetTagSegmentRelationshipsResponseCollection]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Get Tag Relationships Segments
     ...
     Returns the IDs of all segments associated with the given tag.<br><br>*Rate limits*:<br>Burst:
    `3/s`<br>Steady: `60/m`
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, GetTagSegmentRelationshipsResponseCollection]
    """
