...
from ...models.tag_campaign_op import TagCampaignOp
...
def sync_detailed(
    ...
    *,
    ...
    """Create Tag Relationships Campaigns
     ...
     Associate a tag with one or more campaigns. Any campaign cannot be associated with more than **100**
    tags.


    Use the request body to pass in the ID(s) of the campaign(s) that will be associated with the
    tag.<br><br>*Rate limits*:<br>Burst: `3/s`<br>Steady: `60/m`
