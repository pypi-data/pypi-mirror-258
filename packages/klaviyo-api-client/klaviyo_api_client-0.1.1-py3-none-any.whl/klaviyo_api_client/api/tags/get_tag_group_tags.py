...
from ...models.get_tag_group_tags_fieldstag_item import GetTagGroupTagsFieldstagItem
...
def _get_kwargs(
    id: str,
    *,
    fieldstag: Union[Unset, List[GetTagGroupTagsFieldstagItem]] = UNSET,
...
def sync_detailed(
    ...
    **Scopes:**
    ...
    Args:
        id (str):
        fieldstag (Union[Unset, List[GetTagGroupTagsFieldstagItem]]):
