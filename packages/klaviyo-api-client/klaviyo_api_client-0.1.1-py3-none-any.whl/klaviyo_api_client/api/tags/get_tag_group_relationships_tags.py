...
from ...models.get_tag_group_tag_relationships_response_collection import GetTagGroupTagRelationshipsResponseCollection
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/tag-groups/{id}/relationships/tags/",
    }
...
) -> Optional[Union[Any, GetTagGroupTagRelationshipsResponseCollection]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetTagGroupTagRelationshipsResponseCollection.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetTagGroupTagRelationshipsResponseCollection]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Get Tag Group Relationships Tags
     ...
     Returns the tag IDs of all tags inside the given tag group.<br><br>*Rate limits*:<br>Burst:
    `3/s`<br>Steady: `60/m`
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, GetTagGroupTagRelationshipsResponseCollection]
    """
