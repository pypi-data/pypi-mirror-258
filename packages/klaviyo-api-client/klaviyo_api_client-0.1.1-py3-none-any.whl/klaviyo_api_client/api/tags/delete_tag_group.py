...
from ...models.delete_tag_group_response import DeleteTagGroupResponse
...
) -> Optional[Union[Any, DeleteTagGroupResponse]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = DeleteTagGroupResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, DeleteTagGroupResponse]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Any tags inside that tag group, and any associations between those tags and other resources, will
    also be removed. The default tag group cannot be deleted.<br><br>*Rate limits*:<br>Burst:
    `3/s`<br>Steady: `60/m`
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, DeleteTagGroupResponse]
    """
