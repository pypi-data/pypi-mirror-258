...
from ...models.patch_tag_group_response import PatchTagGroupResponse
from ...models.tag_group_update_query import TagGroupUpdateQuery
...
) -> Optional[Union[Any, PatchTagGroupResponse]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = PatchTagGroupResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, PatchTagGroupResponse]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Only a tag group's `name` can be changed. A tag group's `exclusive` or `default` value cannot be
    changed.<br><br>*Rate limits*:<br>Burst: `3/s`<br>Steady: `60/m`
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, PatchTagGroupResponse]
    """
