...
from ...models.image_upload_query import ImageUploadQuery
from ...models.post_image_response import PostImageResponse
...
) -> Optional[Union[Any, PostImageResponse]]:
    if response.status_code == HTTPStatus.CREATED:
        response_201 = PostImageResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, PostImageResponse]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    If you want to import an image from an existing url or a data uri, use the Upload Image From URL
    endpoint instead.<br><br>*Rate limits*:<br>Burst: `3/s`<br>Steady: `100/m`<br>Daily: `100/d`
