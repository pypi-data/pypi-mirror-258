...
from ...models.get_flow_message_template_fieldstemplate_item import GetFlowMessageTemplateFieldstemplateItem
...
def _get_kwargs(
    id: str,
    *,
    fieldstemplate: Union[Unset, List[GetFlowMessageTemplateFieldstemplateItem]] = UNSET,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/flow-messages/{id}/template/",
        "params": params,
    }
...
def sync_detailed(
    ...
    **Scopes:**
    ...
    Args:
        id (str):
        fieldstemplate (Union[Unset, List[GetFlowMessageTemplateFieldstemplateItem]]):
