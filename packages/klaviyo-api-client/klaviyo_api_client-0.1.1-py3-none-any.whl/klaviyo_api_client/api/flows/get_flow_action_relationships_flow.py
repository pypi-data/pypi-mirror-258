...
from ...models.get_flow_action_flow_relationship_response import GetFlowActionFlowRelationshipResponse
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/flow-actions/{id}/relationships/flow/",
    }
...
) -> Optional[Union[Any, GetFlowActionFlowRelationshipResponse]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetFlowActionFlowRelationshipResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetFlowActionFlowRelationshipResponse]]:
    return Response(
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, GetFlowActionFlowRelationshipResponse]
    """
