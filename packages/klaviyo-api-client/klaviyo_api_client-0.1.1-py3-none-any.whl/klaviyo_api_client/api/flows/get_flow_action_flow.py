...
from ...models.get_flow_action_flow_fieldsflow_item import GetFlowActionFlowFieldsflowItem
from ...models.get_flow_response import GetFlowResponse
...
def _get_kwargs(
    id: str,
    *,
    fieldsflow: Union[Unset, List[GetFlowActionFlowFieldsflowItem]] = UNSET,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/flow-actions/{id}/flow/",
        "params": params,
    }
...
) -> Optional[Union[Any, GetFlowResponse]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetFlowResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetFlowResponse]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Get Flow For Flow Action
     ...
     Get the flow associated with the given action ID.<br><br>*Rate limits*:<br>Burst: `3/s`<br>Steady:
    `60/m`
    ...
    **Scopes:**
    ...
    Args:
        id (str):
        fieldsflow (Union[Unset, List[GetFlowActionFlowFieldsflowItem]]):
