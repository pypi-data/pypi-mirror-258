...
from ...models.get_flow_tag_relationship_list_response_collection import GetFlowTagRelationshipListResponseCollection
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/flows/{id}/relationships/tags/",
    }
...
) -> Optional[Union[Any, GetFlowTagRelationshipListResponseCollection]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetFlowTagRelationshipListResponseCollection.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetFlowTagRelationshipListResponseCollection]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Get Flow Relationships Tags
     ...
     Return the tag IDs of all tags associated with the given flow.<br><br>*Rate limits*:<br>Burst:
    `3/s`<br>Steady: `60/m`
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, GetFlowTagRelationshipListResponseCollection]
    """
