...
from ...models.get_flow_action_fieldsflow_action_item import GetFlowActionFieldsflowActionItem
from ...models.get_flow_action_fieldsflow_item import GetFlowActionFieldsflowItem
from ...models.get_flow_action_fieldsflow_message_item import GetFlowActionFieldsflowMessageItem
from ...models.get_flow_action_include_item import GetFlowActionIncludeItem
from ...models.get_flow_action_response_compound_document import GetFlowActionResponseCompoundDocument
...
def _get_kwargs(
    id: str,
    *,
    fieldsflow_action: Union[Unset, List[GetFlowActionFieldsflowActionItem]] = UNSET,
    fieldsflow_message: Union[Unset, List[GetFlowActionFieldsflowMessageItem]] = UNSET,
    fieldsflow: Union[Unset, List[GetFlowActionFieldsflowItem]] = UNSET,
    include: Union[Unset, List[GetFlowActionIncludeItem]] = UNSET,
...
) -> Optional[Union[Any, GetFlowActionResponseCompoundDocument]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetFlowActionResponseCompoundDocument.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetFlowActionResponseCompoundDocument]]:
    return Response(
...
def sync_detailed(
    ...
    **Scopes:**
    ...
    Args:
        id (str):
        fieldsflow_action (Union[Unset, List[GetFlowActionFieldsflowActionItem]]):
        fieldsflow_message (Union[Unset, List[GetFlowActionFieldsflowMessageItem]]):
        fieldsflow (Union[Unset, List[GetFlowActionFieldsflowItem]]):
        include (Union[Unset, List[GetFlowActionIncludeItem]]):
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, GetFlowActionResponseCompoundDocument]
    """
