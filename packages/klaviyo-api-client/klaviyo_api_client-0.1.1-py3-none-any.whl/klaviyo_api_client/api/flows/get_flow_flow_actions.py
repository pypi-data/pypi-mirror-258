...
from ...models.get_flow_action_response_collection import GetFlowActionResponseCollection
from ...models.get_flow_flow_actions_fieldsflow_action_item import GetFlowFlowActionsFieldsflowActionItem
from ...models.get_flow_flow_actions_sort import GetFlowFlowActionsSort
...
def _get_kwargs(
    id: str,
    *,
    fieldsflow_action: Union[Unset, List[GetFlowFlowActionsFieldsflowActionItem]] = UNSET,
    filter_: Union[Unset, str] = UNSET,
    pagecursor: Union[Unset, str] = UNSET,
    pagesize: Union[Unset, int] = 50,
    sort: Union[Unset, GetFlowFlowActionsSort] = UNSET,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/flows/{id}/flow-actions/",
        "params": params,
    }
...
) -> Optional[Union[Any, GetFlowActionResponseCollection]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetFlowActionResponseCollection.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetFlowActionResponseCollection]]:
    return Response(
...
def sync_detailed(
    ...
    **Scopes:**
    ...
    Args:
        id (str):
        fieldsflow_action (Union[Unset, List[GetFlowFlowActionsFieldsflowActionItem]]):
        filter_ (Union[Unset, str]):
        pagecursor (Union[Unset, str]):
        pagesize (Union[Unset, int]):  Default: 50.
        sort (Union[Unset, GetFlowFlowActionsSort]):
...
def sync(
    ...
    **Scopes:**
    ...
    Returns:
        Union[Any, GetFlowActionResponseCollection]
    """
