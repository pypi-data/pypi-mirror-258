############## Mycelium Version 0.18.16 of 2024.02.23 ##############
...
class Mycelium:
    ...
    async def send_to_mycelium(self, dialog_id, isReply = False, newestMessagesToSend = 1, autogenerateRoutingStrategies = False):          
        ...
        try:
            ...
            await self.connect_to_mycelium()  # Reconnect
            await self.channel.default_exchange.publish(message, routing_key=self.output_channel)  # Retry publishing
