...
def version_impl(
    *,
    ...
    source = metadata.puffling.version.source
    ...
    updated_version = metadata.puffling.version.scheme.update(
...
def version_command(subparsers: argparse._SubParsersAction, defaults: Any) -> None:
    ...
    parser.add_argument(
        "--app", dest="called_by_app", action="store_true", help=argparse.SUPPRESS
    )
