...
from puffling.builders.config import BuilderConfigBound
...
class BuildHookInterface(Generic[BuilderConfigBound]):  # no cov
    ...
    @hookimpl
    def puffling_register_build_hook():
    ...
    def config(self) -> dict[str, Any]:
        ...
        ```toml config-example
        [tool.puffling.build.hooks.<PLUGIN_NAME>]
        [tool.puffling.build.targets.<TARGET_NAME>.hooks.<PLUGIN_NAME>]
        ```
        """
