...
def construct_metadata_file_1_2(
    metadata: ProjectMetadata, extra_dependencies: tuple[str] | None = None
) -> str:
    """
...
def construct_metadata_file_2_1(
    metadata: ProjectMetadata, extra_dependencies: tuple[str] | None = None
) -> str:
    """
        ...
        for option, dependencies in metadata.core.optional_dependencies.items():
            ...
            for dependency in dependencies:
                if ";" in dependency:
                    ...
                    metadata_file += (
                        f"Requires-Dist: {dependency} ; extra == {option!r}\n"
                    )
                else:
                    metadata_file += (
                        f"Requires-Dist: {dependency}; extra == {option!r}\n"
    ...
    if metadata.core.readme:
        metadata_file += (
            f"Description-Content-Type: {metadata.core.readme_content_type}\n"
        )
...
def construct_metadata_file_2_2(
    metadata: ProjectMetadata, extra_dependencies: tuple[str] | None = None
) -> str:
    """
...
def construct_metadata_file_2_3(
    metadata: ProjectMetadata, extra_dependencies: tuple[str] | None = None
) -> str:
    """
