...
class VersionSourceInterface(ABC):  # no cov
    ...
    @hookimpl
    def puffling_register_version_source():
    ...
    def get_version_data(self) -> dict:
        ...
        [set_version](reference.md#puffling.version.source.plugin.interface.VersionSourceInterface.set_version)
