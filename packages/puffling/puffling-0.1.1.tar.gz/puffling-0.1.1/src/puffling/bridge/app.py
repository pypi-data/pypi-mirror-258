...
class Application:
    ...
    !!! important
        Never import this directly; Puffling judiciously decides if a type of plugin requires
        the capabilities herein and will grant access via an attribute.
    """

    def __init__(self) -> None:
        self.__verbosity = int(os.environ.get("HATCH_VERBOSE", "0")) - int(
            os.environ.get("HATCH_QUIET", "0")
        )
