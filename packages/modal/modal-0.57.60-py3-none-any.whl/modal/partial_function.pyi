...
def _enter(_warn_parentheses_missing=None, *, checkpoint: bool = False) -> typing.Callable[[typing.Union[typing.Callable[[typing.Any], typing.Any], _PartialFunction]], _PartialFunction]:
    ...
...
def enter(_warn_parentheses_missing=None, *, checkpoint: bool = False) -> typing.Callable[[typing.Union[typing.Callable[[typing.Any], typing.Any], PartialFunction]], PartialFunction]:
    ...
