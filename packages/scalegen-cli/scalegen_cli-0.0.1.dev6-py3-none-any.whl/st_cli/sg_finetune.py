...
@click.option(
    "--task",
    type=click.Choice(["llm", "seq2seq", "text_classification"]),
    required=False,
    default="llm",
)
...
@click.option(
    "--project_name", required=False, type=click.STRING, help="Project name in HF hub"
)
@click.option(
    "--model_max_length",
    required=False,
...
@click.option(
    "--hf_token", required=False, type=click.STRING, help="Hugingface token to use"
)
@click.option(
    "--torch_dtype",
    required=False,
    type=click.Choice(["auto", "bfloat16", "float16", "float32"]),
    help="Load the model under this dtype",
)
@click.option(
    "--username", required=False, type=click.STRING, help="Huggingface username to use"
)
@click.option(
    "--push_to_hub",
    required=False,
