...
def create_entity(path, name):
    create_file(
        f"{path}{os.sep}Domain{os.sep}Entities", f"{name.capitalize}.cs", payload=""
    )
    create_file(
    ...
    create_file(
        f"{path}{os.sep}Application{os.sep}Dtos", f"{name.capitalize}App.cs", payload=""
    )
    create_file(
    ...
    create_file(
        f"{path}{os.sep}Application{os.sep}Mappers", f"MappingProfile.cs", payload=""
    )
    create_file(
