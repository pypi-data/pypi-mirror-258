...
class NeuroQRS:
    "NeuroQRS main class"
    def __init__(self, embedding_model: Union[str, SentenceTransformer] = "all-mpnet-base-v2", model_dim: int = 768, is_model_load: bool = True):
        ...
        :type model_dim: int
        """
        if type(embedding_model) == str and is_model_load:
            print("loading model!!")
    ...
    async def quick_query(self, query: Union[str, np.array], namespace: str, k: int = 5, minimum_score_threshold: float = 0.5):
        ...
        return index_caches[namespace].search(query, k=k, minimum_score_threshold=minimum_score_threshold)
    

    async def query_and_index(self, query: str, namespace: str, extra_documents_data: dict, fields_info: dict = {}, k: int = 5, minimum_score_threshold: float = 0.5):
        ...
        return index_caches[namespace].search(query_embeddings, k=k, minimum_score_threshold=minimum_score_threshold)
    
    async def query_maybe_index(self, query: str, namespace: str, extra_documents_data: dict, fields_info: dict = {}, k: int = 5, minimum_score_threshold: float = 0.5):
        ...
        if results and len(results) > 3:
            ...
            return await self.query_and_index(query, namespace, extra_documents_data, fields_info, k=k, minimum_score_threshold=minimum_score_threshold)
