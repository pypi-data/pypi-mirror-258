...
class NeuroIndex:
    ...
    def search(self, embedded_query: list, k: int = 5, return_scores: bool = False, minimum_score_threshold: float = 0.5):
        ...
        :rtype: list
        """
        return search_index(embedded_query, self.index, self.queries, k=k, return_scores=return_scores, minimum_score_threshold=minimum_score_threshold)
