...
Refer to the Terraform Registry for docs: [`data_launchdarkly_feature_flag`](https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.18.0/docs/data-sources/feature_flag).
'''
import abc
import builtins
import datetime
...
class DataLaunchdarklyFeatureFlag(
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing DataLaunchdarklyFeatureFlag that should be imported. Refer to the {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.18.0/docs/data-sources/feature_flag#import import section} in the documentation of this resource for the id to use
