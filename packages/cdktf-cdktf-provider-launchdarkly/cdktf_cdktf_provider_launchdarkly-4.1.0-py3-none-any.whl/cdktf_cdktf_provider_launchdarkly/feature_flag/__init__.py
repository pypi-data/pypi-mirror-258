...
Refer to the Terraform Registry for docs: [`launchdarkly_feature_flag`](https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.18.0/docs/resources/feature_flag).
'''
import abc
import builtins
import datetime
...
class FeatureFlag(
    ...
    def __init__(
        ...
        *,
        ...
        :param key: The unique feature flag key that references the flag in your application code. A change in this field will force the destruction of the existing resource and the creation of a new one. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.18.0/docs/resources/feature_flag#key FeatureFlag#key}
        :param name: The human-readable name of the feature flag. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.18.0/docs/resources/feature_flag#name FeatureFlag#name}
        :param project_key: The feature flag's project key. A change in this field will force the destruction of the existing resource and the creation of a new one. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.18.0/docs/resources/feature_flag#project_key FeatureFlag#project_key}
        :param variation_type: The feature flag's variation type: ``boolean``, ``string``, ``number`` or ``json``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.18.0/docs/resources/feature_flag#variation_type FeatureFlag#variation_type}
        :param archived: Specifies whether the flag is archived or not. Note that you cannot create a new flag that is archived, but can update a flag to be archived. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.18.0/docs/resources/feature_flag#archived FeatureFlag#archived}
        :param client_side_availability: client_side_availability block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.18.0/docs/resources/feature_flag#client_side_availability FeatureFlag#client_side_availability}
        :param custom_properties: custom_properties block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.18.0/docs/resources/feature_flag#custom_properties FeatureFlag#custom_properties}
        :param defaults: defaults block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.18.0/docs/resources/feature_flag#defaults FeatureFlag#defaults}
        :param description: The feature flag's description. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.18.0/docs/resources/feature_flag#description FeatureFlag#description}
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.18.0/docs/resources/feature_flag#id FeatureFlag#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param include_in_snippet: Specifies whether this flag should be made available to the client-side JavaScript SDK using the client-side Id. This value gets its default from your project configuration if not set. ``include_in_snippet`` is now deprecated. Please migrate to ``client_side_availability.using_environment_id`` to maintain future compatibility. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.18.0/docs/resources/feature_flag#include_in_snippet FeatureFlag#include_in_snippet}
        :param maintainer_id: The feature flag maintainer's 24 character alphanumeric team member ID. ``maintainer_team_key`` cannot be set if ``maintainer_id`` is set. If neither is set, it will automatically be or stay set to the member ID associated with the API key used by your LaunchDarkly Terraform provider or the most recently-set maintainer. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.18.0/docs/resources/feature_flag#maintainer_id FeatureFlag#maintainer_id}
        :param maintainer_team_key: The key of the associated team that maintains this feature flag. ``maintainer_id`` cannot be set if ``maintainer_team_key`` is set. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.18.0/docs/resources/feature_flag#maintainer_team_key FeatureFlag#maintainer_team_key}
        :param tags: Tags associated with your resource. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.18.0/docs/resources/feature_flag#tags FeatureFlag#tags}
        :param temporary: Specifies whether the flag is a temporary flag. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.18.0/docs/resources/feature_flag#temporary FeatureFlag#temporary}
        :param variations: variations block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.18.0/docs/resources/feature_flag#variations FeatureFlag#variations}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing FeatureFlag that should be imported. Refer to the {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.18.0/docs/resources/feature_flag#import import section} in the documentation of this resource for the id to use
    ...
    def put_defaults(
        ...
        *,
        ...
        '''
        :param off_variation: The index of the variation the flag will default to in all new environments when off. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.18.0/docs/resources/feature_flag#off_variation FeatureFlag#off_variation}
        :param on_variation: The index of the variation the flag will default to in all new environments when on. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.18.0/docs/resources/feature_flag#on_variation FeatureFlag#on_variation}
        '''
...
class FeatureFlagClientSideAvailability:
    def __init__(
        ...
        *,
        ...
        '''
        :param using_environment_id: Whether this flag is available to SDKs using the client-side ID. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.18.0/docs/resources/feature_flag#using_environment_id FeatureFlag#using_environment_id}
        :param using_mobile_key: Whether this flag is available to SDKs using a mobile key. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.18.0/docs/resources/feature_flag#using_mobile_key FeatureFlag#using_mobile_key}
        '''
        if __debug__:
    ...
    def using_environment_id(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.18.0/docs/resources/feature_flag#using_environment_id FeatureFlag#using_environment_id}
        '''
    ...
    def using_mobile_key(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.18.0/docs/resources/feature_flag#using_mobile_key FeatureFlag#using_mobile_key}
        '''
...
class FeatureFlagConfig(_cdktf_9a9027ec.TerraformMetaArguments):
    ...
    def key(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.18.0/docs/resources/feature_flag#key FeatureFlag#key}
        '''
    ...
    def name(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.18.0/docs/resources/feature_flag#name FeatureFlag#name}
        '''
    ...
    def project_key(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.18.0/docs/resources/feature_flag#project_key FeatureFlag#project_key}
        '''
    ...
    def variation_type(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.18.0/docs/resources/feature_flag#variation_type FeatureFlag#variation_type}
        '''
    ...
    def archived(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.18.0/docs/resources/feature_flag#archived FeatureFlag#archived}
        '''
    ...
    def client_side_availability(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.18.0/docs/resources/feature_flag#client_side_availability FeatureFlag#client_side_availability}
        '''
    ...
    def custom_properties(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.18.0/docs/resources/feature_flag#custom_properties FeatureFlag#custom_properties}
        '''
    ...
    def defaults(self) -> typing.Optional["FeatureFlagDefaults"]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.18.0/docs/resources/feature_flag#defaults FeatureFlag#defaults}
        '''
    ...
    def description(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.18.0/docs/resources/feature_flag#description FeatureFlag#description}
        '''
    ...
    def id(self) -> typing.Optional[builtins.str]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.18.0/docs/resources/feature_flag#id FeatureFlag#id}.
    ...
    def include_in_snippet(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.18.0/docs/resources/feature_flag#include_in_snippet FeatureFlag#include_in_snippet}
        '''
    ...
    def maintainer_id(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.18.0/docs/resources/feature_flag#maintainer_id FeatureFlag#maintainer_id}
        '''
    ...
    def maintainer_team_key(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.18.0/docs/resources/feature_flag#maintainer_team_key FeatureFlag#maintainer_team_key}
        '''
    ...
    def tags(self) -> typing.Optional[typing.List[builtins.str]]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.18.0/docs/resources/feature_flag#tags FeatureFlag#tags}
        '''
    ...
    def temporary(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.18.0/docs/resources/feature_flag#temporary FeatureFlag#temporary}
        '''
    ...
    def variations(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.18.0/docs/resources/feature_flag#variations FeatureFlag#variations}
        '''
...
class FeatureFlagCustomProperties:
    def __init__(
        ...
        *,
        ...
        '''
        :param key: The unique custom property key. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.18.0/docs/resources/feature_flag#key FeatureFlag#key}
        :param name: The name of the custom property. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.18.0/docs/resources/feature_flag#name FeatureFlag#name}
        :param value: The list of custom property value strings. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.18.0/docs/resources/feature_flag#value FeatureFlag#value}
        '''
        if __debug__:
    ...
    def value(self) -> typing.List[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.18.0/docs/resources/feature_flag#value FeatureFlag#value}
        '''
...
class FeatureFlagDefaults:
    ...
    def off_variation(self) -> jsii.Number:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.18.0/docs/resources/feature_flag#off_variation FeatureFlag#off_variation}
        '''
    ...
    def on_variation(self) -> jsii.Number:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.18.0/docs/resources/feature_flag#on_variation FeatureFlag#on_variation}
        '''
