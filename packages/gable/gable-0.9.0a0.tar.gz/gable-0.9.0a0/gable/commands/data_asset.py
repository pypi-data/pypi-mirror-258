...
def register_data_asset(
    ...
    if source_type in SCHEMA_SOURCE_TYPE_VALUES:
        ...
        # TODO - We may want the TS source type to take in the project_root once we move to schema detection
        event_names = gather_typescript_asset_data(ctx.obj.client)
