...
class ModifyUserInput(object):
    ...
    def __init__(self, firstname=None, lastname=None, email=None, avatars=None, avatar=None, roles=None, disabled=None, preferences=None, root=None, password=None, multifactor=None, central_revision=None):  # noqa: E501
