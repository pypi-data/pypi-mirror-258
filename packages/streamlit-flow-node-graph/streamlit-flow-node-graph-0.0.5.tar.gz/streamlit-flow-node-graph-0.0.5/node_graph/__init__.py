...
if __name__ == '__main__':
    ...
    item_types = {
        ...
        "Change type": {"color": "rgb(0,255, 192)", "port_selection": "both", "icon": "FaArrow-up"},
        "Group by": {"color": "rgb(0,255, 192)", "port_selection": "both", "icon": "FaObject-group"},
        "Filter rows": {"color": "rgb(0,255, 192)", "port_selection": "both", "icon": "FaObject-group"},
        "Sort rows": {"color": "rgb(0,255, 192)", "port_selection": "both", "icon": "FaArrow-down"},
        "Select columns": {"color": "rgb(0,255, 192)", "port_selection": "both", "icon": "FaColumns"},  # add an icon here
        "Sample data": {"color": "rgb(0,255, 192)", "port_selection": "both", "icon": "FaSample"},  # add an icon here
        "Pivot": {"color": "rgb(0,255, 192)", "port_selection": "both", "icon": "FaPivot"},  # add an icon here
        "Unpivot": {"color": "rgb(0,255, 192)", "port_selection": "both", "icon": "FaUnpivot"},  # add an icon here
