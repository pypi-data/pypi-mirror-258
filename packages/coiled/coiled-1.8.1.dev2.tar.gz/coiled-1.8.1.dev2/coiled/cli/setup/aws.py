...
def get_role_assumption_trust_policy(principal_external_ids: dict):
    ...
    return json.dumps(policy_dict, indent=4)
...
def do_full_setup(
    ...
    *,
    ...
    if use_access_key:
        ...
        return finish_role_assumption_setup(coiled_account, role_assumption_external_id, role_assumption_arn)

    return False


def finish_role_assumption_setup(coiled_account, role_assumption_external_id, role_assumption_arn):
    with coiled.Cloud(account=coiled_account) as cloud:
        setup_endpoint = "/api/v2/cloud-credentials/callback"
        setup_data = {
