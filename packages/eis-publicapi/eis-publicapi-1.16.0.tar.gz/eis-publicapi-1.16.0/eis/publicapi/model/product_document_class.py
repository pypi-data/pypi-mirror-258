...
class ProductDocumentClass(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, code, product_code, product_version_id, type, description, s3_key, content_type, product_slug, created_at, slug, version_number, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            version_number (float): The current verison of a document.
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, code, product_code, product_version_id, type, description, s3_key, content_type, product_slug, created_at, slug, version_number, *args, **kwargs):  # noqa: E501
        """ProductDocumentClass - a model defined in OpenAPI
