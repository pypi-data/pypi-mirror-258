from calcores.hamiltonians.tb_h import (
    TightTBGHa,
    TightAAtTTGHa,
    TightABtTTGHa,
    TightAtATTGHa,
...
from calcores.hamiltonians.conti_h import ContiTBGHa, EffABtHa
from typing import Literal
from calcores.bands.bands_cal import BandsCal
from calcores.bands.bands_plot import BandsPlot
from calcores.raman.raman_cal import RamanCal
from calcores.raman.raman_plot import RamanPlot
from calcores.abc.abmoire import ABContiGraMoires, ABMoHa, ABTBHa, np, plt
from calcores.pubmeth.pubmeth import Line
from calcores.superlattices.comm_stru import (
    CommTBGStru,
    CommAAtTTGStru,
    CommABtTTGStru,
    CommAtATTGStru,
...
from calcores.superlattices.stru_plot import StruPlot
from calcores.jdos.jdos_cal import JdosCal
from calcores.jdos.jdos_plot import JdosPlot
...
class TightAAtTTG(TightTBG, CommAAtTTGStru):
    def __init__(
        ...
        a1: ndarray = np.array([np.sqrt(3) / 2, -1 / 2]),
        a2: ndarray = np.array([np.sqrt(3) / 2, 1 / 2]),
        a0: float = 2.46,
    ) -> None:
        super().__init__(m0, r, haInst, a1, a2, a0)
