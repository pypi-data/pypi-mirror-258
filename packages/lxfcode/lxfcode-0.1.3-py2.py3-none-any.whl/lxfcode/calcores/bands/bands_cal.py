from calcores.hamiltonians.conti_h import ContiTBGHa, np
from calcores.hamiltonians.tb_h import TightTBGHa
from calcores.multical.multicorecal import MultiCal
from calcores.filesop.filesave import FilesSave
from calcores.abc.abmoire import ABMoHa
...
class BandsCal:
    def __init__(
        self,
        haInst: Union[ABMoHa, TightTBGHa],
        p_density=100,
        path: Union[list[str], list[np.ndarray]] = ["K_b", "M", "Gamma", "K_t"],
        suffix="",
    ) -> None:
        self.haInst: Union[ABMoHa, TightTBGHa] = haInst
