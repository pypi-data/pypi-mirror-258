...
class DemoFunc:
    ...
    def demo_rs_rp_with_gra_cond():
        ...
        gra_cond = PSHE.graphene_cond_analytic(2.5, mu=1)[1] # the conductivity of the graphene
        ...
        for ele_theta in theta_list:
            ele_rs, ele_rp = PSHE.rs_rp_from_cond(n0_index=1, cond=gra_cond, n2_index=n, theta_0=ele_theta)
        ...
        for ele_data_i in range(len(data_list_1)):
            ...
            fig.savefig(data_file_dir + "PSHE/gra_cond/{}_1.png".format(file_name_list_1[ele_data_i]), dpi=330, facecolor='w', bbox_inches='tight', pad_inches=0.1)
            plt.close()
        ...
        Ang_rp_list_2 = []
        for ele_theta in theta_list:
            ele_rs, ele_rp = PSHE.rs_rp_from_cond(n0_index=n, cond=gra_cond, n2_index=1, theta_0=ele_theta)
            ele_Amp_rs = abs(ele_rs)
            ele_Amp_rp = abs(ele_rp)
            ele_Ang_rs = np.angle(ele_rs)
            ele_Ang_rp = np.angle(ele_rp)
        ...
        for ele_data_i in range(len(data_list_2)):
            ...
            fig.savefig(data_file_dir + "PSHE/gra_cond/{}_2.png".format(file_name_list_2[ele_data_i]), dpi=330, facecolor='w', bbox_inches='tight', pad_inches=0.1)
            plt.close()
    ...
    def demo_rs_rp_without_gra_cond():
        ...
        Ang_rp_list_1 = []
        for ele_theta in theta_list:
            ele_rs, ele_rp = PSHE.rs_rp_between_two_medium(n0_index=1, n2_index=n, theta_0=ele_theta)
            ele_Amp_rs = abs(ele_rs)
            ele_Amp_rp = abs(ele_rp)
            ele_Ang_rs = np.angle(ele_rs)
            ele_Ang_rp = np.angle(ele_rp)
        ...
        Ang_rp_list_2 = []
        for ele_theta in theta_list:
            ele_rs, ele_rp = PSHE.rs_rp_between_two_medium(n0_index=n, n2_index=1, theta_0=ele_theta)
            ele_Amp_rs = abs(ele_rs)
            ele_Amp_rp = abs(ele_rp)
            ele_Ang_rs = np.angle(ele_rs)
            ele_Ang_rp = np.angle(ele_rp)
    ...
    def demo_plot_compare_rs_rp():
        ...
        for ele_data_i in range(len(with_gra_cond_1)):
            ...
            fig.savefig(data_file_dir + "PSHE/gra_cond/with_wino_{}_1.png".format(file_name_list_1[ele_data_i]), dpi=330, facecolor='w', bbox_inches='tight', pad_inches=0.1)
            plt.close()
        ...
        for ele_data_i in range(len(with_gra_cond_2)):
            ...
            ax_ele_data.set_ylim(y_lim_list_2[ele_data_i])
            ax_ele_data.legend(["With Graphene", "Without Graphene"])
            fig.savefig(data_file_dir + "PSHE/gra_cond/with_wino_{}_2.png".format(file_name_list_2[ele_data_i]), dpi=330, facecolor='w', bbox_inches='tight', pad_inches=0.1)
            plt.close()
    ...
    def demo_gra_if_gh_shift_from_single_cond_example_old():
        ...
        incident_theta_list = linspace(1 / 180 * pi, 89.9 / 180 * pi, 300)    #   incident angles
        ...
        for ele_theta in incident_theta_list:
            ele_IF_cp = PSHE.get_if_shift_cond_no_wl(n0_index=1, cond=gra_cond_example, n2_index=1.5, theta_0=ele_theta, eta_phase=pi/2)
            ele_IF_45lp = PSHE.get_if_shift_cond_no_wl(n0_index=1, cond=gra_cond_example, n2_index=1.5, theta_0=ele_theta, eta_phase=0)

            ele_GH_s1 = PSHE.get_gh_shift_cond_no_wl(n0_index=1, cond=gra_cond_example, n2_index=1.5, theta_0=ele_theta, w_s=1, w_p=0)
            ele_GH_p1 = PSHE.get_gh_shift_cond_no_wl(n0_index=1, cond=gra_cond_example, n2_index=1.5, theta_0=ele_theta, w_s=0, w_p=1)
        ...
        ##  Plot of data
        data_list1 = [IF_shift_example_cp1, IF_shift_example_45lp1, GH_shift_example_s1, GH_shift_example_p1]
        name_list = ["example_situ1_IF_cp", "example_situ1_IF_45lp", "example_situ1_GH_s", "example_situ1_GH_p"]
        y_label_list = [r'$k_0 \Delta_{IF}$', r'$k_0 \Delta_{IF}$', r'$k_0 \Delta_{GH}$', r'$k_0 \Delta_{GH}$']
        for data_i in range(len(data_list1)):
            ...
            fig.savefig(data_file_dir + "PSHE/gra_if_gh_shift/{}.png".format(name_list[data_i]), dpi=330, facecolor='w', bbox_inches='tight', pad_inches=0.1)
            plt.close()
        ...
        GH_shift_example_p2 = []
        for ele_theta in incident_theta_list:
            ele_IF_cp2 = PSHE.get_if_shift_cond_no_wl(n0_index=1.5, cond=gra_cond_example, n2_index=1, theta_0=ele_theta, eta_phase=pi/2)
            ele_IF_45lp2 = PSHE.get_if_shift_cond_no_wl(n0_index=1.5, cond=gra_cond_example, n2_index=1, theta_0=ele_theta, eta_phase=0)
        ...
        for ele_theta in incident_theta_list2:
            ele_GH_s2 = PSHE.get_gh_shift_cond_no_wl(n0_index=1.5, cond=gra_cond_example, n2_index=1, theta_0=ele_theta, w_s=1, w_p=0)
            ele_GH_p2 = PSHE.get_gh_shift_cond_no_wl(n0_index=1.5, cond=gra_cond_example, n2_index=1, theta_0=ele_theta, w_s=0, w_p=1)
        ...
        for data_i in range(len(data_list2)):
            ...
            ax_example.set_ylim(ax_example.get_ylim())
            fig.savefig(data_file_dir + "PSHE/gra_if_gh_shift/{}.png".format(name_list2[data_i]), dpi=330, facecolor='w', bbox_inches='tight', pad_inches=0.1)
            plt.close()
        for data_i in range(len(data_list3)):
            ...
            ax_example.set_ylim(ax_example.get_ylim())
            fig.savefig(data_file_dir + "PSHE/gra_if_gh_shift/{}.png".format(name_list3[data_i]), dpi=330, facecolor='w', bbox_inches='tight', pad_inches=0.1)
            plt.close()
    ...
    def demo_gra_if_gh_shift_from_single_cond_example():
        ...
        ##  Plot of data
        data_list1 = [IF_shift_example_cp1, IF_shift_example_45lp1, GH_shift_example_s1, GH_shift_example_p1]
        name_list = ["example_situ1_IF_cp", "example_situ1_IF_45lp", "example_situ1_GH_s_new", "example_situ1_GH_p_new"]
        y_label_list = [r'$k_0 \Delta_{IF}$', r'$k_0 \Delta_{IF}$', r'$k_0 \Delta_{GH}$', r'$k_0 \Delta_{GH}$']
        for data_i in range(len(data_list1)):
            fig, ax_example = plt.subplots(figsize=(6, 3))
            ax_example.plot(incident_angle_list, data_list1[data_i])
    ...
    def demo_gra_cond_for_mu():
        ...
        print("Energy range for graphene conductivity: ", min(photon_energy_list), max(photon_energy_list))
        ...
        img = ax.imshow(real(gra_cond_for_mu), extent=(wave_length_arr[0], wave_length_arr[-1], mu_list[-1], mu_list[0]))
        ax.set_aspect('auto')
        ...
        fig.savefig(data_file_dir + 'PSHE/gra_cond/gra_for_mu_real.png', dpi=330, pad_inches=0.2, bbox_inches='tight')
        plt.close()
        fig, ax = plt.subplots()
        fig.set_size_inches(5, 5)
        img = ax.imshow(imag(gra_cond_for_mu), extent=(wave_length_arr[0], wave_length_arr[-1], mu_list[-1], mu_list[0]))
        ax.set_aspect('auto')
        ax.set_xlabel(r'$\lambda$ (nm)')
        ax.set_ylabel(r'$\mu$ (meV)')
        ...
        c_bar = fig.colorbar(img, cax=c_ax)
        c_bar.set_label(r"Graphene Conductivity ($\varepsilon_0 c$)")
        fig.savefig(data_file_dir + 'PSHE/gra_cond/gra_for_mu_imag.png', dpi=330, pad_inches=0.2, bbox_inches='tight')
        plt.close()
        #endregion
    ...
    def demo_gra_if_shift_from_cond_over_wl():
        ...
        wavelength_example = 1240 / energy_example * 1000   #   The wavelength of the example photon energy
        gra_cond_low_doped1 = PSHE.graphene_cond_analytic(photon_energy_list, mu=mu_select)[1]
        gra_cond_low_doped1 = array(gra_cond_low_doped1)
        IF_shift_for_theta1 = []
        incident_theta_list = linspace(1 / 180 * pi, 90 / 180 * pi, 200)    #   incident angles
        incident_angle_list = incident_theta_list / pi * 180
        for ele_theta in incident_theta_list:
            ele_IF_shift1 = PSHE.get_if_shift_cond_over_wl(wave_length_arr, n0_index=1, cond=gra_cond_low_doped1, n2_index=ref_index_n0, theta_0=ele_theta)
            IF_shift_for_theta1.append(ele_IF_shift1)
        fig, ax = plt.subplots()
        fig.set_size_inches(5, 5)
        img = ax.imshow(IF_shift_for_theta1, extent=(wave_length_arr[0], wave_length_arr[-1], incident_angle_list[-1], incident_angle_list[0]))
        ax.plot([wavelength_example, wavelength_example], [incident_angle_list[0], incident_angle_list[-1]], 'r--')
        ...
        fig.savefig(data_file_dir + 'PSHE/gra_if_gh_shift/if_shift_for_theta1.png', dpi=330, pad_inches=0.2, bbox_inches='tight')
        plt.close()
        ...
        energy_example = mu_select * 2.5    #   The example Omega is 2.5
        wavelength_example = 1240 / energy_example * 1000   #   The wavelength of the example photon energy
        gra_cond_low_doped = PSHE.graphene_cond_analytic(photon_energy_list, mu=mu_select)[1]
        gra_cond_low_doped = array(gra_cond_low_doped)
        IF_shift_for_theta = []
        incident_theta_list = linspace(1 / 180 * pi, 90 / 180 * pi, 200)    #   incident angles
        incident_angle_list = incident_theta_list / pi * 180
        for ele_theta in incident_theta_list:
            ele_IF_shift = PSHE.get_if_shift_cond_over_wl(wave_length_arr, n0_index=ref_index_n0, cond=gra_cond_low_doped, n2_index=1, theta_0=ele_theta)
            IF_shift_for_theta.append(ele_IF_shift)
        fig, ax = plt.subplots()
        fig.set_size_inches(5, 5)
        img = ax.imshow(IF_shift_for_theta, extent=(wave_length_arr[0], wave_length_arr[-1], incident_angle_list[-1], incident_angle_list[0]))
        ax.plot([wavelength_example, wavelength_example], [incident_angle_list[0], incident_angle_list[-1]], 'r--')
        ax.text(wavelength_example+5, 80, r"$\Omega=2.5$", color='r')
        ax.set_aspect('auto')
        ax.set_xlabel(r'$\lambda$ (nm)')
        ...
        c_bar = fig.colorbar(img, cax=c_ax)
        c_bar.set_label("IF shift (nm)")
        fig.savefig(data_file_dir + 'PSHE/gra_if_gh_shift/if_shift_for_theta2.png', dpi=330, pad_inches=0.2, bbox_inches='tight')
        plt.close()
    ...
    def demo_gra_gh_shift_from_cond_over_wl():
        ...
        der_rs_angle_f, der_rp_angle_f = PSHE.get_gh_func_from_cond_over_wl(ref_index_n0, gra_cond_low_doped1, n2_index=1)
        ...
        fig, ax = plt.subplots()
        fig.set_size_inches(5, 5)
        img = ax.imshow(GH_shift_mat1, extent=(wave_length_arr[0], wave_length_arr[-1], incident_angle_list[-1], incident_angle_list[0]))
        ax.set_aspect('auto')
        ax.plot([wavelength_example, wavelength_example], [incident_angle_list[0], incident_angle_list[-1]], 'r--')
        ax.set_xlabel(r'$\lambda$ (nm)', fontsize=12)
        ax.set_ylabel(r'$\theta$ ($\degree$)', fontsize=12)
        ...
        fig.savefig(data_file_dir + 'PSHE/gra_if_gh_shift/gh_shift_for_theta2.png', dpi=330, pad_inches=0.2, bbox_inches='tight')
        plt.close()
        ...
        GH_shift_mat2 = []
        ##  Get the interpolated function of derivative of rs and rp angles
        der_rs_angle_f2, der_rp_angle_f2 = PSHE.get_gh_func_from_cond_over_wl(n0_index=1, cond=gra_cond_low_doped1, n2_index=ref_index_n0)
        ##  Express the wave vector
        ...
        fig, ax = plt.subplots()
        fig.set_size_inches(5, 5)
        img = ax.imshow(GH_shift_mat2, extent=(wave_length_arr[0], wave_length_arr[-1], incident_angle_list[-1], incident_angle_list[0]))
        ax.plot([wavelength_example, wavelength_example], [incident_angle_list[0], incident_angle_list[-1]], 'r--')
        ax.set_aspect('auto')
        ax.set_xlabel(r'$\lambda$ (nm)', fontsize=12)
        ax.set_ylabel(r'$\theta$ ($\degree$)', fontsize=12)
        ...
        c_bar = fig.colorbar(img, cax=c_ax)
        c_bar.set_label("GH shift (nm)")
        fig.savefig(data_file_dir + 'PSHE/gra_if_gh_shift/gh_shift_for_theta1.png', dpi=330, pad_inches=0.2, bbox_inches='tight')
        plt.close()
    ...
    def demo_verify_mos2_cond_Wu():
        ...
        fig.savefig(data_file_dir + "PSHE/MoS2_cond_Wu/cond_real_imag.png", dpi=330, facecolor='w', bbox_inches='tight', pad_inches=0.1)
        plt.close()
        ...
        ax_cond.set_ylim(ax_cond.get_ylim())
        ax_cond.legend(["Real part", "Imaginary part"])
        fig.savefig(data_file_dir + "PSHE/MoS2_cond_Wu/cond_real_e.pdf", dpi=330, facecolor='w', bbox_inches='tight', pad_inches=0.1)
        plt.close()

        ##  read unshifted data
        wls, cond_realpart, cond_imagpart = PSHE.read_mos2_the_cond_Wu_as_e2_h_unshifted()
        ...
        ax_cond.set_xlim(ax_cond.get_xlim())
        ax_cond.set_ylim(ax_cond.get_ylim())
        fig.savefig(data_file_dir + "PSHE/MoS2_cond_Wu/cond_real_imag_unshifted.pdf", dpi=330, facecolor='w', bbox_inches='tight', pad_inches=0.1)
        plt.close()
        ...
        ax_cond.set_ylim(ax_cond.get_ylim())
        ax_cond.legend(["Real part", "Imaginary part"])
        fig.savefig(data_file_dir + "PSHE/MoS2_cond_Wu/cond_real_e_unshifted.pdf", dpi=330, facecolor='w', bbox_inches='tight', pad_inches=0.1)
        plt.close()
    ...
    def demo_mos2_if_gh_shift_from_cond_unshifted():
        ##  read data
        wls_mos2, cond_realpart, cond_imagpart = PSHE.read_mos2_the_cond_Wu_as_eps_x_c_unshifted()
        ...
        wls_mos2, cond_realimag = PSHE.sample_wl_fit_substrate_wl(wls_sub, wls_mos2, [cond_realpart, cond_imagpart])
        ...
        IF_mos2_from_cond = PSHE.get_if_shift_cond_over_wl(wls_mos2, ref_index_sub, cond_mos2, n2_index=1, theta_0=pi/4)
        GH_mos2_from_cond = PSHE.get_gh_shift_cond_over_wl(wls_mos2, ref_index_sub, cond_mos2, n2_index=1, theta_0=pi/4)
        ...
        fig.savefig(data_file_dir + "PSHE/IF_shift_theory/if_gh_shift_from_cond_unshifted_comp_exp.pdf", dpi=330, facecolor='w', bbox_inches='tight', pad_inches=0.1)
        plt.close()
    ...
    def demo_sigma1_sigma2():
        ...
        fig.savefig(data_file_dir + "PSHE/s1_s2/s1_s2.png", dpi=330, facecolor='w', bbox_inches='tight', pad_inches=0.1)
        plt.close()
        ...
        fig.savefig(data_file_dir + "PSHE/s1_s2/s1_func_s2.png", dpi=330, facecolor='w', bbox_inches='tight', pad_inches=0.1)
        plt.close()

        ##  animation of s1 function of s2
        PubMeth.line_dot_track_animation(s1, s2, frames_num=len(s1), file_name="s1_func_s2")
    ...
    def demo_s1_s2_omegap_evolve():
        ...
        PubMeth.line_evolve_animation_in_a_row([s1_lists, [energy_list] * len(s1_lists), [energy_list] * len(s1_lists)], [s2_lists, s1_lists, s2_lists], frames_num=len(s1_lists), xlabels_list=[r"$\sigma_1$", r"E (meV)", r"E (meV)"], ylabels_list=[r"$\sigma_2$", r"$\sigma_1$", r"$\sigma_2$"], titles_list=[title_list, title_list, title_list], file_name="All_comp_omegap")
    ...
    def demo_s1_s2_omegao_evolve():
        ...
        ##  Multi-Column Animation
        PubMeth.line_evolve_animation_in_a_row([s1_lists, [energy_list] * len(s1_lists), [energy_list] * len(s1_lists)], [s2_lists, s1_lists, s2_lists], frames_num=len(s1_lists), xlabels_list=[r"$\sigma_1$", r"E (meV)", r"E (meV)"], ylabels_list=[r"$\sigma_2$", r"$\sigma_1$", r"$\sigma_2$"], titles_list=[title_list, title_list, title_list], file_name="All_comp_omegao")
    ...
    def demo_s1_s2_gamma_evolve():
        ...
        ##  Multi-Column Animation
        PubMeth.line_evolve_animation_in_a_row([s1_lists, [energy_list] * len(s1_lists), [energy_list] * len(s1_lists)], [s2_lists, s1_lists, s2_lists], frames_num=len(s1_lists), xlabels_list=[r"$\sigma_1$", r"E (meV)", r"E (meV)"], ylabels_list=[r"$\sigma_2$", r"$\sigma_1$", r"$\sigma_2$"], titles_list=[title_list, title_list, title_list], file_name="All_comp_gamma")
    ...
    def demo_get_rs_rp_from_s1_s2():
        ...
        fig.savefig(data_file_dir + "PSHE/s1_s2/Rs_phis.png", dpi=330, facecolor='w', bbox_inches='tight', pad_inches=0.1)
        plt.close()
        ##  Plot Rs and phi_s
        fig, axe_list = plt.subplots(1, 2, figsize=(10, 4))
        ax_1 = axe_list[0]
        ...
        ax_2.set_xlim(ax_2.get_xlim())
        ax_2.set_ylim(ax_2.get_ylim())
        fig.savefig(data_file_dir + "PSHE/s1_s2/Rp_phip.png", dpi=330, facecolor='w', bbox_inches='tight', pad_inches=0.1)
        plt.close()
        #endregion

        ##  Plot Rs as function of sigma1 and sigma2
        PubMeth.line_3d_dot_track_animation(sigma1, sigma1, Rs, len(sigma1), xlabel="$\sigma_1$", ylabel="$\sigma_2$", zlabel="$R_s$", title="", file_name="R_s_s1_s2")
        PubMeth.line_3d_dot_track_animation(sigma1, sigma1, phi_s, len(sigma1), xlabel="$\sigma_1$", ylabel="$\sigma_2$", zlabel="$\phi_s$", title="", file_name="phis_s1_s2")
        PubMeth.line_3d_dot_track_animation(sigma1, sigma1, Rp, len(sigma1), xlabel="$\sigma_1$", ylabel="$\sigma_2$", zlabel="$R_p$", title="", file_name="R_p_s1_s2")
        PubMeth.line_3d_dot_track_animation(sigma1, sigma1, phi_p, len(sigma1), xlabel="$\sigma_1$", ylabel="$\sigma_2$", zlabel="$\phi_p$", title="", file_name="phip_s1_s2")
    ...
    def demo_if_shift_from_s1_s2_single_lorentz():
        ...
        IF_shift = PSHE.get_if_shift_from_s1_s2(sigma1, sigma2, dense_wls, dense_n0_index, theta_0=pi/4)
        ...
        fig.savefig(data_file_dir + "PSHE/s1_s2/IF_single_lorentz.png", dpi=330, facecolor='w', bbox_inches='tight', pad_inches=0.1)
        plt.close()
        #endregion
        ...
        for ele_center_e in center_e_list:
            ...
            sigma1, sigma2 = PSHE.trial_single_lorentz_s1_s2(dense_energy, center_energy=ele_center_e)

            ele_IF_shift = PSHE.get_if_shift_from_s1_s2(sigma1, sigma2, dense_wls, dense_n0_index, theta_0=pi/4)
        ...
        for ele_coeff in omega_p_coeff_list:
            ...
            sigma1, sigma2 = PSHE.trial_single_lorentz_s1_s2(dense_energy, omegap_coeff=ele_coeff)
        ...
        for ele_gamma in gamma_e_list:
            ...
            sigma1, sigma2 = PSHE.trial_single_lorentz_s1_s2(dense_energy, gamma_energy=ele_gamma)
        ...
        PubMeth.line_evolve_animation([dense_wls] * len(evolution_over_center_e), evolution_over_center_e, frames_num=len(evolution_over_center_e), xlabel=r"$\lambda$ (nm)", ylabel=r"$\Delta_{IF}$", title=title_list1, file_name="IF_evo_center_e")
        PubMeth.line_evolve_animation([dense_wls] * len(evolution_over_omegap_coeff), evolution_over_omegap_coeff, frames_num=len(evolution_over_omegap_coeff), xlabel=r"$\lambda$ (nm)", ylabel=r"$\Delta_{IF}$", title=title_list2, file_name="IF_evo_omegap_coeff")
        PubMeth.line_evolve_animation([dense_wls] * len(evolution_over_gamma_e), evolution_over_gamma_e, frames_num=len(evolution_over_gamma_e), xlabel=r"$\lambda$ (nm)", ylabel=r"$\Delta_{IF}$", title=title_list3, file_name="IF_evo_gamma")

        wls_lists = [[dense_wls] * len(evolution_over_center_e), [dense_wls] * len(evolution_over_omegap_coeff), [dense_wls] * len(evolution_over_gamma_e)]
        shifts_list = [evolution_over_center_e, evolution_over_omegap_coeff, evolution_over_gamma_e]
        PubMeth.line_evolve_animation_in_a_row(wls_lists, shifts_list, frames_num=len(evolution_over_center_e), xlabels_list=[r"$\lambda$ (nm)", r"$\lambda$ (nm)", r"$\lambda$ (nm)"], ylabels_list=[r"$\Delta_{IF}$", r"$\Delta_{IF}$", r"$\Delta_{IF}$"], titles_list=[title_list1, title_list2, title_list3], file_name="multi_factor_IF_shift")
    ...
    def demo_multiple_lorentz_s1_s2():
        ...
        s1, s2 = PSHE.trial_multi_lorentz_s1_s2(dense_energy, center_list, coeff_list, gamma_list)
        ...
        ax_sigma.set_title(r"$\hbar \omega_{o_1} = %s \mathrm{meV}, \hbar \omega_{o_2} = %s \mathrm{meV}$" % (center_list[0], center_list[1]), fontsize=14)
        ax_sigma.set_xlim(ax_sigma.get_xlim())
        ax_sigma.set_ylim(ax_sigma.get_ylim())
        ax_sigma.legend([r"$\sigma_1$", r"$\sigma_2$"])
        fig.savefig(data_file_dir + "PSHE/s1_s2/multi_lorentz.png", dpi=330, facecolor='w', bbox_inches='tight', pad_inches=0.1)
        plt.close()
    ...
    def demo_if_shift_from_s1_s2_multi_lorentz():
        ...
        IF_shift = PSHE.get_if_shift_from_s1_s2(s1, s2, dense_wls, dense_n0_index, theta_0=pi/4)
        ...
        ax_IF.set_xlim(ax_IF.get_xlim())
        ax_IF.set_ylim(ax_IF.get_ylim())
        fig.savefig(data_file_dir + "PSHE/s1_s2/IF_multi_lorentz.png", dpi=330, facecolor='w', bbox_inches='tight', pad_inches=0.1)
        plt.close()
        #endregion
        ...
        for ele_coeff in omega_p_coeff_list:
            ...
            ele_IF_shift = PSHE.get_if_shift_from_s1_s2(s1, s2, dense_wls, dense_n0_index, theta_0=pi/4)
        ...
        wls_lists = [[dense_wls] * len(evo_if_center_e), [dense_wls] * len(evo_if_coeff), [dense_wls] * len(evo_if_gamma_e)]
    ...
    def demo_draw_exp_if_gh_data():
        ...
        for ele_i, ele_gh in enumerate(gh_tot_shifts):
            ...
            fig.savefig(data_file_dir + "PSHE/exp_ob_GH/sample_{}.png".format(ele_i + 1), dpi=330, facecolor='w', bbox_inches='tight', pad_inches=0.1)
            plt.close()
        ...
        for ele_i, ele_if in enumerate(if_tot_shifts):
            ...
            ax_gh.set_xlim(ax_gh.get_xlim())
            ax_gh.set_ylim(ax_gh.get_ylim())
            fig.savefig(data_file_dir + "PSHE/exp_ob_IF/sample_{}.png".format(ele_i + 1), dpi=330, facecolor='w', bbox_inches='tight', pad_inches=0.1)
            plt.close()
    ...
    def scan_omega_p_gamma():
        ...
        for ele_coeff in coeff_list:
            ...
            for ele_gamma in gamma_list:
                s1, s2 = PSHE.trial_single_lorentz_s1_s2(energy_list, center_e, ele_coeff, ele_gamma)
        ...
        fig, ax = plt.subplots()
        fig.set_size_inches(5, 5)
        img = ax.imshow(all_mat, extent=(gamma_list[0], gamma_list[-1], coeff_list[-1], coeff_list[0]))
        ax.set_aspect('auto')
        ax.set_xlabel('$\gamma$')
        ...
        fig.savefig(data_file_dir + 'PSHE/s1_s2/scan_omega_p_gamma.png', dpi=330, pad_inches=0.2, bbox_inches='tight')
        plt.close()
    ...
    def demo_lorentz_peak():
        ...
        lorentz_real = PubMeth.lorentz_real(var_list, amp_ratio_list, center_list, gamma_list)

        lorentz_imag= PubMeth.lorentz_imag(var_list, amp_ratio_list, center_list, gamma_list)
        ...
        fig.savefig(data_file_dir + "PSHE/lorentz/real_imag_part.png", dpi=330, facecolor='w', bbox_inches='tight', pad_inches=0.1)
        plt.close()
    ...
    def demo_if_shift_from_s1_s2_multi_lorentz_direct():
        ...
        ##  parameters list
        center_list = [1.9624354e+03]
        num_of_lorentz = len(center_list)
        gamma_list = [95] * num_of_lorentz
        amp_ratio_list = [1] * num_of_lorentz

        ##  Express the IF shift
        IF_shift = PSHE.if_shift_func_multi_lorentz(target_energy, center_list, amp_ratio_list, gamma_list, 0, 0, 'direct')
        ...
        for ele_center in center_list:
            amp = 1
            ele_if = PSHE.if_shift_func_multi_lorentz(target_energy, [ele_center], [amp], [gamma_default], total_shift=0, lorentz_const=0, type_s='direct')
            evo_center_list.append(ele_if)
            center_titles.append(r"$\omega_o$={:.2f}".format(ele_center))

        for ele_gamma in gamma_list:
            amp = 1
            ele_if = PSHE.if_shift_func_multi_lorentz(target_energy, [center_default], [amp], [ele_gamma], total_shift=0, lorentz_const=0, type_s='direct')
            evo_gamma_list.append(ele_if)
            gamma_titles.append(r"$\gamma$={:.2f}".format(ele_gamma))
        
        for ele_ratio in linspace(0, 1, frames_num):
            ele_amp = ele_ratio
            ele_if = PSHE.if_shift_func_multi_lorentz(target_energy, [center_default], [ele_amp], [gamma_default], total_shift=0, lorentz_const=0, type_s='direct')
            evo_amp_list.append(ele_if)
            amp_titles.append("ratio = {}".format(ele_ratio))
        
        for ele_const in lorentz_const_list:
            amp_ratio = 1
            ele_if = PSHE.if_shift_func_multi_lorentz(target_energy, [center_default], [amp_ratio], [gamma_default], total_shift=0, lorentz_const=ele_const, type_s='direct')
        ...
        PubMeth.line_evolve_animation_in_a_row(x_lists, images_list, frames_num=frames_num, xlabels_list=[r"$\lambda$"] * len(images_list), ylabels_list=[r"$\Delta_{IF}$"] * len(images_list), titles_list=title_list, file_name="IF_s1_s2_direct_lorentz", fig_height=5)
    ...
    def demo_gh_shift_from_s1_s2():
        ...
        amp_list = [PSHE.eta_amp_to_center_gamma(center_list[ele_i], gamma_list[ele_i], scale_ratio=1) for ele_i in range(len(center_list))]

        ##  Express the IF shift
        GH_shift, dense_wls = PSHE.get_gh_shift_over_wl_s1_s2_direct_lorentz(center_list, amp_list, gamma_list, theta_0=pi/4)
        ...
        ax_gh.set_ylim(ax_gh.get_ylim())
        ax_gh.legend([])
        fig.savefig(data_file_dir + "PSHE/lorentz/gh.png", dpi=330, facecolor='w', bbox_inches='tight', pad_inches=0.1)
        plt.close()
    ...
    def demo_scan_s1_s2_for_one_lambda():
        ...
        fig.savefig(data_file_dir + 'PSHE/s1_s2/scan/tmp_map.png', dpi=330, pad_inches=0.2, bbox_inches='tight')
        plt.close()

        trace1 = go.Surface(x=s1, y=s2, z=IF_map)
        layout = PubMeth.plotly_layout(xlabel=r"$\sigma_1$", ylabel="$\sigma_2$", zlabel=r"IF shift (nm)", figuretitle=r"$\lambda=$ {}nm".format(target_wl))
    ...
    def demo_mono_mos2():
        ...
        # plt.ylabel("E(eV)")
        # plt.plot(eig_list)
        # plt.savefig(data_file_dir + 'bands/MoS2/mono_bands.png', dpi=330)
    ...
    def demo_VR_test():
        ...
        fig.savefig(data_file_dir + "00_small_test/V_R.png", dpi=330, facecolor='w', bbox_inches='tight', pad_inches=0.1)
        plt.close()
    ...
    def demo_mos2_converge():
        ...
        boundary_list = [tmp_mos2.path_gamma, tmp_mos2.b1, tmp_mos2.b1 + tmp_mos2.b2, tmp_mos2.b2, tmp_mos2.path_gamma]
        ...
        for ele_i in range(70):
            ...
            fig.savefig("/home/aoxv/code/Data/bands/MoS2/V_q_sum/N_Vq_nb_{}.png".format(ele_i), dpi=330, facecolor='w', bbox_inches='tight', pad_inches=0.4)
            plt.close()
    ...
    def demo_struve_bessel_function():
        ...
        fig.savefig(data_file_dir + "00_small_test/struve_bessel.png", dpi=330, facecolor='w', bbox_inches='tight', pad_inches=0.1)
        plt.close()
    ...
    def demo_PL_mos2():
        ...
        ax_PL.set_xlabel(r'$\lambda$ (nm)', fontsize=12)
        ...
        fig.savefig(data_file_dir + "PL/MoS2.pdf", dpi=330, facecolor='w', bbox_inches='tight', pad_inches=0.1)
        plt.close()
        ...
        ax_PL.set_xlim(ax_PL.get_xlim())
        ax_PL.set_ylim(ax_PL.get_ylim())
        fig.savefig(data_file_dir + "PL/MoS2_e.pdf", dpi=330, facecolor='w', bbox_inches='tight', pad_inches=0.1)
        plt.close()
    ...
    def demo_comp_BK7():
        ...
        data_1 = PubMeth.read_xlsx_data(path_1, )
        data_2 = PubMeth.read_xlsx_data(path_2, )
        ...
        fig.savefig(data_file_dir + "00_small_test/BK7_comp.png", dpi=330, facecolor='w', bbox_inches='tight', pad_inches=0.1)
        plt.close()
    ...
    def demo_if_gh_angle_test():
        ...
        Rs_mat, phis_mat = PSHE.rs_from_s1_s2(s1, s2, dense_n0_index, theta_0=theta_list, cal_type="GH")
        ...
        for ele_theta in plot_theta_list:
            ele_GH_shift, ele_wls = PSHE.get_gh_shift_over_wl_s1_s2_direct_lorentz(center_list, amp_ratio_list, gamma_list, theta_0=ele_theta, sample_points=1000, wls_points=wls_points)
            # ele_GH_shift = ele_GH_shift - max(ele_GH_shift)
            ele_trace = go.Scatter(name=round(ele_theta / pi * 180, 1), x=ele_wls, y=ele_GH_shift)
        ...
        traces_list = []
        for ele_theta in plot_theta_list:
            ele_if_shift, ele_wls = PSHE.get_if_shift_over_wl_s1_s2_direct_lorentz(dense_energy, center_list, amp_ratio_list, gamma_list, theta_0=ele_theta, wls_points=wls_points)
            # ele_if_shift = ele_if_shift - min(ele_if_shift)
            ele_trace = go.Scatter(name=round(ele_theta / pi * 180, 1), x=ele_wls, y=ele_if_shift)
            traces_list.append(ele_trace)
            print("Complete angle (degree): ", round(ele_theta / pi * 180, 2))
    ...
    def demo_model_comp():
        ...
        for ele_i in range(len(if_wls)):
            ...
            all_pars_list = np.load("/home/aoxv/code/Data/00_dash_app/data/fit_pars/fit_pars_{}.npy".format(ele_i + 1))

            energy_centers = all_pars_list[0]
            amp_ratio_list = all_pars_list[1]
            gamma_list = all_pars_list[2]

            sigma = PubMeth.lorentz_full(dense_energy, energy_centers, amp_ratio_list, gamma_list, timesi=True, pars_type="list")

            permittivity_epsilon = PSHE.convert_2d_sigma_to_permittivity(dense_energy, sigma)

            n, k = PSHE.convert_permittivity_to_ref_index(permittivity_epsilon)

            n1_index = n + 1j * k

            if_shift_ref_index, if_wls_ref_index = PSHE.get_if_shift_ref_index(dense_wls, dense_n0_index, n1_index)
            gh_shift_ref_index, gh_wls_ref_index = PSHE.get_gh_shift_ref_index(dense_wls, dense_n0_index, n1_index)

            if_shift_sigma, if_wls_sigma = PSHE.get_if_shift_over_wl_s1_s2_direct_lorentz(dense_energy, energy_centers, amp_ratio_list, gamma_list)
            gh_shift_sigma, gh_wls_sigma = PSHE.get_gh_shift_over_wl_s1_s2_direct_lorentz( energy_centers, amp_ratio_list, gamma_list)

            xybar_if_ref_index = PubMeth.get_center_of_curve(if_wls_ref_index, if_shift_ref_index)

            xybar_gh_ref_index = PubMeth.get_center_of_curve(gh_wls_ref_index, gh_shift_ref_index)
            xybar_gh_sigma = PubMeth.get_center_of_curve(gh_wls_sigma, gh_shift_sigma)
            mutual_ybar = (xybar_gh_ref_index[1] + xybar_gh_sigma[1] + gh_ybar_list[ele_i]) / 3
            ...
            ax_gh_comp.legend(["Experiment result", "Thin-film model", "Conductivity model", ])
            fig.savefig(data_file_dir + "PSHE/model_comp/GH shift_same_center/sample_{}.png".format(ele_i + 1), dpi=330, facecolor='w', bbox_inches='tight', pad_inches=0.1)
            plt.close()
    ...
    def demo_lorentz_puzzle():
        ...
        fig.savefig(data_file_dir + "PSHE/lorentz/model2.png", dpi=330, facecolor='w', bbox_inches='tight', pad_inches=0.1)
        plt.close()
    ...
    def demo_comp_Wu_mos2_lorentzian_mos2():
        ...
        data_set = pd.read_csv("/home/aoxv/code/Data/00_common_sense/Wu_cond_real_original.csv")
        ...
        ax_comp.legend(["Original data", "Lorentzian-fitted real part", "Lorentzian-fitted imaginary part"])
        fig.savefig(data_file_dir + "PSHE/MoS2_cond_Wu/comp_origin_lorentzian_fit.pdf", dpi=330, facecolor='w', bbox_inches='tight', pad_inches=0.1)
        plt.close()
    ...
    def demo_all_exp_if_data():
        ...
        spec_IF = fig_IF.add_gridspec(nrows=2, ncols=14, )
        fig_GH = plt.figure(figsize=(18, 10))
        spec_GH = fig_GH.add_gridspec(nrows=2, ncols=14, )

        for ele_i in range(3):
            ax1 = fig_IF.add_subplot(spec_IF[0, ele_i * 4 + ele_i : (ele_i + 1) * 4 + ele_i])
            ...
            ax2 = fig_GH.add_subplot(spec_GH[0, ele_i * 4 + ele_i : (ele_i + 1) * 4 + ele_i])
        ...
        fig_IF.savefig(data_file_dir + "PSHE/exp_ob/shifts_collection/if_collections.pdf", bbox_inches='tight', pad_inches=0.1, dpi=330)
        plt.close(fig_IF)

        fig_GH.savefig(data_file_dir + "PSHE/exp_ob/shifts_collection/gh_collections.pdf", bbox_inches='tight', pad_inches=0.1, dpi=330)
        plt.close(fig_GH)
    ...
    def demo_dimensionless_IF_GH():
        ...
        IF_shift_0, out_wls_0 = PSHE.get_if_shift_over_wl_s1_s2_direct_lorentz(dense_energy, center_list, amp_ratio_list, gamma_list, dimensionless=False)

        center_list = [2000, 2100]
        gamma_list = [50, 70]
        amp_ratio_list = [0.3, 0.3]

        IF_shift, out_wls = PSHE.get_if_shift_over_wl_s1_s2_direct_lorentz(dense_energy, center_list, amp_ratio_list, gamma_list, dimensionless=False)
        ...
        fig.savefig(data_file_dir + "PSHE/shifts_theory/dimensionless_IF.png", dpi=330, facecolor='w', bbox_inches='tight', pad_inches=0.1)
        plt.close()
