...
async def send_price_wx(openid_list, route: SpotData):
    data = {'first': {'value': f'新运价:{route.carrier_id} {route.from_port_id}-{route.to_port_id}'.upper(),
                      'color': '#173177'},
            'keyword1': {'value': f'{route.vessel}/{route.voyage}/{route.carrier_line}',
                         'color': '#173177'},
            'keyword2': {'value': f' etd:{route.etd} days:{route.days}',
                         'color': '#173177'},
            'keyword3': {'value': f'{route.ctntype_id} price ${route.base_price}',
                         'color': '#173177'},
