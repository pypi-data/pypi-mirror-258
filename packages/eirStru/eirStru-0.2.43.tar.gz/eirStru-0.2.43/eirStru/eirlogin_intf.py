...
class LoginIntf:
    ...
    async def check_account_info(self, param: ParamsCheckAccount):
        """
        检查账号
        """
        url = f'{self.host}/get_account_info/'
        headers = {
        ...
        try:
            async with ClientSession() as cs:
                async with cs.post(url, headers=headers, data=param.model_dump_json(), verify_ssl=False) as resp:
