...
class SpotParams(BaseModel):
    ...
    carrier_id: Optional[str] = None
    from_port: Optional[str] = None  # 起运港
    to_port: Optional[str] = None  # 目的港
    ctntype: Optional[str] = None  # 箱型
...
class SpotData(BaseModel):
    ...
    freight: Optional[float] = None  # 运费
    info: Optional[dict] = None  # json数据
