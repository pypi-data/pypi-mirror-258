...
import clients.fine_tuning.models
from clients.fine_tuning import rest
from clients.fine_tuning.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(clients.fine_tuning.models, klass)
