...
from admin.live_output.get_output_types import _get_output_types

import requests, json

def _create_live_output(AUTH_TOKEN, URL, NAME, OUTPUT_TYPE, ENABLED, AUDIO_BITRATE,
    ...
    try:
        ...
        _api_exception_handler(RESPONSE, "Create Live Output Failed")