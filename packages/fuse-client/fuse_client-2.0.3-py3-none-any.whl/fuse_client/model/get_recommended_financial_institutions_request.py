...
class GetRecommendedFinancialInstitutionsRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["session_client_secret", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["session_client_secret", ], str]):
