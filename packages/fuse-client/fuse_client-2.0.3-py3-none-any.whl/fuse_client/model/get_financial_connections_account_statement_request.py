...
class GetFinancialConnectionsAccountStatementRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["access_token", "remote_account_id", "date", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["access_token", "remote_account_id", "date", ], str]):
