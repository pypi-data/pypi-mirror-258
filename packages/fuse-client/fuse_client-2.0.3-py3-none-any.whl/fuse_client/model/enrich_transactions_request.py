        ...
        class properties:
            ...
            class transactions(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['TransactionToEnrich']:
                        return TransactionToEnrich
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['TransactionToEnrich'], typing.List['TransactionToEnrich']],
                ...
                def __getitem__(self, i: int) -> 'TransactionToEnrich':
