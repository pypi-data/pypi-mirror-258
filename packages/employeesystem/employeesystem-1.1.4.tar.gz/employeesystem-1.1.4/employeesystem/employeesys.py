class Employee:
    ...
    def input_raise_amt(self):
        print(
            'Input must be a float greater than 1 (ex: 1.25 for 25%), otherwise the salary will decrease when the raise is applied')
        self.raiseAmt = float(input('Enter new raise amount: '))
