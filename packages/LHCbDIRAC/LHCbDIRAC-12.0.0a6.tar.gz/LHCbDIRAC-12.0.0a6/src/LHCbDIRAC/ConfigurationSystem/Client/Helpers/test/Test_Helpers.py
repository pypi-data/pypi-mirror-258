...
@pytest.mark.parametrize(
    ...
    [
        ...
        ({frozenset({"x86_64-centos7-gcc49-opt"}), frozenset({"x86_64-slc6-gcc62-opt"})}, "x86_64_v2-centos7"),
        (
            {
        ...
        ({frozenset({"x86_64+fma-centos7-gcc7-opt"}), frozenset({"x86_64+avx-slc6-gcc62-opt"})}, "x86_64_v3-centos7"),
