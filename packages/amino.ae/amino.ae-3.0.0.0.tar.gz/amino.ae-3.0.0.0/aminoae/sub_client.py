...
class SubClient(client.Client):
    ...
    def send_coins(self, coins: int, blogId: str = None, wikiId: str = None, chatId: str = None, objectId: str = None, transactionId: str = None):
        url = None
        ...
        if wikiId is not None: url = f"{self.api}/x{self.comId}/s/item/{wikiId}/tipping"
