...
class AscendApi(object):
    ...
    def delete_data_service(self, data_service_id, **kwargs):  # noqa: E501
        ...
        :param async_req bool: execute request asynchronously
        :param str data_service_id: Data service id. (required)
        :param bool clean_connections_and_credentials:
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def delete_data_service_with_http_info(self, data_service_id, **kwargs):  # noqa: E501
        ...
        all_params = [
            'data_service_id',
            'clean_connections_and_credentials'
        ]
        all_params.extend(
            [
                'async_req',
        ...
        query_params = []
        if 'clean_connections_and_credentials' in local_var_params and local_var_params['clean_connections_and_credentials'] is not None:  # noqa: E501
            query_params.append(('clean_connections_and_credentials', local_var_params['clean_connections_and_credentials']))  # noqa: E501
