...
def getNodeDeathPayload():
    payload = Payload()
    # addMetric(payload, "bdSeq", None, MetricDataType.Double, getBdSeqNum())
    addMetric(payload, "bdSeq", None, MetricDataType.Double, 1)
    return payload
######################################################################
...
def getNodeBirthPayload():
    ...
    # addMetric(payload, "bdSeq", None, MetricDataType.Double, --bdSeq)
    return payload
######################################################################
