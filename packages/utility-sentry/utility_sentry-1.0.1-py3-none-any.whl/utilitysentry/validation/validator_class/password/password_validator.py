"""This module provide functionality to validate password object.

This module provides a UtilityValidator class that allows for validating
a password value of JSON object.

This have the following classes:
    - `Password` : This class is responsible for validating a password object.
"""
...
class Password(BaseValidator, UtilityValidator):
    """Validate a Password object.

    This class provide functionality to validate a Password object. It is
    ...
    def __init__(self, *args, **kwargs):
        """Initialize a Password class instance."""
    ...
    def _validate_init_method_arguments(self, *args, **kwargs):
        ...
        try:
            ...
            self._validate_accepted_parameters(
                self.CLASS_NAME, cons.PASSWORD_CLASS, kwargs)
    ...
    def validate(self, key, value):
        """Validate parameter for Password class.

        This method validates the input parameters for the Password class.
        ...
        try:
            ...
            if self.regex is None:
                self.regex = cons.DEFAULT_PASSWORD_REGEX
