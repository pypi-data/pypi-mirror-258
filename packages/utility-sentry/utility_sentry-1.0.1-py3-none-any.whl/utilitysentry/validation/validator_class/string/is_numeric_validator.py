"""This module provide functionality to validate string numeric object.

This module provides a UtilityValidator class that allows for validating
a numeric string value of JSON object.

This have the following classes:
    - `IsNumeric` : This class is responsible for validating a numeric string
        object.
"""
...
class IsNumeric(BaseValidator, UtilityValidator):
    """Validate a String numeric object.

    This class provide functionality to validate a String numeric object. It is
    designed to simplify validation operations in Python programs.
    """

    DATA_TPYE = str
    DATA_TYPE_NAME = "String"
    CLASS_NAME = "IsNumeric"

    def __init__(self, *args, **kwargs):
        """Initialize a String numeric class instance."""
        self.log = UtilityDefaultLogger().get_logger()
        self._validate_init_method_arguments(*args, **kwargs)
        super(IsNumeric, self).__init__(**kwargs)
    ...
    def _validate_init_method_arguments(self, *args, **kwargs):
        ...
        try:
            ...
            self._validate_accepted_parameters(
                self.CLASS_NAME, cons.IS_NUMERIC_CLASS, kwargs)
    ...
    def validate(self, key, value):
        """Validate parameter for String numeric class.

        This method validates the input parameters for the String numeric
        class.
