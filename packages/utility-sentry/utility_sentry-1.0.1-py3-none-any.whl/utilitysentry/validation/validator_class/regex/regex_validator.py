"""This module provide functionality to validate regex object.

This module provides a UtilityValidator class that allows for validating
a regex value of JSON object.

This have the following classes:
    - `Regex` : This class is responsible for validating a regex object.
"""
...
class Regex(BaseValidator, UtilityValidator):
    """Validate a Regex object.

    This class provide functionality to validate a Regex object. It is
    ...
    def __init__(self, *args, **kwargs):
        """Initialize a Regex class instance."""
    ...
    def _validate_init_method_arguments(self, *args, **kwargs):
        ...
        try:
            ...
            self._validate_accepted_parameters(
                self.CLASS_NAME, cons.REGEX_CLASS, kwargs)
    ...
    def validate(self, key, value):
        """Validate parameter for Regex class.

        This method validates the input parameters for the Regex class.
        ...
        try:
            ...
            if self.regex is None:
                ...
                message = message.format(
                    cons.REGEX, self.DATA_TYPE_NAME, self.CLASS_NAME)
