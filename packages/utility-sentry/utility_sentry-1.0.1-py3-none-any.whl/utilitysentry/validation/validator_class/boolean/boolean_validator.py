"""This module provide functionality to validate boolean value object.

This module provides a UtilityValidator class that allows for validating
a boolean value of JSON object.

This have the following classes:
    - `Boolean` : This class is responsible for validating a boolean value
        object.
"""
...
class Boolean(BaseValidator, UtilityValidator):
    """Validate a Boolean value object.

    This class provide functionality to validate a Boolean value object. It is
    ...
    def __init__(self, *args, **kwargs):
        """Initialize a Boolean class instance."""
    ...
    def _validate_init_method_arguments(self, *args, **kwargs):
        ...
        try:
            ...
            self._validate_accepted_parameters(
                self.CLASS_NAME, cons.BOOLEAN_CLASS, kwargs)
    ...
    def validate(self, key, value):
        """Validate parameter for Boolean class.

        This method validates the input parameters for the Boolean class.
