from tools_rest import *
from django.conf import settings, urls
from tools_rest.exceptions import exception_400, exception_403, exception_404, exception_500, TESTE

if hasattr(settings, 'CUSTOM_EXCEPTION') and settings.CUSTOM_EXCEPTION.__contains__('URLS_HANDLER', None):
    from tools_rest.resources.constants_exc import HTTP_400, HTTP_403, HTTP_404, HTTP_500
    ...
    custom_ex =settings.CUSTOM_EXCEPTION.get('EXCEPTIONS', None)
