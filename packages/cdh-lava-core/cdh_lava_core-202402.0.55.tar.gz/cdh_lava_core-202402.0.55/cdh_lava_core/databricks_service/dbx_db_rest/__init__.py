...
class RestClient(ApiClient):
    ...
    def __init__(
        ...
        *,
        ...
        from cdh_lava_core.databricks_service.dbx_db_rest.cluster_policies import ClustersPolicyClient

        self.cluster_policies = ClustersPolicyClient(self)

        from cdh_lava_core.databricks_service.dbx_db_rest.instance_pools import InstancePoolsClient
        ...
        from cdh_lava_core.databricks_service.dbx_db_rest.pipelines import PipelinesClient
        ...
        from cdh_lava_core.databricks_service.dbx_db_rest.token_management import TokenManagementClient
        ...
        from cdh_lava_core.databricks_service.dbx_db_rest.workspace import WorkspaceClient
