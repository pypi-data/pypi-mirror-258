...
class MetadataJsonFileDownload(Resource):
    ...
    def get(self, schema_id):
        ...
        Example:
            Use schema_id 106788 to test LAVA_CORE_DEV (DataBricks): lava_core_dev
...
class MetadataExcelFileDownload(Resource):
    ...
    def get(self, schema_id):
        ...
        Example:
            Use schema_id 106788TBD to test LAVA_CORE_DEV (DataBricks): lava_core_dev
...
class MetadataJsonFileUpload(Resource):
    ...
    def post(self):
        ...
        based on schema_id.
        Use 106788 to test LAVA_CORE_DEV (DataBricks)
        """
