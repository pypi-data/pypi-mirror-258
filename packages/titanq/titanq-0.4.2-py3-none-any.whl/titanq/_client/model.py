...
class S3Input(BaseModel):
    ...
    bias_constraints_file_name: Optional[str]
    weights_constraints_file_name: Optional[str]
    s3: AwsStorage
...
class TempStorageInput(BaseModel):
    ...
    weights_constraints_file: FileUrls = Field(alias="weights_constraints.npy")
    bias_constraints_file: FileUrls = Field(alias="bias_constraints.npy")
