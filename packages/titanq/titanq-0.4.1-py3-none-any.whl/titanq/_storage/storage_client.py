...
class StorageClient(ABC):
    ...
    def temp_files_manager(self,
        bias: np.ndarray,
        weights: np.ndarray,
        bias_constraints: Optional[np.ndarray],
        weights_constraints: Optional[np.ndarray],
        ...
        """
        return TempFileManager(self, bias, weights, bias_constraints, weights_constraints)
...
class TempFileManager():
    ...
    def __init__(
        ...
        self._bias_constraints = bias_constraints
    ...
    def __enter__(self) -> Type["TempFileManager"]:
        self._storage_client._upload_arrays(
            ...
            self._to_bytes(self._bias_constraints),
            self._to_bytes(self._weights_constraints),
        )
        return self
