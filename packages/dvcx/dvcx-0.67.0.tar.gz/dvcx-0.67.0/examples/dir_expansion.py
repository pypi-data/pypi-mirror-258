...
partial_id = metastore.get_valid_partial_id("s3://ldb-public", "remote/datasets")
n = warehouse.nodes_table("s3://ldb-public", partial_id)
dr = warehouse.dataset_rows(dataset)
