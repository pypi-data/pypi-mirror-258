...
from random_flavorpack.management.commands.load_random_flavorpack_auth import Command
...
class RandomTests(APITestCase):
    ...
    def test_create_region_bad_start(
        self, data=None, assert_status=status.HTTP_201_CREATED
    ):
        """
        Ensure we can create a test region for the created pool instance
        """
    ...
    def test_create_region_bad_min(
        self, data=None, assert_status=status.HTTP_201_CREATED
    ):
        """
        Ensure we can create a test region for the created pool instance
    ...
    def test_allocate_numbers(self):
        ...
        logger.info(f"Randomized Response:  {response.content}")
    ...
    def test_region_remaining(self):
        ...
        self.assertEqual(
            ...
            "The region remaining size has not been calculated  " "correctly",
        )
    ...
    def test_generate_10_pseudo_random(self):
        state = 23423
        rg = RandomGenerator()
        numbers = rg.get_random_numbers(
            state, 1, 999999999999, size=10, shuffle_numbers=False
        )[0]
        logger.info(numbers)
        self.assertTrue(
            set(numbers)
    ...
    def test_shuffle(self):
        ...
        rg = RandomGenerator()
        numbers = rg.get_random_numbers(
            state, 1, 999999999999, size=10, shuffle_numbers=True
        )[0]
