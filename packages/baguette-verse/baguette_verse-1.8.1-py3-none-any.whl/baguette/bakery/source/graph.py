...
from typing import Any, Callable, Iterable, Iterator, Literal, Never, Optional, Self, TypeGuard, TypeVar, TypedDict, Union, overload
...
class Graph:
    ...
    class GraphIsoMapping:
        ...
        from Viper.collections.isomorph import IsoDict as __IsoDict
...
del RLock, Thread, Any, Callable, Iterable, Iterator, Literal, Never, Optional, TypeVar, TypedDict, Union, WeakKeyDictionary, WeakValueDictionary, Color, ColorSetting, SizeSetting, SwitchSetting, WeightSetting, InstanceReferencingClass, IsoSet