import logging
from infra.proxy import proxy_files
from infra.remote import ssh_content_into_file, ssh_run_command
from infra.repo import get_epel_repo, get_insecure_registry, get_local_repo
from ezlab.parameters import GENERIC, KVM, PVE, SETUP_COMMANDS, TASK_FINISHED
from utils import fire_and_forget, ezapp
from infra import pve
from infra import kvm
