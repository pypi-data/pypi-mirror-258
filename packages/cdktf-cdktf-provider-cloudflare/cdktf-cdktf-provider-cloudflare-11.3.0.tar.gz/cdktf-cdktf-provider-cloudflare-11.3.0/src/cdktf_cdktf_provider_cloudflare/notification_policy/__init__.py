...
class NotificationPolicy(
    ...
    def __init__(
        ...
        *,
        ...
        :param account_id: The account identifier to target for the resource. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.25.0/docs/resources/notification_policy#account_id NotificationPolicy#account_id}
        ...
        :param enabled: The status of the notification policy. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.25.0/docs/resources/notification_policy#enabled NotificationPolicy#enabled}
        :param name: The name of the notification policy. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.25.0/docs/resources/notification_policy#name NotificationPolicy#name}
        :param description: Description of the notification policy. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.25.0/docs/resources/notification_policy#description NotificationPolicy#description}
        :param email_integration: email_integration block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.25.0/docs/resources/notification_policy#email_integration NotificationPolicy#email_integration}
        :param filters: filters block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.25.0/docs/resources/notification_policy#filters NotificationPolicy#filters}
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.25.0/docs/resources/notification_policy#id NotificationPolicy#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param pagerduty_integration: pagerduty_integration block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.25.0/docs/resources/notification_policy#pagerduty_integration NotificationPolicy#pagerduty_integration}
        :param webhooks_integration: webhooks_integration block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.25.0/docs/resources/notification_policy#webhooks_integration NotificationPolicy#webhooks_integration}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing NotificationPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.25.0/docs/resources/notification_policy#import import section} in the documentation of this resource for the id to use
    ...
    def put_filters(
        ...
        *,
        ...
        '''
        :param actions: Targeted actions for alert. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.25.0/docs/resources/notification_policy#actions NotificationPolicy#actions}
        :param affected_components: Affected components for alert. Available values: ``API``, ``API Shield``, ``Access``, ``Always Online``, ``Analytics``, ``Apps Marketplace``, ``Argo Smart Routing``, ``Audit Logs``, ``Authoritative DNS``, ``Billing``, ``Bot Management``, ``Bring Your Own IP (BYOIP)``, ``Browser Isolation``, ``CDN Cache Purge``, ``CDN/Cache``, ``Cache Reserve``, ``Challenge Platform``, ``Cloud Access Security Broker (CASB)``, ``Community Site``, ``DNS Root Servers``, ``DNS Updates``, ``Dashboard``, ``Data Loss Prevention (DLP)``, ``Developer's Site``, ``Digital Experience Monitoring (DEX)``, ``Distributed Web Gateway``, ``Durable Objects``, ``Email Routing``, ``Ethereum Gateway``, ``Firewall``, ``Gateway``, ``Geo-Key Manager``, ``Image Resizing``, ``Images``, ``Infrastructure``, ``Lists``, ``Load Balancing and Monitoring``, ``Logs``, ``Magic Firewall``, ``Magic Transit``, ``Magic WAN``, ``Magic WAN Connector``, ``Marketing Site``, ``Mirage``, ``Network``, ``Notifications``, ``Observatory``, ``Page Shield``, ``Pages``, ``R2``, ``Radar``, ``Randomness Beacon``, ``Recursive DNS``, ``Registrar``, ``Registration Data Access Protocol (RDAP)``, ``SSL Certificate Provisioning``, ``SSL for SaaS Provisioning``, ``Security Center``, ``Snippets``, ``Spectrum``, ``Speed Optimizations``, ``Stream``, ``Support Site``, ``Time Services``, ``Trace``, ``Tunnel``, ``Turnstile``, ``WARP``, ``Waiting Room``, ``Web Analytics``, ``Workers``, ``Workers KV``, ``Workers Preview``, ``Zaraz``, ``Zero Trust``, ``Zero Trust Dashboard``, ``Zone Versioning``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.25.0/docs/resources/notification_policy#affected_components NotificationPolicy#affected_components}
        :param alert_trigger_preferences: Alert trigger preferences. Example: ``slo``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.25.0/docs/resources/notification_policy#alert_trigger_preferences NotificationPolicy#alert_trigger_preferences}
        :param enabled: State of the pool to alert on. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.25.0/docs/resources/notification_policy#enabled NotificationPolicy#enabled}
        :param environment: Environment of pages. Available values: ``ENVIRONMENT_PREVIEW``, ``ENVIRONMENT_PRODUCTION``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.25.0/docs/resources/notification_policy#environment NotificationPolicy#environment}
        :param event: Pages event to alert. Available values: ``EVENT_DEPLOYMENT_STARTED``, ``EVENT_DEPLOYMENT_FAILED``, ``EVENT_DEPLOYMENT_SUCCESS``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.25.0/docs/resources/notification_policy#event NotificationPolicy#event}
        :param event_source: Source configuration to alert on for pool or origin. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.25.0/docs/resources/notification_policy#event_source NotificationPolicy#event_source}
        :param event_type: Stream event type to alert on. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.25.0/docs/resources/notification_policy#event_type NotificationPolicy#event_type}
        :param group_by: Alert grouping. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.25.0/docs/resources/notification_policy#group_by NotificationPolicy#group_by}
        :param health_check_id: Identifier health check. Required when using ``filters.0.status``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.25.0/docs/resources/notification_policy#health_check_id NotificationPolicy#health_check_id}
        :param incident_impact: The incident impact level that will trigger the dispatch of a notification. Available values: ``INCIDENT_IMPACT_NONE``, ``INCIDENT_IMPACT_MINOR``, ``INCIDENT_IMPACT_MAJOR``, ``INCIDENT_IMPACT_CRITICAL``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.25.0/docs/resources/notification_policy#incident_impact NotificationPolicy#incident_impact}
        :param input_id: Stream input id to alert on. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.25.0/docs/resources/notification_policy#input_id NotificationPolicy#input_id}
        :param limit: A numerical limit. Example: ``100``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.25.0/docs/resources/notification_policy#limit NotificationPolicy#limit}
        :param megabits_per_second: Megabits per second threshold for dos alert. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.25.0/docs/resources/notification_policy#megabits_per_second NotificationPolicy#megabits_per_second}
        :param new_health: Health status to alert on for pool or origin. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.25.0/docs/resources/notification_policy#new_health NotificationPolicy#new_health}
        :param new_status: Tunnel health status to alert on. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.25.0/docs/resources/notification_policy#new_status NotificationPolicy#new_status}
        :param packets_per_second: Packets per second threshold for dos alert. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.25.0/docs/resources/notification_policy#packets_per_second NotificationPolicy#packets_per_second}
        :param pool_id: Load balancer pool identifier. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.25.0/docs/resources/notification_policy#pool_id NotificationPolicy#pool_id}
        :param product: Product name. Available values: ``worker_requests``, ``worker_durable_objects_requests``, ``worker_durable_objects_duration``, ``worker_durable_objects_data_transfer``, ``worker_durable_objects_stored_data``, ``worker_durable_objects_storage_deletes``, ``worker_durable_objects_storage_writes``, ``worker_durable_objects_storage_reads``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.25.0/docs/resources/notification_policy#product NotificationPolicy#product}
        :param project_id: Identifier of pages project. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.25.0/docs/resources/notification_policy#project_id NotificationPolicy#project_id}
        :param protocol: Protocol to alert on for dos. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.25.0/docs/resources/notification_policy#protocol NotificationPolicy#protocol}
        :param requests_per_second: Requests per second threshold for dos alert. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.25.0/docs/resources/notification_policy#requests_per_second NotificationPolicy#requests_per_second}
        :param selectors: Selectors for alert. Valid options depend on the alert type. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.25.0/docs/resources/notification_policy#selectors NotificationPolicy#selectors}
        :param services: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.25.0/docs/resources/notification_policy#services NotificationPolicy#services}.
        :param slo: A numerical limit. Example: ``99.9``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.25.0/docs/resources/notification_policy#slo NotificationPolicy#slo}
        :param status: Status to alert on. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.25.0/docs/resources/notification_policy#status NotificationPolicy#status}
        :param target_hostname: Target host to alert on for dos. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.25.0/docs/resources/notification_policy#target_hostname NotificationPolicy#target_hostname}
        :param target_zone_name: Target domain to alert on. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.25.0/docs/resources/notification_policy#target_zone_name NotificationPolicy#target_zone_name}
        :param tunnel_id: Tunnel IDs to alert on. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.25.0/docs/resources/notification_policy#tunnel_id NotificationPolicy#tunnel_id}
        :param where: Filter for alert. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.25.0/docs/resources/notification_policy#where NotificationPolicy#where}
        :param zones: A list of zone identifiers. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.25.0/docs/resources/notification_policy#zones NotificationPolicy#zones}
        '''
...
class NotificationPolicyEmailIntegration:
    def __init__(
        ...
        *,
        ...
        '''
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.25.0/docs/resources/notification_policy#id NotificationPolicy#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param name: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.25.0/docs/resources/notification_policy#name NotificationPolicy#name}.
        '''
        if __debug__:
