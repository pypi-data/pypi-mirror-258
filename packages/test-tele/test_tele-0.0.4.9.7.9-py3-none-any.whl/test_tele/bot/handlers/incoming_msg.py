...
from test_tele.bot.bot_header import loop_message #, hentaifox_to_telegraph
...
# async def in_message_for_doujin(app, message: Message):
#     """Handle hentaifox incoming message"""
#     pattern = r"Code : (\d+)"
#     match = re.search(pattern, message.text)
#     try:
#         if message.text:
#             if match:
#                 await hentaifox_to_telegraph(match.group(1))
#     except Exception as err:
#         logging.error(err, exc_info=True)
