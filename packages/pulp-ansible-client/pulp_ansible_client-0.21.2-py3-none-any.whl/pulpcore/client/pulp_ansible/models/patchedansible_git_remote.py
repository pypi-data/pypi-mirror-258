...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, username=None, name=None, download_concurrency=None, total_timeout=None, sock_connect_timeout=None, rate_limit=None, client_cert=None, sock_read_timeout=None, ca_cert=None, proxy_password=None, tls_validation=None, url=None, headers=None, max_retries=None, password=None, connect_timeout=None, pulp_labels=None, client_key=None, proxy_url=None, proxy_username=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
