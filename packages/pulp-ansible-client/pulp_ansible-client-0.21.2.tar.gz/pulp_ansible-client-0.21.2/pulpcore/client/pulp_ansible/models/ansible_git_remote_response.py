...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, name=None, download_concurrency=None, total_timeout=None, sock_connect_timeout=None, rate_limit=None, client_cert=None, pulp_href=None, sock_read_timeout=None, ca_cert=None, pulp_last_updated=None, tls_validation=None, url=None, headers=None, max_retries=None, pulp_created=None, connect_timeout=None, pulp_labels=None, hidden_fields=None, proxy_url=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
