...
class SeparatorWidget(QWidget):
    ...
    def __init__(self, orient: QtEnum.Qt.Orientation, parent=None):
        super().__init__(parent=parent)
        if orient == QtEnum.Qt.Horizontal:
            self.setFixedHeight(1)
        else:
            self.setFixedWidth(1)

        self.setAttribute(QtEnum.Qt.WA_StyledBackground)
...
class ItemMaskWidget(QWidget):
    ...
    def paintEvent(self, e):
        ...
        # draw text
        painter.setPen(QtEnum.Qt.black if isDarkTheme() else QtEnum.Qt.white)
    ...
    def _drawText(self, item: QListWidgetItem, painter: QPainter, y: int):
        ...
        if align & QtEnum.Qt.AlignLeft:
            rect = QRectF(15, y, w, h)      # padding-left: 11px
        elif align & QtEnum.Qt.AlignRight:
            rect = QRectF(4, y, w-15, h)    # padding-right: 11px
        elif align & QtEnum.Qt.AlignCenter:
            rect = QRectF(4, y, w, h)
...
class PickerColumnButton(QPushButton):
    ...
    def __init__(self, name: str, items: Iterable, width: int, align=Qt.AlignLeft, formatter=None, parent=None):
        ...
        self.setAttribute(QtEnum.Qt.WA_TransparentForMouseEvents)

    def align(self):
        return self._align

    def setAlignment(self, align=QtEnum.Qt.AlignCenter):
...
class PickerBase(QPushButton):
    ...
    def addColumn(self, name: str, items: Iterable, width: int, align=QtEnum.Qt.AlignCenter,
        ...
        self.hBoxLayout.addWidget(button, 0, QtEnum.Qt.AlignLeft)
    ...
    @checkColumnIndex
    def setColumnAlignment(self, index: int, align=QtEnum.Qt.AlignCenter):
    ...
    @checkColumnIndex
    def setColumn(self, index: int, name: str, items: Iterable, width: int, align=QtEnum.Qt.AlignCenter):
        """ set column
...
class PickerPanel(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.hSeparatorWidget = SeparatorWidget(QtEnum.Qt.Horizontal, self.view)
    ...
    def __initWidget(self):
        self.setWindowFlags(QtEnum.Qt.Popup | QtEnum.Qt.FramelessWindowHint |
                            QtEnum.Qt.NoDropShadowWindowHint)
        self.setAttribute(QtEnum.Qt.WA_TranslucentBackground)
        ...
        self.hBoxLayout.addWidget(self.view, 1, QtEnum.Qt.AlignCenter)
    ...
    def addColumn(self, items: Iterable, width: int, align=QtEnum.Qt.AlignCenter):
        ...
        """
        if self.listWidgets:
            self.listLayout.addWidget(SeparatorWidget(QtEnum.Qt.Vertical))
