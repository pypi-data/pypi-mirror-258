...
def test_loki_log_provider():
    ...
    with patch.object(
        requests, requests.Session.__name__, return_value=mocked_session,
    ):
        with LokiLogProvider(
            ...
            logs = loki_log_provider.query(start_timestamp_ns=123, end_timestamp_ns=456)
            expected_logs = [
                (1, "log1"),
                (3, "log3"),
                (4, "log4"),
        ...
        mocked_session.headers.update.assert_called_once_with(expected_headers)
