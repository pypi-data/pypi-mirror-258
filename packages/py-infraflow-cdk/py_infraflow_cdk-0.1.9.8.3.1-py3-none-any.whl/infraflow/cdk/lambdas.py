...
class LambdaContext:
    ...
    def function(
        ...
        func = aws_lambda.Function(
                ...
                vpc_subnets=SubnetSelection(subnets=[Subnet.from_subnet_id(scope=self.stage.scope, id='QA us-west-2a', subnet_id='subnet-c20362bb')]),
                #SubnetSelection(subnets=self.stage.env.service_subnets(self.subnet_type)),
