...
import dataclasses
from .checkconfiginternal import CheckConfigInternal
...
class CheckResult:
    ...
    config: Optional[CheckConfigInternal] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('config'), 'exclude': lambda f: f is CheckResult.UNSET }})
