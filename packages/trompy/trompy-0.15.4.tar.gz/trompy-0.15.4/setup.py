...
setup(
  ...
  version = '0.15.4',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/mccutcheonlab/trompy/archive/v0.15.4-beta.tar.gz',    # I explain this later on
