...
def main():
    ...
    if os.path.isfile(args_file):
        ...
        stored_args = {'Input_location': cDir,
                       ...
                       'Output_method':"1.[Default] Save in new Subfolders",
    ...
    group1.add_argument('Input_location', help="location of images to process", widget='DirChooser', #                        default= stored_args.get('Input_location'),
    ...
    group1.add_argument('Output_method', help="select how processed images are saved", widget='Dropdown'
                        ...
                        ,choices=["1.[Default] Save in new Subfolders","2. Save in new Parent Folder","3. Save in Same Folder"])
