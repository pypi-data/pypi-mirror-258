...
class CloudCommandsLoader(AzCommandsLoader):
    ...
    def load_arguments(self, command):
        ...
        with self.argument_context('cloud') as c:
            ...
            c.argument('endpoint_client_id', options_list=('--client-id'), help='The management client id')
            c.argument('endpoint_management_client_id', options_list=('--management-client-id'), help='The management api client id')
            c.argument('endpoint_instance_id', options_list=('--instance-id'), help='The FLLM instance id')
