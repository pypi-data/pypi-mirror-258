...
helps['version'] = """
type: command
short-summary: Show the versions of FLLM CLI modules and extensions in JSON format by default or format configured by --output
"""

helps['upgrade'] = """
type: command
short-summary: Upgrade FLLM CLI and extensions
"""

helps['demo'] = """
type: group
short-summary: Demos for designing, developing and demonstrating FLLM CLI.
"""
