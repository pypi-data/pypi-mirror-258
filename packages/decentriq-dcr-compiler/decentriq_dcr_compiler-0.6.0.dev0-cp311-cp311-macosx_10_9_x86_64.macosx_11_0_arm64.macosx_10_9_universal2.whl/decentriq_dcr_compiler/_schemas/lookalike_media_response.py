...
class LookalikeMediaDcrCompute10(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
...
class LookalikeMediaDcrCompute11(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
...
class LookalikeMediaDcrCompute8(
    RootModel[
        Union[
            LookalikeMediaDcrCompute,
            LookalikeMediaDcrCompute10,
            LookalikeMediaDcrCompute11,
        ]
    ]
):
    root: Union[
        LookalikeMediaDcrCompute, LookalikeMediaDcrCompute10, LookalikeMediaDcrCompute11
    ]


class LookalikeMediaDcrComputeOrUnknown(RootModel[Optional[LookalikeMediaDcrCompute8]]):
    root: Optional[LookalikeMediaDcrCompute8]
