...
class TestCruiseServiceCrud(unittest.TestCase):
    ...
    def test_dataset_service(self):
        ...
        self.assertEqual(saved.archive_date, datetime.datetime.isoformat(archive_date))
        ...
        self.assertEqual(found.archive_date, datetime.datetime.isoformat(archive_date))
    ...
    def test_file_service(self):
        ...
        self.assertEqual(datetime.datetime.isoformat(model.collection_date), saved.collection_date)
        self.assertEqual(datetime.datetime.isoformat(model.publish_date), saved.publish_date)
        self.assertEqual(datetime.datetime.isoformat(model.archive_date), saved.archive_date)
        ...
        self.assertEqual(datetime.datetime.isoformat(model.collection_date), found.collection_date)
        self.assertEqual(datetime.datetime.isoformat(model.publish_date), found.publish_date)
        self.assertEqual(datetime.datetime.isoformat(model.archive_date), found.archive_date)
