...
setup(
    ...
    version="0.0.01",
    python_requires=">=3.8",
    description="FreeGenius AI, inspired by LetMeDoIt AI, offers a comprehensive suite of free, core AI features for FREE. No paid API key required.",
