...
** [[elisp:(org-cycle)][| *DocStr | ] Examples of Service Access Instance Commands.
    ...
    if sectionTitle == "default":
        cs.examples.menuChapter('*MARMEE Qmail Config Utilities*')
    ...
    icmWrapper = "" ;  cmndName = "fullAction_NOTYET"
...
####+BEGIN: b:py3:cs:cmnd/classHead :cmndName "marmeeMaildirCreateMoved" :comment "" :extent "verify" :parsMand "bpoId envRelPath" :argsMin 1 :argsMax 9999 :pyInv ""
""" #+begin_org
*  _[[elisp:(blee:menu-sel:outline:popupMenu)][±]]_ _[[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]]_ [[elisp:(outline-show-branches+toggle)][|=]] [[elisp:(bx:orgm:indirectBufOther)][|>]] *[[elisp:(blee:ppmm:org-mode-toggle)][|N]]*  CmndSvc-   [[elisp:(outline-show-subtree+toggle)][||]] <<marmeeMaildirCreateMoved>>  =verify= parsMand=bpoId envRelPath argsMin=1 argsMax=9999 ro=cli   [[elisp:(org-cycle)][| ]]
#+end_org """
class marmeeMaildirCreateMoved(cs.Cmnd):
