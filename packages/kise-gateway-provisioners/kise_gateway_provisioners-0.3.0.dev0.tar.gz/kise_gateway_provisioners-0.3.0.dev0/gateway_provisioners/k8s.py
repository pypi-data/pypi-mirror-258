...
try:
    from jinja2 import \
        Environment  # noqa - used by launcher so check presence here
...
class KubernetesProvisioner(ContainerProvisionerBase):
    ...
    def get_container_status(self, iteration: Optional[str]) -> str:
        ...
        # ret: https://github.com/kubernetes-client/python/blob/master/kubernetes/docs/V1PodList.md
