...
class ActualizeApi:
    ...
    def run_actualize_refining(
        ...
        _param = self._run_actualize_refining_serialize(
            actualize_task=actualize_task,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def run_actualize_refining_with_http_info(
        self,
        actualize_task: Annotated[ActualizeTask, Field(description="Data for refine.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def run_actualize_refining_without_preload_content(
        self,
        actualize_task: Annotated[ActualizeTask, Field(description="Data for refine.")],
        _request_timeout: Union[
            None,
    ...
    def _run_actualize_refining_serialize(
        self,
        actualize_task,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/universal/actualize/refining',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
