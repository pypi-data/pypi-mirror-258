...
class PlanApi:
    ...
    def _cancel_plan_calculation_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/universal/plan/calculation_async/{id}',
    ...
    def _delete_plan_result_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/universal/plan/result/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def read_plan_calculation_state(
        ...
        _param = self._read_plan_calculation_state_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def read_plan_calculation_state_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Calculation identifier.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def read_plan_calculation_state_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Calculation identifier.")],
        _request_timeout: Union[
            None,
    ...
    def _read_plan_calculation_state_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def _run_plan_calculation_async_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/universal/plan/calculation_async',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
