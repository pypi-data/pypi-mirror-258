...
class ReplanApi:
    ...
    def cancel_replan_calculation_async(
        self,
        id: Annotated[StrictStr, Field(description="Calculation identifier.")],
        ...
        _param = self._cancel_replan_calculation_async_serialize(
            id=id,
    ...
    @validate_call
    def cancel_replan_calculation_async_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Calculation identifier.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def cancel_replan_calculation_async_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Calculation identifier.")],
        _request_timeout: Union[
            None,
    ...
    def _cancel_replan_calculation_async_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/universal/replan/calculation_async/{id}',
    ...
    def _delete_replan_result_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/universal/replan/result/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def read_replan_calculation_state(
        ...
        _param = self._read_replan_calculation_state_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def read_replan_calculation_state_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Calculation identifier.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def read_replan_calculation_state_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Calculation identifier.")],
        _request_timeout: Union[
            None,
    ...
    def _read_replan_calculation_state_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def _run_replan_calculation_async_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/universal/replan/calculation_async',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def run_replan_refining(
        ...
        _param = self._run_replan_refining_serialize(
            replan_task=replan_task,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def run_replan_refining_with_http_info(
        self,
        replan_task: Annotated[ReplanTask, Field(description="Data for refine.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def run_replan_refining_without_preload_content(
        self,
        replan_task: Annotated[ReplanTask, Field(description="Data for refine.")],
        _request_timeout: Union[
            None,
    ...
    def _run_replan_refining_serialize(
        self,
        replan_task,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/universal/replan/refining',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
