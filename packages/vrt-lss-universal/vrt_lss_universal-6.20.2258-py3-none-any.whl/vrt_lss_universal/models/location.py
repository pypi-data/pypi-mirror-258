...
class Location(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["key", "geopoint", "arrival_duration", "departure_duration", "work_windows", "compatibilities", "attributes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "work_windows": [TimeWindow.from_dict(_item) for _item in obj["work_windows"]] if obj.get("work_windows") is not None else None,
