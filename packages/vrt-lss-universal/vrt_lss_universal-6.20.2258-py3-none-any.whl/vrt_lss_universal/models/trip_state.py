...
class TripState(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["time", "order_key", "demand_key", "event_key", "location_key", "flags", "cargo_placements", "attributes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "flags": obj.get("flags"),
            "cargo_placements": [CargoPlacement.from_dict(_item) for _item in obj["cargo_placements"]] if obj.get("cargo_placements") is not None else None,
