...
class node:
    ...
    def new_client(self, topic):
        ...
        s, port, ip  = nep.masterRegister(self.node_name, topic, master_ip = '0.0.0.0', master_port = 7000, socket = "client", pid = self.pid, data_type="json")
    ...
    def new_server(self, topic):
        ...
        s, port, ip  = nep.masterRegister(self.node_name, topic, master_ip = '0.0.0.0', master_port = 7000, socket = "server", pid = self.pid, data_type="json")
        if s:
