...
class SpaceXSelenium(SpaceXFile):
    ...
    def GetDriverFromBlaywright(self,headless_disply,Use_Proxy):
        ...
        browser = playwright.chromium.launch(headless=headless_disply,proxy=proxy)
        useragent = ua_generator.generate(device='mobile').text
        self.driver = browser.new_page(viewport={"width":600,"height":800},locale='en-US',user_agent=useragent)
        return self.driver