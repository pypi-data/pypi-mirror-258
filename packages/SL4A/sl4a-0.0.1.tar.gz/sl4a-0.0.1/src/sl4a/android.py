import os,json
if os.path.exists("/sdcard/sl4a/server.json"):
  with open("/sdcard/sl4a/server.json") as f:
    d=json.load(f)
  for k in ["AP_HOST","AP_PORT","AP_HANDSHAKE"]:
    os.environ[k]=d[k]
import sl4a.rpc as rpc

class Android(rpc.Android):
