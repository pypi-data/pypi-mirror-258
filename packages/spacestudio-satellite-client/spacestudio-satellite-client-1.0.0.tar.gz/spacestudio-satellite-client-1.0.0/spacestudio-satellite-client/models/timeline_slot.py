...
class TimelineSlot(BaseModel):
    ...
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[ManeuverTimelineSlot, OrbitTimelineSlot]]:
        ...
        if object_type ==  'MANEUVER':
            return import_module("spacestudio-satellite-client.models.maneuver_timeline_slot").ManeuverTimelineSlot.from_dict(obj)
        if object_type ==  'ORBIT':
            return import_module("spacestudio-satellite-client.models.orbit_timeline_slot").OrbitTimelineSlot.from_dict(obj)
