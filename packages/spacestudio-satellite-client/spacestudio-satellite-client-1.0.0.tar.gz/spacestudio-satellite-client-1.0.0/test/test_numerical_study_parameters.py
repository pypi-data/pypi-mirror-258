    ...
    def make_instance(self, include_optional) -> NumericalStudyParameters:
        ...
        if include_optional:
            return NumericalStudyParameters(
                numerical_outputs_configuration = spacestudio-satellite-client.models.numerical_outputs_configuration.NumericalOutputsConfiguration(
                ...
                maneuvering_strategy = spacestudio-satellite-client.models.maneuvering_strategy.ManeuveringStrategy(
                ...
                simulation_configuration = spacestudio-satellite-client.models.simulation_configuration.SimulationConfiguration(
