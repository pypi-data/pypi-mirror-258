    ...
    def make_instance(self, include_optional) -> Scenario:
        ...
        if include_optional:
            return Scenario(
                ...
                baseline = spacestudio-satellite-client.models.scenario_baseline.scenarioBaseline(
                    valid = True, 
                    ...
                    payload = spacestudio-satellite-client.models.payload.payload(
                        id = '', 
                        name = '', 
                        scope = '', ), 
                    spacecraft_geometry = spacestudio-satellite-client.models.spacecraft_geometry.spacecraft-geometry(
                        ...
                        type = 'SPHERE', ), 
                    timeline = [
                        spacestudio-satellite-client.models.timeline_slot.TimelineSlot(
                            id = '', 
                            validity = 'VALID', )
                        ], 
