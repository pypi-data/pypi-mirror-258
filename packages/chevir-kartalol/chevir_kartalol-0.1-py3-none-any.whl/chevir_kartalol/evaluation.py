...
class Dilmanc:
    def __init__(self):
        ...
        # Load vocabularies
        self.SRC.vocab = torch.load(params['eval']['src_voc'])
        self.TARGET.vocab = torch.load(params['eval']['tar_vocab'])
        ...
        # Load model weights
        self.model.load_state_dict(torch.load(params['eval']['model'], map_location=device))
