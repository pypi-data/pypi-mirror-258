...
class HelperTests(unittest.TestCase):
    ...
    def test_trade_item_master_data_urn(self):
        ...
        assert result == 'urn:epc:idpat:sgtin:0355555.234561.*'
        result = make_trade_item_master_data_urn('0355555', '23456',
                                                 '1', serial_number='100023')
        assert result == 'urn:epc:id:sgtin:0355555.234561.100023'
        result = make_trade_item_master_data_urn('0355555', '23456',
                                                 '1', lot='LOT23')
        assert result ==  'urn:epc:class:lgtin:0355555.234561.LOT23'
