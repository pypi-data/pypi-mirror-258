...
class ListMixin:
    ...
    def get_business_transaction_list(self, o):
        ...
        if o.business_transaction_list:
            ret = {
                str(bt.biz_transaction): str(bt.type)
                for bt in o.business_transaction_list
            }
        else:
            ret = {}
        return ret
...
class EPCISEventEncoder(
    ...
    def default(self, o: events.EPCISEvent):
        ...
        ret = {
            ...
            "errorDeclaration": self.get_error_declaration(o.error_declaration),
        }
        return ret
        ...
        ret.update(
            {
                ...
                "childQuantityList": self.get_quantity_list(o.child_quantity_list),
            }
        )
        ...
        ret.update(
            {
                ...
                "inputQuantityList": self.get_quantity_list(o.input_quantity_list),
                "outputEPCList": [epc for epc in o.output_epc_list],
                "outputQuantityList": self.get_quantity_list(o.output_quantity_list),
...
class PartnerIdentificationEncoder(JSONEncoder):
    ...
    def default(self, o: sbdh.PartnerIdentification):
        if o:
            ret = {"authority": o.authority, "value": o.value}
        else:
            ret = {}
        return ret
...
class DocumentIdentificationEncoder(JSONEncoder, DateHelperMixin):
    def default(self, o: sbdh.DocumentIdentification):
        ...
        ret = {
            ...
            "mutlipleType": str(o.multiple_type).lower() if o.multiple_type else None,
...
class EPCISDocumentEncoder(JSONEncoder, DateHelperMixin):
    def default(self, o: events.EPCISDocument):
        ...
        ret["events"] = (
            self.list_events(o.object_events, obj)
