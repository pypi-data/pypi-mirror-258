...
example = "tabular_datapackage_hack_a_thon"


# from oemof.tabular.facades import *
#
# TYPEMAP.update({
#     "modex_com_lignite": Commodity,
#     "modex_tech_chp_steam": BackpressureTurbine,
#     "modex_tech_generator_steam":
#
# })
...
datapackage_dir = os.path.join(
    ...
    "examples/test_datapackages/{}".format(example),
