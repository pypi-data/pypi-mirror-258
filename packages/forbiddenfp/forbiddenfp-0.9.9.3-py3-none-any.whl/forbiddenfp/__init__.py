...
@chainable
def weeks(self: int) -> datetime.timedelta:
    return datetime.timedelta(weeks=self)


@chainable
def days(self: int) -> datetime.timedelta:
    return datetime.timedelta(days=self)


@chainable
def hours(self: int) -> datetime.timedelta:
    return datetime.timedelta(hours=self)


@chainable
def minutes(self: int) -> datetime.timedelta:
    return datetime.timedelta(minutes=self)


@chainable
def seconds(self: int) -> datetime.timedelta:
    return datetime.timedelta(seconds=self)


@chainable
def milliseconds(self: int) -> datetime.timedelta:
    return datetime.timedelta(milliseconds=self)


@chainable
def microseconds(self: int) -> datetime.timedelta:
    return datetime.timedelta(microseconds=self)


@chainable
def strftime(self: Union[datetime.date, datetime.datetime], fmt: str) -> str:
    return self.strftime(fmt)


@chainable
def strptime(self: str, fmt: str) -> datetime.datetime:
