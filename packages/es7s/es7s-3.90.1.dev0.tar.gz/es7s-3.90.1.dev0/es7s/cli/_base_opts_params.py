...
class HelpPart:
    """
    :param width_perc: in (0.00; 1.00] range
    """
...
class DayMonthType(DateTimeType):
    ...
    def get_format_section(cls):
        return [
            ...
            HelpPart(cls.format_supported_formats(), indent_shift=1, width_perc=0.7),
        ]
...
class MonthYearType(DateTimeType):
    ...
    def get_format_section(cls):
        return [
            ...
            HelpPart("Recognised formats list: "),
            HelpPart(cls.format_supported_formats(), indent_shift=1, width_perc=0.9),
        ]
