...
class BusConfigurationServiceStub(object):
    """Missing associated documentation comment in .proto file."""
    ...
    def __init__(self, channel):
        ...
        self.ConfigureBus = channel.unary_unary(
                '/com.jifeline.OpenOBD.Protocol.BusConfigurationService/ConfigureBus',
        ...
        self.ConfigureBuses = channel.stream_unary(
                '/com.jifeline.OpenOBD.Protocol.BusConfigurationService/ConfigureBuses',
                request_serializer=BusConfiguration__pb2.BusConfiguration.SerializeToString,
                response_deserializer=Status__pb2.Status.FromString,
                )


class BusConfigurationServiceServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_BusConfigurationServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'com.jifeline.OpenOBD.Protocol.BusConfigurationService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))


 # This class is part of an EXPERIMENTAL API.
class BusConfigurationService(object):
    """Missing associated documentation comment in .proto file."""
    ...
    def ConfigureBus(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/com.jifeline.OpenOBD.Protocol.BusConfigurationService/ConfigureBus',
    ...
    def ConfigureBuses(request_iterator,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_unary(request_iterator, target, '/com.jifeline.OpenOBD.Protocol.BusConfigurationService/ConfigureBuses',
            BusConfiguration__pb2.BusConfiguration.SerializeToString,
            Status__pb2.Status.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
