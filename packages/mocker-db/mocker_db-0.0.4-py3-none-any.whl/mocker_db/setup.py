...
setup(
    name="mocker_db",
    packages=["mocker_db"],
    install_requires=['### mocker_db.py', 'attrs>=22.2.0', 'numpy', 'dill==0.3.7', 'sentence-transformers==2.2.2', 'hnswlib==0.8.0'],
    ...
    author="Kyrylo Mordan", author_email="parachute.repo@gmail.com", description="A mock handler for simulating a vector database.", version="0.0.4"
)
