...
class Qart(Qrcode, Img):
    ...
    def blend(self, qimg : np.ndarray, image_path : np.ndarray, version: int, error_correction: str, mode = "Normal"):
        ...
        self.Binaryimage = Img.imagemoudlebase((version * 4 + 17), image=image_path)
