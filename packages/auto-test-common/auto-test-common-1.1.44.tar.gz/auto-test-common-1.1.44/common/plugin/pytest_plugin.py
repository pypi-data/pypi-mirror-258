...
class PytestPlugin(object):
    ...
    def runSceneCase(self, _caseNameList):
        ...
        logger.info('去重前脚本数:'+_caseNameList.__len__())
        _caseNameList = DataProcess.list_dict_duplicate_removal_byKey(_caseNameList, 'script')
        logger.info('去重后脚本数:' + _caseNameList.__len__())
