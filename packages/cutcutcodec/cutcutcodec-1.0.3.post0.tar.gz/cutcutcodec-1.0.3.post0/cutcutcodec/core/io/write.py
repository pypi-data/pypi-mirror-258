...
def frame_audio_to_av(frame_audio: FrameAudio) -> av.audio.frame.AudioFrame:
    ...
    <av.AudioFrame 0, pts=480000, 1024 samples at 48000Hz, 5.1, flt at ...>
    >>>
    """
...
def frame_video_to_av(frame_video: FrameVideo) -> av.video.frame.VideoFrame:
    ...
    >>>
    >>> frame_video_to_av(FrameVideo(10, torch.empty(480, 720, 3)))  # doctest: +ELLIPSIS
    <av.VideoFrame #0, pts=3003000 bgr24 720x480 at ...>
    >>> frame_video_to_av(FrameVideo(10, torch.empty(480, 720, 1)))  # doctest: +ELLIPSIS
    <av.VideoFrame #0, pts=3003000 bgr24 720x480 at ...>
    >>> frame_video_to_av(FrameVideo(10, torch.empty(480, 720, 4)))  # doctest: +ELLIPSIS
    <av.VideoFrame #0, pts=3003000 bgr24 720x480 at ...>
    >>>
    """
