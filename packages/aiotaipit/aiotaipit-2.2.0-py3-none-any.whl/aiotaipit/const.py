...
METER_MODELS: dict[int, Tuple[str, str]] = {
    ...
    5: ('Меркурий', '233, 234, 236'),
    6: ('НЗиФ', 'ПСЧ-4TM'),
    7: ('НЗиФ', 'СЭТ-4TM'),
    8: ('БЕТАР', 'ЭСО-211'),
    9: ('НЕВА', 'МТ 123'),
    10: ('НЕВА', 'МТ 114, МТ 124'),
    11: ('НЕВА', 'МТ 313, МТ 323, МТ 324'),
    12: ('Меркурий', '206, 203.2Т'),
    13: ('Берегун', '3-1 (красный)'),
    14: ('Берегун', '1-2 (белый)'),
    15: ('НЕВА', 'МТ 315 (GSM)'),
    16: ('НЕВА', 'МТ 114 (Wi-Fi)'),
    17: ('Универсальный', 'Импульсный'),
    18: ('Гермес', 'Импульсный'),
    19: ('Schneider', 'iEM3155'),
    20: ('НЗиФ', 'СЭТ/ПСЧ старый'),
    21: ('НЕВА', 'МТ 124 (Wi-Fi)'),
    22: ('НЕВА', 'МТ 115 (GSM)'),
    23: ('Энергомера', 'СЕ102 R5.1 (протокол СЕ)'),
    24: ('Милур', '0300-0399'),
}
