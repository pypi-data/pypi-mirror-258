...
ApiToMySQLParameters = SharedConfig(
    shared_config_type_uuid="APIRS-SQLDB",
    alias="API Response to MySQL Load Options",
    description="Information needed when loading data from an API response into a MySQL table.",
    categories=["MySQL", "API"],
    parameter_groups=[
        ParameterGroup(
            Parameter(
                name="fields_mapping_autodetect",
