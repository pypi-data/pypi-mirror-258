...
class DataApi:
    ...
    def read_data(
        ...
        data_flow_stage: Annotated[Optional[Annotated[int, Field(le=3, strict=True, ge=0)]], Field(description="Data flow stage.")] = None,
        data_flow_convert: Annotated[Optional[FlowConvert], Field(description="Data result convert.")] = None,
    ...
    def _read_data_serialize(
        ...
        if data_flow_convert is not None:
            
            _query_params.append(('data_flow_convert', data_flow_convert.value))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/account/data/{tracecode}',
