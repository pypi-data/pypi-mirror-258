...
class AuditApi:
    ...
    def read_audit(
        ...
        service_name: Annotated[Optional[ServiceName], Field(description="Service name.")] = None,
        operation_id: Annotated[Optional[Annotated[str, Field(min_length=3, strict=True, max_length=256)]], Field(description="Operation identifier.")] = None,
        method_group: Annotated[Optional[MethodGroup], Field(description="Method group name.")] = None,
    ...
    def _read_audit_serialize(
        ...
        if service_name is not None:
            ...
            _query_params.append(('service_name', service_name.value))
        ...
        if method_group is not None:
            ...
            _query_params.append(('method_group', method_group.value))
