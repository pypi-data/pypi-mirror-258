...
class AuditStats(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "overall": AuditStatsDetail.from_dict(obj["overall"]) if obj.get("overall") is not None else None,
            "filter": AuditStatsDetail.from_dict(obj["filter"]) if obj.get("filter") is not None else None
        })
        return _obj
