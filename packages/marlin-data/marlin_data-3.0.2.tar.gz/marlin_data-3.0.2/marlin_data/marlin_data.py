...
class MarlinDerivedData(object):
    ...
    def build_derived_labelled_data(self, signature_data : SignatureData = None):
        ...
        self.labelled_data[signature_data.meta_data['snapshot_id']] = time_bounds
    ...
    def query_label(self, time_start: dt, time_end : dt):
        """
...
if __name__ == "__main__":
    ...
    marlin_data.download_signature_snapshots()
    marlin_data.build_derived_data(n_fft=2048)
    data_feed = MarlinDataStreamer()
    ...
    marlin_data.download_simulation_snapshots(load_args = {'location' : ['clyde_surfer_1'], 'limit':1})
