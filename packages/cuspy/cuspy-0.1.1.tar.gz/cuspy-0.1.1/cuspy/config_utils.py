...
class ConfigUtils:
    ...
    @classmethod
    def _set_path(cls, config_json: Dict, mkdir_auto: bool) -> Dict:
    ...
    @classmethod
    def _set_path_iter(cls, config_json: Dict, mkdir_auto: str) -> Dict:
        for key, value in config_json.items():
            if key.endswith('_config'):
                config_json[key] = cls._set_path(value, mkdir_auto)
        return config_json
    ...
    @classmethod
    def load_config(cls, confi_fp: str, mkdir_auto: bool = True):
        ...
        config_json = cls._set_path(config_json, mkdir_auto)
        config_json = cls._set_path_iter(config_json, mkdir_auto)
