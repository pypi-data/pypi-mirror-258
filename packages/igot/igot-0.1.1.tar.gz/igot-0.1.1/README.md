...
**Declare**: igot forked from [you-get](https://github.com/soimort/you-get). Just fix some bug and change application name, so more detail you can refer [you-get site](https://you-get.org/)

---

**NOTICE (30 May 2022): Support for Python 3.5, 3.6 and 3.7 will eventually be dropped. ([see details here](https://github.com/iniself/igot/wiki/TLS-1.3-post-handshake-authentication-(PHA)))**

**NOTICE (8 Mar 2019): Read [this](https://github.com/iniself/igot/blob/develop/CONTRIBUTING.md) if you are looking for the conventional "Issues" tab.**

---

[igot](https://igot.org/) is a tiny command-line utility to download media contents (videos, audios, images) from the Web, in case there is no other handy way to do it.

Here's how you use `igot` to download a video from [YouTube](https://www.youtube.com/watch?v=jNQXAC9IVRw):
...
Are you a Python programmer? Then check out [the source](https://github.com/iniself/igot) and fork it!
...
The official release of `igot` is distributed on [PyPI](https://pypi.python.org/pypi/igot), and can be installed easily from a PyPI mirror via the [pip](https://en.wikipedia.org/wiki/Pip_\(package_manager\)) package manager. Note that you must use the Python 3 version of `pip`:
...
You may either download the [stable](https://github.com/iniself/igot/archive/master.zip) (identical with the latest release on PyPI) or the [develop](https://github.com/iniself/igot/archive/develop.zip) (more hotfixes, unstable features) branch of `igot`. Unzip it, and put the directory containing the `igot` script into your `PATH`.
...
You can also use the [pipenv](https://pipenv.pypa.io/en/latest) to install the `igot` in the Python virtual environment.
...
Completion definitions for Bash, Fish and Zsh can be found in [`contrib/completion`](https://github.com/iniself/igot/tree/develop/contrib/completion). Please consult your shell's manual for how to take advantage of them.
...
```
$ igot http://kopasas.tumblr.com/post/69361932517
Site:       Tumblr.com
Title:      kopasas
...
* If you need to use proxies a lot (in case your network is blocking certain sites), you might want to use `igot` with [proxychains](https://github.com/rofl0r/proxychains-ng) and set `alias igot="proxychains -q igot"` (in Bash).
...
If something is broken and `igot` can't get you things you want, don't panic. (Yes, this happens all the time!)

Check if it's already a known problem on <https://github.com/iniself/igot/wiki/Known-Bugs>. If not, follow the guidelines on [how to report an issue](https://github.com/iniself/igot/blob/develop/CONTRIBUTING.md).

## Getting Involved

You can reach us on the Gitter channel [#iniself/igot](https://gitter.im/iniself/igot) (here's how you [set up your IRC client](http://irc.gitter.im) for Gitter). If you have a quick question regarding `igot`, ask it there.

If you are seeking to report an issue or contribute, please make sure to read [the guidelines](https://github.com/iniself/igot/blob/develop/CONTRIBUTING.md) first.

## Legal Issues

This software is distributed under the [MIT license](https://raw.github.com/iniself/igot/master/LICENSE.txt).
...
Made by [@iniself](https://github.com/iniself), who is in turn powered by :coffee:, :beer: and :ramen:.

You can find the [list of all contributors](https://github.com/iniself/igot/graphs/contributors) here.
