...
class Workbench:
	...
	def get_workflow_descriptor(self, workflow_version:WorkflowVersion) -> WorkflowDescriptor:
		return self._get_workflow_client().get_json_schema(workflow_version.workflowId, workflow_version.id)
