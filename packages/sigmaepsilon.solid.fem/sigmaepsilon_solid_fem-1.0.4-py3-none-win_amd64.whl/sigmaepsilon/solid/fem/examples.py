...
from sigmaepsilon.mesh.utils.space import index_of_closest_point, frames_of_lines

from sigmaepsilon.solid.material import BernoulliFrameSection
from sigmaepsilon.solid.fem import Structure, LineMesh, PointData
...
def console_grid_bernoulli() -> Structure:
    ...
    Example
    -------
    >>> from sigmaepsilon.solid.fem.examples import console_grid_bernoulli
    >>> structure = console_grid_bernoulli()
    >>> structure.linear_elastic_solution()
    """
    # units in kN and cm
    ...
    section = BernoulliFrameSection("CHS", d=d, t=t, n=16)
