...
from sigmaepsilon.math.logical import isintegerarray, isfloatarray, isboolarray
from sigmaepsilon.math import bool_to_float, atleastnd, matrixform
from sigmaepsilon.math.linalg.sparse.utils import lower_spdata, upper_spdata
...
def estimate_stiffness_penalty(K: Union[ndarray, spmatrix], N: int) -> float:
    """
    Returns a suggested value for the stiffness penalty, to account
