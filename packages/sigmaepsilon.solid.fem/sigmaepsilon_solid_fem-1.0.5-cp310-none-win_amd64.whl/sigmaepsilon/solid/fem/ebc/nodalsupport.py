...
from sigmaepsilon.math import atleast1d, atleast2d, repeat_diagonal_2d
...
class NodalSupport(FemEssentialBoundaryCondition):
    """
    ...
    **kwargs: dict, Optional
    ...
    def __init__(
        ...
        *,
        ...
        i: Optional[Union[int, Iterable[int]]] = None,
        frame: Optional[Union[ndarray, ReferenceFrame, None]] = None,
