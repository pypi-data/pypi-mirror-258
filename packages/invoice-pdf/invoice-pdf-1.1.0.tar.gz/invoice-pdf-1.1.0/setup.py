...
setup(
  name = 'invoice-pdf',         #* Your package will have this name
  packages = ['invoice-pdf'],   #* Name the package again
  version = '1.1.0',         #* To be increased every time your change your
  # library
  ...
  author = 'Lazar Voštić',                   # Your name
  author_email = 'vostic.l24@gmail.com',  # Your email
  ...
  install_requires=['pandas', 'fpdf', 'openpyxl'],                 # Other
  # 3rd-party libs that pip needs to install
  classifiers=[
