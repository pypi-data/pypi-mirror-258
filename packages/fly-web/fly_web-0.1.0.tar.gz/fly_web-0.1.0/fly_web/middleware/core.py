...
from fly_web.constant import BuiltinSignal
from fly_web.utils import is_sync_generator_function, is_async_generator_function, run_func
from fly_web.middleware.exception import MiddlewareInitialCheckFailedError, MiddlewareAlreadyRegisteredError
...
class MiddlewareManager:
    ...
    def _add_builtin_middlewares(self):
        from fly_web.middleware.builtin import FlyCorsMiddleware
