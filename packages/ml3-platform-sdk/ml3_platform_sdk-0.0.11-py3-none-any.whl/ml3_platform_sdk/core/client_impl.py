...
class ML3PlatformClientImpl:
    ...
    def update_model_version_from_raw_data(
        ...
        if target_data_info is None:
            raise UpdateModelVersionException("Error in processing target")
        if inputs_data_info is None:
            raise UpdateModelVersionException("Error in processing task input")
    ...
    def add_model_reference(
        ...
        if inputs_data_info is None:
            raise AddModelReferenceException(
                "Error in processing taskinput data"
            )
        target_data_info = self._process_data(
            task_id=model.task_id,
            data=target,
        ...
        if target_data_info is None:
            raise AddModelReferenceException("Error in processing target data")
