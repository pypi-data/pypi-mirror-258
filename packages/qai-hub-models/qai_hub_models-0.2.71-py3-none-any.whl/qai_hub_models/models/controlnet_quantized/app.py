...
class ControlNetApp:
    ...
    * https://github.com/lllyasviel/ControlNet
    ...
    def _encode_text_prompt(self, prompt: str) -> torch.Tensor:
        ...
        print(f"Extracting embeddings (inference on TextEncoder)\n{'-' * 50}")
    ...
    def generate_image(
        ...
        for i, t in enumerate(self.scheduler.timesteps):
            ...
            # Denoise input
            print(
                f"Denoising image in latent space (inference on ControlNet)\n{'-' * 50}"
            )
            ...
            print(f"Denoising image in latent space (inference on UNet)\n{'-' * 50}")
        ...
        print(f"Decoding generated image (inference on VAEDecoder)\n{'-' * 50}")
