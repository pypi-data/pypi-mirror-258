...
code_list = {
    correct_code: "Correct Car Plate Format",
    error_code_1: "Country name is not found in the list",
    error_code_2: "Invalid Car Plate Format",
    error_code_3: "Car Plate length is not same as Car Plate length of the country",
