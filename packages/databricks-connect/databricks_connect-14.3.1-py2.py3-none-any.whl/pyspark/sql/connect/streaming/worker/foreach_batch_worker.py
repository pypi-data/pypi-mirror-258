...
from pyspark.sql.connect.session import SparkSession as RemoteSparkSession  # EDGE
...
def main(infile: IO, outfile: IO) -> None:
    ...
    if connect_url.lower().startswith("unix"):  # Used in process-isolation mode.
        credentials_header = {"x-databricks-local-credentials-key": credentials_key}
        spark_connect_session = RemoteSparkSession.builder.channelBuilder(
