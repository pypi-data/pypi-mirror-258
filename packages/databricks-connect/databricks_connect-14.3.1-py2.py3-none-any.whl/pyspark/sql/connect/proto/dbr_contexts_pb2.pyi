...
class SparkContextLocalProperties(google.protobuf.message.Message):
    """*
    Message to pass localProperties to be set on SparkContext for the scope of the query.
    """
...
global___SparkContextLocalProperties = SparkContextLocalProperties
