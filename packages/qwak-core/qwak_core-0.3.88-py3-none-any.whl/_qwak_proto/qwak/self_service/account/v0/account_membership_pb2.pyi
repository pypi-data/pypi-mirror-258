...
class JoiningInvitationSpec(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["account_role", b"account_role", "environment_ids", b"environment_ids", "environment_names", b"environment_names", "invitee_email", b"invitee_email"]) -> None: ...
