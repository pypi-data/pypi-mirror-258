...
def run_query_syntax(mode, input_file_path, output_file_path):
    ...
    if 'init' == mode:
        ...
        keywordsFilePointer = open(input_file_path, 'r', encoding='utf-8')
        resultFilePointer = open(output_file_path, 'w', encoding='utf-8')
