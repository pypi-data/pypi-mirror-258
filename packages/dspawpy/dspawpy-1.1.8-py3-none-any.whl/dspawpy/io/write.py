...
def write_VESTA(
    ...
    >>> write_VESTA("../../dspawpy_tests/2.2/rho.json", "rho", out_filename='../../dspawpy_tests/doctest_out/rho.cube') # doctest:+ELLIPSIS
    Reading .../dspawpy_tests/2.2/rho.json...
    ==> .../dspawpy_tests/doctest_out/rho.cube

    >>> from dspawpy.io.write import write_VESTA
    >>> write_VESTA(
    ...     in_filename="../../dspawpy_tests/2.7/potential.h5",
    ...     data_type="potential",
    ...     out_filename="../../dspawpy_tests/doctest_out/my_potential.txt",
    ...
    >>> with open("../../dspawpy_tests/doctest_out/my_potential.txt") as t:
...
def write_delta_rho_vesta(
    ...
    >>> write_delta_rho_vesta(total='../../dspawpy_tests/supplement/AB.h5',
    ...     individuals=['../../dspawpy_tests/supplement/A.h5', '../../dspawpy_tests/supplement/B.h5'],
    ...     output='../../dspawpy_tests/doctest_out/delta_rho.cube') # doctest:+ELLIPSIS
    Reading .../dspawpy_tests/supplement/AB.h5...
    Reading .../dspawpy_tests/supplement/A.h5...
    Reading .../dspawpy_tests/supplement/B.h5...
    ==> .../dspawpy_tests/doctest_out/delta_rho.cube
    """
...
def meshgrid2points(X, Y, Z) -> np.ndarray:
