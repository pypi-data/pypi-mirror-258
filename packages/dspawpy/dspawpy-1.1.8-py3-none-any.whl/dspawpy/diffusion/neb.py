...
def write_neb_structures(
    ...
    >>> init_struct = read("/data/home/hzw1002/dspawpy_repo/test/2.15/00/structure00.as")[0]
    >>> final_struct = read("/data/home/hzw1002/dspawpy_repo/test/2.15/04/structure04.as")[0]
