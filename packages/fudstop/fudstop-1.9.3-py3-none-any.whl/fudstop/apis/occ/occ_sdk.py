...
from .occ_models import OCCMostActive, StockInfo
...
class occSDK:
    def __init__(self, host, port, user, password, database):
        ...
        self.ticker_df = pd.read_csv('fudstop/apis/occ/occ_tickers.csv')
    ...
    async def get_ticker_id(self, symbol):
        ...
        row = self.ticker_df[self.ticker_df['symbol'] == symbol]
        if not row.empty:
