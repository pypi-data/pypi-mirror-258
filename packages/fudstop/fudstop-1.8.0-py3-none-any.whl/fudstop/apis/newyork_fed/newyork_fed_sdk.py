...
class FedNewyork:
    ...
    def all_agency_mortgage_backed_securities(self):
        ...
        """
        url = f"https://markets.newyorkfed.org/beta/api/ambs/all/results/details/search.json?startDate=2023-10-01&endDate={today_str}"
        print(url)
    ...
    def data_act_compliance(self):
        ...
        url=base_url+f"/v2/debt/tror/data_act_compliance?filter=record_date:gte:2023-07-01,record_date:lte:{today_str}&sort=-record_date,agency_nm,agency_bureau_indicator,bureau_nm"
        r = requests.get(url).json()
        data = r['data']
        df = pd.DataFrame(data)
    ...
    def central_bank_liquidity_swaps():
        ...
        url = f"https://markets.newyorkfed.org/api/fxs/usdollar/last/5.json"
