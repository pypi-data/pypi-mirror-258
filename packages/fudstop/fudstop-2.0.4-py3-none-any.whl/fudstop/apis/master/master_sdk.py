...
class MasterSDK:
    ...
    async def webull_short_interest(self, ticker, limit:int=50, insert:bool=False):
    ...
    async def webull_financials(self, ticker, type:str='balancesheet', limit:int=50, insert:bool=False):
    ...
    async def webull_etf_holdings(self, ticker, limit:int=50, insert:bool=False):
    ...
    async def webull_news(self, ticker, limit:int=5, insert:bool=False):
        ...
        return df.head(limit).to_dict('records')
    async def webull_capital_flow(self, ticker, limit:int=50, insert:bool=False):
