...
class DocumentClass(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, code, template_slug, entity_type, requester, description, s3_key, content_type, created_at, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, code, template_slug, entity_type, requester, description, s3_key, content_type, created_at, *args, **kwargs):  # noqa: E501
        """DocumentClass - a model defined in OpenAPI
