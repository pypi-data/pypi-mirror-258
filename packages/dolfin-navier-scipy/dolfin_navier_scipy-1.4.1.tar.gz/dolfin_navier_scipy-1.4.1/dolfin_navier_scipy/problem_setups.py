...
def get_sysmats(problem='gen_bccont', scheme=None, ppin=None,
    ...
    onlymesh : boolean, optional
        ...
        defaults to `False`
    return_fullmats " boolean, optional
        whether to (additionally) return the matrices `A`, `M`, `J`
        not being reduced to the inner nodes
    ...
    stokesmatsc : dict
        ...
        optional if `return_fullmats`
         * `Jfull`: the uncondensed divergence matrix
         * `Afull`: the uncondensed stiffness matrix
         * `Mfull`: the uncondensed mass matrix
