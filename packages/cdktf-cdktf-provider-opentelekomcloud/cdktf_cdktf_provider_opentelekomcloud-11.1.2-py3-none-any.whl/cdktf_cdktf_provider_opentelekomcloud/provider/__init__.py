...
class OpentelekomcloudProvider(
    ...
    def __init__(
        ...
        *,
        ...
        :param access_key: The access key for API operations. You can retrieve this from the 'My Credential' section of the console. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.2/docs#access_key OpentelekomcloudProvider#access_key}
        :param agency_domain_name: The name of domain who created the agency (Identity v3). Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.2/docs#agency_domain_name OpentelekomcloudProvider#agency_domain_name}
        :param agency_name: The name of agency. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.2/docs#agency_name OpentelekomcloudProvider#agency_name}
        :param alias: Alias name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.2/docs#alias OpentelekomcloudProvider#alias}
        :param allow_reauth: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.2/docs#allow_reauth OpentelekomcloudProvider#allow_reauth}.
        :param auth_url: The Identity authentication URL. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.2/docs#auth_url OpentelekomcloudProvider#auth_url}
        :param backoff_retry_timeout: Timeout in seconds for backoff retry. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.2/docs#backoff_retry_timeout OpentelekomcloudProvider#backoff_retry_timeout}
        :param cacert_file: A Custom CA certificate. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.2/docs#cacert_file OpentelekomcloudProvider#cacert_file}
        :param cert: A client certificate to authenticate with. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.2/docs#cert OpentelekomcloudProvider#cert}
        :param cloud: An entry in a ``clouds.yaml`` file to use. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.2/docs#cloud OpentelekomcloudProvider#cloud}
        :param delegated_project: The name of delegated project (Identity v3). Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.2/docs#delegated_project OpentelekomcloudProvider#delegated_project}
        :param domain_id: The ID of the Domain to scope to (Identity v3). Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.2/docs#domain_id OpentelekomcloudProvider#domain_id}
        :param domain_name: The name of the Domain to scope to (Identity v3). Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.2/docs#domain_name OpentelekomcloudProvider#domain_name}
        :param endpoint_type: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.2/docs#endpoint_type OpentelekomcloudProvider#endpoint_type}.
        :param insecure: Trust self-signed certificates. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.2/docs#insecure OpentelekomcloudProvider#insecure}
        :param key: A client private key to authenticate with. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.2/docs#key OpentelekomcloudProvider#key}
        :param max_backoff_retries: How many times HTTP request should be retried when rate limit reached. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.2/docs#max_backoff_retries OpentelekomcloudProvider#max_backoff_retries}
        :param max_retries: How many times HTTP connection should be retried until giving up. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.2/docs#max_retries OpentelekomcloudProvider#max_retries}
        :param passcode: One-time MFA passcode. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.2/docs#passcode OpentelekomcloudProvider#passcode}
        :param password: Password to login with. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.2/docs#password OpentelekomcloudProvider#password}
        :param region: The OpenTelekomCloud region to connect to. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.2/docs#region OpentelekomcloudProvider#region}
        :param secret_key: The secret key for API operations. You can retrieve this from the 'My Credential' section of the console. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.2/docs#secret_key OpentelekomcloudProvider#secret_key}
        :param security_token: Security token to use for OBS federated authentication. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.2/docs#security_token OpentelekomcloudProvider#security_token}
        :param swauth: Use Swift's authentication system instead of Keystone. Only used for interaction with Swift. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.2/docs#swauth OpentelekomcloudProvider#swauth}
        :param tenant_id: The ID of the Tenant (Identity v2) or Project (Identity v3) to login with. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.2/docs#tenant_id OpentelekomcloudProvider#tenant_id}
        :param tenant_name: The name of the Tenant (Identity v2) or Project (Identity v3) to login with. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.2/docs#tenant_name OpentelekomcloudProvider#tenant_name}
        :param token: Authentication token to use as an alternative to username/password. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.2/docs#token OpentelekomcloudProvider#token}
        :param user_id: User ID to login with. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.2/docs#user_id OpentelekomcloudProvider#user_id}
        :param user_name: Username to login with. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.2/docs#user_name OpentelekomcloudProvider#user_name}
        '''
        if __debug__:
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing OpentelekomcloudProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.2/docs#import import section} in the documentation of this resource for the id to use
