...
from .. import dsl
from ..metamodel import ActionType, Builtins, Type
import gravis as gv
...
class Graph:
    ...
    def visualize(self, three=False):
        ...
        fig = vis(graph1, show_edge_label=True, edge_label_data_source='label', node_label_data_source='label', edge_curvature=0.4)
        return fig
