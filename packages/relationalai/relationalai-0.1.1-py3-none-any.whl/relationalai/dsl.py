...
class Producer():
    ...
    def _make_sub(self, name:str, existing:Optional['Producer']=None):
...
class Type(Producer):
    ...
    def _make_sub(self, name: str, existing):
