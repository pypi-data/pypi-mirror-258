...
from icotest_voice.models.inline_object2 import InlineObject2  # noqa: E501
...
class TestInlineObject2(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = icotest_voice.models.inline_object2.InlineObject2()  # noqa: E501
        if include_optional :
            return InlineObject2(
                certificates_zip_file = bytes(b'blah')
            )
        else :
            return InlineObject2(
                certificates_zip_file = bytes(b'blah'),
