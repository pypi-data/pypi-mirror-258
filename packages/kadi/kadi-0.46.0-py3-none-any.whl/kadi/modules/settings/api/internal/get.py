...
@bp.get("/settings/personal-tokens", v=None)
@login_required
@internal
@paginated
def get_personal_tokens(page, per_page):
    """Get all personal tokens of the current user."""
...
@bp.get("/settings/applications/registered", v=None)
@login_required
@internal
@paginated
def get_registered_applications(page, per_page):
    """Get all registered OAuth2 applications of the current user."""
...
@bp.get("/settings/applications/authorized", v=None)
@login_required
@internal
@paginated
def get_authorized_applications(page, per_page):
    """Get all authorized OAuth2 applications of the current user."""
