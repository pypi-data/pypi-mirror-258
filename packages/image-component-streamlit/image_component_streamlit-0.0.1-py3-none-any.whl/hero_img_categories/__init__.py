...
def image_component_streamlit(data=None, styles=None, key=None, default=None):
   
    component_value = _image_component_streamlit(data=data, styles=styles, key=key, default=default)
