...
def get_cli_args():
    ...
    optional_arguments_group.add_argument(
        ...
        version=f"%(prog)s v{get_version(caller=__file__, version_file='LINODE-MGMT_VERSION')}",
    ...
    cluster_create_group.add_argument(
        ...
        '--region', metavar='<NAME>', default='us-east',
    ...
    cluster_create_group.add_argument(
        '--node-type', metavar='<NAME>', default='g6-dedicated-56',
        help="node type (default: g6-dedicated-56)"
    )
    ...
    for _arg in ['token', 'cluster', 'action', 'resource']:
