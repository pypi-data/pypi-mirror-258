...
class ClusterClusterWorkloadWithPrometheusMetric(object):
    ...
    def __init__(self, created_dt=None, experiment=None, id=None, kernel_cluster_node=None, kernel_resource_spec=None, metrics=None, model_service_revision=None, run_execution=None, status=None, status_last_updated=None, type=None, workspace=None, local_vars_configuration=None):  # noqa: E501
