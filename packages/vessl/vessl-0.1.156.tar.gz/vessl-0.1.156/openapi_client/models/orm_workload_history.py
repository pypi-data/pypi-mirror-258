...
class OrmWorkloadHistory(object):
    ...
    def __init__(self, created_dt=None, edges=None, end_dt=None, id=None, immutable_slug=None, is_running_time_extended=None, message=None, status=None, updated_dt=None, workload_history_workload=None, local_vars_configuration=None):  # noqa: E501
