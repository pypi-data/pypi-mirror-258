...
class OrmKernelCluster(object):
    ...
    def __init__(self, created_dt=None, default_storage_id=None, edges=None, id=None, immutable_slug=None, influx_bucket_name=None, is_credit_charged=None, is_custom_resource_spec_allowed=None, is_vessl_managed=None, kubernetes_container_runtime=None, kubernetes_service_type=None, metric_source=None, name=None, primary_owner_organization_id=None, provider=None, region_id=None, suspended=None, updated_dt=None, local_vars_configuration=None):  # noqa: E501
