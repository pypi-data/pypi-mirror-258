...
class BaseCC:
    ...
    def aplica_decks(self, anafas_dir, caso_base, list_decks):
        ...
        list_inp = []
        caso_base_novo = path_base + caso_base[caso_base.rfind("/"):]

        for index, deck in enumerate(path_alt):
            caso_alt = deck + list_decks[index][list_decks[index].rfind("/"):]
            if index == 0:
                list_inp.append("(==============================================================================")
