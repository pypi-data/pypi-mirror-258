...
class TransportTariff(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["cost_per_shift", "constraints", "transportation_cost", "max_penalty_cost"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "transportation_cost": Capacity.from_dict(obj["transportation_cost"]) if obj.get("transportation_cost") is not None else None,
