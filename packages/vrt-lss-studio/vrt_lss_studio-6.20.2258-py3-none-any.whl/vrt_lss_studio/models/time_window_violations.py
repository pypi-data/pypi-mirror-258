...
class TimeWindowViolations(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "before": ObjectMetrics.from_dict(obj["before"]) if obj.get("before") is not None else None,
            "after": ObjectMetrics.from_dict(obj["after"]) if obj.get("after") is not None else None
        })
        return _obj
