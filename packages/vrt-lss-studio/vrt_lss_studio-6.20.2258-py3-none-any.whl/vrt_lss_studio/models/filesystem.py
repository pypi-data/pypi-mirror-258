...
class Filesystem(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["key", "type", "name", "statistics", "elements"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type"),
            "name": obj.get("name"),
            "statistics": FolderStats.from_dict(obj["statistics"]) if obj.get("statistics") is not None else None,
