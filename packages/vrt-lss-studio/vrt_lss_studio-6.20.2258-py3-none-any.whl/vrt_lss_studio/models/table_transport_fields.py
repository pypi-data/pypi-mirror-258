...
class TableTransportFields(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["essence_key", "essence_type", "enabled", "pristine", "working_time", "availability_time", "transport_type", "trip_key", "trip_name", "location_keys", "trips_count", "attributes"]
    ...
    def essence_type_validate_enum(cls, value):
        ...
        if value not in set(['TRANSPORT', 'SHIFT']):
