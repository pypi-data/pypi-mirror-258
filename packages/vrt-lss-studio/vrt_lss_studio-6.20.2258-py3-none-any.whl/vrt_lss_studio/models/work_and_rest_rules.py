...
class WorkAndRestRules(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["first_break"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.first_break is None and "first_break" in self.model_fields_set:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "first_break": ModelBreak.from_dict(obj["first_break"]) if obj.get("first_break") is not None else None
        })
        return _obj
