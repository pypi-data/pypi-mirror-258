...
class ExperimentStatistics(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["indicators", "total_statistics", "data_statistics", "unplanned_items"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "total_statistics": Statistics.from_dict(obj["total_statistics"]) if obj.get("total_statistics") is not None else None,
