...
def init_parser():
    ...
    # parser.set_defaults(function='move_table', chrom="NR_103073.1", pos=2030, len=10, strand='+', cpu=8,norm=True,
    ...
    # parser.set_defaults(function='f5c_ev', chrom="17", pos=43281378, len=10, strand='+', cpu=8,base_shift=True,norm=True,
    ...
    # parser.set_defaults(function='f5c_re', chrom="NR_103073.1", pos=2030, len=10, strand='+', cpu=8,base_shift=True,norm=True,
    #                     input='/hdd_data/download/23s_rRNA_A2030/wt/file',
    #                     control='/hdd_data/download/23s_rRNA_A2030/ivt/file', output='f5c_result_rna_re',
    #                     subsample_ratio=1,rna=False,
    ...
    parser.set_defaults(function='f5c_re', chrom="NR_103073.1", pos=2030, len=10, strand='+', cpu=8,norm=True,base_shift=True,pore='r9',
                        input='../example/data/wt/file', control='../example/data/ivt/file', output='f5c_result_rna_re',
                        subsample_ratio=1,
                        ref="../example/data/23S_rRNA.fasta", rna=True)
    return parser
