...
def main():
                    ...
                    for (tax, kmer_count) in r1_kmer_positions_tuple:
                        ...
                        if tax in descendants_dict[kread[0]]:
                            try:
                                ...
                                print(sread_r1.query_name)
                                print(xmer)
                                print(sread_r1.is_read1)
                                print(sread_r1.seq)
                                # print(sread_r2.seq)
                                sys.exit()
    ...
    # taxa_nucleotides_df.to_csv("/data/scRNA_analysis/benchmark/Galeano2022_CELL_GEX/results/03.classifier/rmhost_classified_qc/6_MOI_100_GEX_S6/nucle.txt",sep="\t")
