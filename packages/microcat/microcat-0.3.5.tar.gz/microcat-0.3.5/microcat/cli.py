...
def config(
    ...
    if donwload_dir is not None and not edited:
        single_config = parse_yaml(single_config_file)
        single_config["params"]["align"]["donwload_dir"] = donwload_dir
        update_config(single_config_file, single_config_file, single_config)

        click.echo(f"Download Directory updated as '{donwload_dir}' path.")
