...
@cloud_sub_app.command(name='expose_db')
def expose_db_command(ctx: typer.Context) -> None:
    """
    Add your IP to the whitelist of the database and return the connection configs.
    """
