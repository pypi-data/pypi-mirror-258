...
class GenericCRUD(metaclass=MetaLogger, object=LOGGER_CRUD_CODE_OBJECT):
    ...
    def upsert(self, *, schema_name: str = None, table_name: str = None, data_json: dict = None) -> int:
        ...
        # TODO: process_insert_data_json should add created_user_id and updated_user_id ...
        columns, values, data_json = process_insert_data_json(data_json=data_json)
        # TODO: process_update_data_json should add updated_user_id and ... but not created_user_id
