# Generated by Django 5.0.2 on 2024-02-23 19:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('jobs_all', models.BooleanField(choices=[(True, 'Yes'), (False, 'No')], default=False)),
                ('credentials_all', models.BooleanField(choices=[(True, 'Yes'), (False, 'No')], default=False)),
                ('repositories_all', models.BooleanField(choices=[(True, 'Yes'), (False, 'No')], default=False)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated', models.DateTimeField(auto_now=True)),
                ('name', models.CharField(max_length=100)),
                ('rtype', models.PositiveSmallIntegerField(choices=[(1, 'Static'), (2, 'Git')])),
                ('time_update', models.DateTimeField(blank=True, default=None, null=True)),
                ...
                ('static_path', models.CharField(blank=True, default='/home/runner/work/ansible-webui/ansible-webui/src/ansible-webui', max_length=500, null=True)),
                ('git_origin', models.CharField(blank=True, default=None, max_length=100, null=True)),
                ('git_branch', models.CharField(blank=True, default=None, max_length=100, null=True)),
                ('git_isolate', models.BooleanField(choices=[(True, 'Yes'), (False, 'No')], default=False)),
                ('git_lfs', models.BooleanField(choices=[(True, 'Yes'), (False, 'No')], default=False)),
                ('git_limit_depth', models.PositiveIntegerField(blank=True, default=None, null=True)),
                ('git_hook_pre', models.CharField(blank=True, default=None, max_length=1000, null=True)),
                ('git_hook_post', models.CharField(blank=True, default=None, max_length=1000, null=True)),
                ('git_override_initialize', models.CharField(blank=True, default=None, max_length=1000, null=True)),
                ('git_override_update', models.CharField(blank=True, default=None, max_length=1000, null=True)),
                ('git_playbook_base', models.CharField(blank=True, default=None, max_length=300, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='SystemConfig',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('log_stdout', models.CharField(blank=True, default=None, max_length=300, null=True)),
                ('log_stderr', models.CharField(blank=True, default=None, max_length=300, null=True)),
                ('log_stdout_repo', models.CharField(blank=True, default=None, max_length=300, null=True)),
                ('log_stderr_repo', models.CharField(blank=True, default=None, max_length=300, null=True)),
        ...
        migrations.AddField(
            ...
            name='credentials',
            field=models.ManyToManyField(through='aw.JobCredentialsPermissionMapping', to='aw.jobglobalcredentials'),
        ),
        migrations.AddField(
            model_name='jobcredentialspermissionmapping',
            name='permission',
        ...
        migrations.AddField(
            ...
            name='job',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='aw.job'),
        ),
        migrations.AddField(
            model_name='jobpermissionmapping',
            name='permission',
        ...
        migrations.AddField(
            model_name='jobqueue',
            name='job',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='jobqueue_fk_job', to='aw.job'),
        ),
        migrations.AddField(
            model_name='jobqueue',
            name='user',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='jobqueue_fk_user', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='repo_fk_cred', to='aw.jobglobalcredentials'),
        ),
        migrations.AddField(
            model_name='jobrepositorypermissionmapping',
            name='repository',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='aw.repository'),
        ),
        migrations.AddField(
            model_name='jobpermission',
            name='repositories',
            field=models.ManyToManyField(through='aw.JobRepositoryPermissionMapping', to='aw.repository'),
        ),
        migrations.AddField(
            model_name='job',
            name='repository',
            field=models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='job_fk_repo', to='aw.repository'),
        ),
        migrations.AddConstraint(
            model_name='jobcredentialspermissionmapping',
        ...
        migrations.AddConstraint(
            model_name='repository',
            constraint=models.UniqueConstraint(fields=('name',), name='repo_name_unique'),
        ),
        migrations.AddConstraint(
            model_name='jobrepositorypermissionmapping',
            constraint=models.UniqueConstraint(fields=('repository', 'permission'), name='jobrepopermmap_unique'),
        ),
        migrations.AddConstraint(
            model_name='jobpermission',
