...
offsets = [rng.uniform(*offset_range) for _, _ in enumerate(frequencies)]
...
# Add some noise
noise = rng.normal(0, 0.5, (sample_num, sample_len))
...
denoised = tsdlr.denoise_linear_regression(samples, window_size, stride)
