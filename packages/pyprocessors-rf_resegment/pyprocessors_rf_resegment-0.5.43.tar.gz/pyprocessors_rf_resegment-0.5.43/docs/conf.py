...
import pyprocessors_rf_resegment


# -- Project information -----------------------------------------------------

project = "pyprocessors_rf_resegment"
copyright = "2021, Olivier Terrier"
author = "Olivier Terrier"
version = pyprocessors_rf_resegment.__version__
release = pyprocessors_rf_resegment.__version__
...
apidoc_module_dir = os.path.dirname(pyprocessors_rf_resegment.__file__)
