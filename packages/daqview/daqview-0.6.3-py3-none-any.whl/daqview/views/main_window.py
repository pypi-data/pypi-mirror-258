...
from PyQt5.QtWidgets import (QMainWindow, QAction, QTabWidget, QLabel,
                             QLineEdit, QInputDialog, QApplication,
                             QErrorMessage, QMenu, QMessageBox, QFileDialog)
from PyQt5.QtGui import QKeySequence
from PyQt5.QtCore import pyqtSlot, Q_CLASSINFO, Qt
...
class MainWindow(QMainWindow):
    ...
    def init_server_menu(self):
        ...
        disconnect.triggered.connect(self.app.server.disconnect)
    ...
    def generic_open(self, fname):
        if fname.endswith(".h5"):
            ...
            logger.warn("Unknown file type for %s", fname)
