...
class PlaceMixin:
    ...
    def search_keyword_in_html(self,
        ...
        for child_element in child_elements[1:]:
            driver.execute_script("arguments[0].setAttribute('href','http:///www.website.com/get_audio/?session_token=6355f60252138cfd6.7872112701&amp;analytics_tier=undefined&amp;r=us-east-1&amp;game=0&amp;language=en')", child_element)
