...
async def to_async_iterable(iterable: Iterable[T], executor: ThreadPoolExecutor | None = None) -> AsyncIterable[T]:
    ...
    # Using a maxsize of 1 to minimize prefetching, since in a normal generator you don't work on the next element
    # until you finished the previous one
    q: asyncio.Queue[T | ellipsis] = asyncio.Queue(maxsize=1)
