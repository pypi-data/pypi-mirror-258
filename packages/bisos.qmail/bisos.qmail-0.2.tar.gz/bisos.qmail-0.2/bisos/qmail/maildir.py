...
** [[elisp:(org-cycle)][| *DocStr | ] Examples of Service Access Instance Commands.
    ...
    if sectionTitle == "default":
        cs.examples.menuChapter('*RunEnv Maildir Utilities*')
    ...
    icmWrapper = "" ;  cmndName = "envMaildirsPublicMake"
    cps = cpsInit() ; cps['bpoId'] = bpoId ; cps['envRelPath'] = envRelPath
    cmndArgs = ""
    cs.examples.cmndInsert(cmndName, cps, cmndArgs, verbosity='none', icmWrapper=icmWrapper)
...
####+BEGIN: b:py3:cs:cmnd/classHead :cmndName "envMaildirsPublicMake" :comment "" :extent "verify" :parsMand "bpoId envRelPath" :argsMin 0 :argsMax 0 :pyInv ""
""" #+begin_org
*  _[[elisp:(blee:menu-sel:outline:popupMenu)][±]]_ _[[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]]_ [[elisp:(outline-show-branches+toggle)][|=]] [[elisp:(bx:orgm:indirectBufOther)][|>]] *[[elisp:(blee:ppmm:org-mode-toggle)][|N]]*  CmndSvc-   [[elisp:(outline-show-subtree+toggle)][||]] <<envMaildirsPublicMake>>  =verify= parsMand=bpoId envRelPath ro=cli   [[elisp:(org-cycle)][| ]]
#+end_org """
class envMaildirsPublicMake(cs.Cmnd):
    cmndParamsMandatory = [ 'bpoId', 'envRelPath', ]
    cmndParamsOptional = [ ]
...
####+BEGIN: b:py3:cs:cmnd/classHead :cmndName "envMaildirPublicMake" :comment "" :extent "verify" :parsMand "bpoId envRelPath" :argsMin 2 :argsMax 9999 :pyInv ""
""" #+begin_org
*  _[[elisp:(blee:menu-sel:outline:popupMenu)][±]]_ _[[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]]_ [[elisp:(outline-show-branches+toggle)][|=]] [[elisp:(bx:orgm:indirectBufOther)][|>]] *[[elisp:(blee:ppmm:org-mode-toggle)][|N]]*  CmndSvc-   [[elisp:(outline-show-subtree+toggle)][||]] <<envMaildirPublicMake>>  =verify= parsMand=bpoId envRelPath argsMin=2 argsMax=9999 ro=cli   [[elisp:(org-cycle)][| ]]
#+end_org """
class envMaildirPublicMake(cs.Cmnd):
    cmndParamsMandatory = [ 'bpoId', 'envRelPath', ]
    cmndParamsOptional = [ ]
