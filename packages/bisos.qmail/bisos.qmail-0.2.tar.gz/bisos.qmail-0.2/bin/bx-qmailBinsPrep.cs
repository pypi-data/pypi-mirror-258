...
####+END:
        ...
        cs.examples.menuChapter('*Qmail Bins Preps*')
        icmWrapper = "" ;  cmndName = "marmeeQmailBinsPrep"
...
####+BEGIN: b:py3:cs:cmnd/classHead :cmndName "marmeeQmailBinsPrep" :comment "" :extent "verify" :parsMand "" :argsMin 0 :argsMax 0 :pyInv ""
""" #+begin_org
*  _[[elisp:(blee:menu-sel:outline:popupMenu)][±]]_ _[[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]]_ [[elisp:(outline-show-branches+toggle)][|=]] [[elisp:(bx:orgm:indirectBufOther)][|>]] *[[elisp:(blee:ppmm:org-mode-toggle)][|N]]*  CmndSvc-   [[elisp:(outline-show-subtree+toggle)][||]] <<marmeeQmailBinsPrep>>  =verify= ro=cli   [[elisp:(org-cycle)][| ]]
#+end_org """
class marmeeQmailBinsPrep(cs.Cmnd):
    cmndParamsMandatory = [ ]
    cmndParamsOptional = [ ]
    cmndArgsLen = {'Min': 0, 'Max': 0,}
