...
metar = "METAR KJAC 142347Z AUTO 00000KT 10SM CLR 15/03 A3013 RMK AO2 SLP206 \
T01500033 10194 20150 53003="
# metar = "METAR KABC 121755Z AUTO 21016G24KT 180V240 1SM R11/P6000FT -RA BR BKN015 OVC025 06/04 A2990="
    ...
    if 'vsby' in decoded:
        ...
        if decoded['vsby']['value'] != '////':
            ...
            if decoded['vsby']['uom'] == '[mi_i]':
                ...
                output['prevailing_visibility'] = min(math.floor(vis_miles * 1609.34), 10224)
                print(f"visibility: {output['prevailing_visibility']}")
