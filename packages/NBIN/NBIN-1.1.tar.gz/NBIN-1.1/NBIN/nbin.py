...
def __parseNextCommand(nbinCode: bytes) -> tuple[Any, int]:
    ...
    match nbinCode[0]:
        ...
        case 0x16:
            ...
            offset: int = int.from_bytes(nbinCode[nameSize + MAX_COLLECTION_LEN + 2 : nameSize + MAX_COLLECTION_LEN + 5], signed=False)
...
def __parseNBINObj(data: NBIO_DATA) -> bytes:
    ...
    if T == Block:
        ...
        result = b'\x15' + len(pastResult).to_bytes(4, signed=False) + result
        return result
