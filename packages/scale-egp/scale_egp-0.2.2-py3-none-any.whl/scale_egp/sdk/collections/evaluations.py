...
from scale_egp.sdk.types.evaluation_configs import StudioEvaluationConfig, HumanEvaluationConfig
...
class EvaluationCollection(APIEngine):
    ...
    def create(
        ...
        evaluation_config: Union[StudioEvaluationConfig, HumanEvaluationConfig],
    ...
    def update(
        ...
        evaluation_config: Optional[Union[StudioEvaluationConfig]] = None,
        tags: Optional[Dict[str, Any]] = None,
    ) -> Evaluation:
        """
