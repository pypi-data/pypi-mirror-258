...
class EGPClient:
    ...
    def __init__(
        ...
        if self.account_id is None:
            ...
            #  intuitive logic
            self.account_id = self.users().who_am_i().accounts[0].account.id

    def user_info(self) -> UserInfoResponse:
        # TODO: this is an exception, should use collections instead
        print("This method will be deprecated soon. Please use the client.users().who_am_i() method instead.")
