...
Refer to the Terraform Registry for docs: [`data_aws_ssoadmin_application_providers`](https://registry.terraform.io/providers/hashicorp/aws/5.38.0/docs/data-sources/ssoadmin_application_providers).
'''
import abc
import builtins
import datetime
...
class DataAwsSsoadminApplicationProviders(
    ...
    def __init__(
        ...
        *,
        ...
        :param application_providers: application_providers block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.38.0/docs/data-sources/ssoadmin_application_providers#application_providers DataAwsSsoadminApplicationProviders#application_providers}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
...
class DataAwsSsoadminApplicationProvidersApplicationProviders:
    def __init__(
        ...
        *,
        ...
        '''
        :param display_data: display_data block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.38.0/docs/data-sources/ssoadmin_application_providers#display_data DataAwsSsoadminApplicationProviders#display_data}
        '''
        if __debug__:
