...
Event = Annotated[
    Union[DocumentReleaseEvent, PartReleaseEvent, FieldValueCalculationEvent, DummyEvent, EngineeringChangeRelease],
    Field(discriminator="name"),
]
EventData = Union[
    DocumentReleaseData, PartReleaseData, FieldValueCalculationData, DummyEventData, EngineeringChangeReleaseData
]
