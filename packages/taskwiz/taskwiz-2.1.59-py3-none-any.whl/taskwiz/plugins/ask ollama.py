...
from taskwiz.ollamachat import OllamaChat
from taskwiz.utils.ollama_models import ollama_models
...
config.addFunctionCall(name="ask_ollama", signature=functionSignature, method=ask_ollama)
