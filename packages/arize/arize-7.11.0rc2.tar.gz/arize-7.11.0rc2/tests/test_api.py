...
from arize.utils.casting import CastingError
...
def test_casting_success():
    ...
    record = c.log(
        ...
        features={
            "feature_str": STR_VAL,
            "feature_double": FLOAT_VAL,
            "feature_int": TypedValue(value=INT_VAL, type=ArizeTypes.FLOAT64),  # cast int to float
            "feature_bool": BOOL_VAL,
            "feature_None": None,
            "feature_str_lst": STR_LST_VAL,
        },
        tags={
            ...
            "tag_double": FLOAT_VAL,
            "tag_int": INT_VAL,
            "tag_bool": TypedValue(value=BOOL_VAL, type=ArizeTypes.STRING),  # cast bool to string
            "tag_bool2": TypedValue(value=BOOL_VAL, type=ArizeTypes.INT64),  # cast bool to int
            "tag_None": None,
        },
        embedding_features=inputs["embedding_features"],
    )
...
def test_casting_fail():
        ...
        _ = c.log(
            ...
            features={
                ...
                "feature_double": TypedValue(
                    value=FLOAT_VAL, type=ArizeTypes.INT64
            ...
            tags={
                ...
                "tag_int": INT_VAL,
                "tag_bool": TypedValue(
                    value=BOOL_VAL, type=ArizeTypes.STRING
                ),  # cast bool to string
                "tag_bool2": TypedValue(value=BOOL_VAL, type=ArizeTypes.INT64),  # cast bool to int
                "tag_None": None,
            },
    ...
    assert excinfo.value.input_value == FLOAT_VAL
    assert excinfo.value.attempted_casting_type == ArizeTypes.INT64
    assert excinfo.value.error_message() == (
        "Failed to cast value 20.2 of type <class 'float'> "
        "to type ArizeTypes.INT64. Error: Cannot convert float with "
