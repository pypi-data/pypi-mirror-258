...
from .utils.casting import cast_dictionary, cast_value
...
class Client:
    ...
    def log(
        ...
        features: Optional[Dict[str, Union[str, bool, float, int, TypedValue]]] = None,
        ...
        if features:
            ...
            for feat_name, feat_value in features.items():
                ...
                if is_list_of(feat_value, str):
                    ...
                    if isinstance(feat_value, TypedValue):
                        feat_value = cast_value(feat_value)
        ...
        if tags:
            ...
            for tag_name, tag_value in tags.items():
                ...
                if isinstance(tag_value, TypedValue):
                    tag_value = cast_value(tag_value)
        ...
        if prediction_label is not None:
            ...
            if tags or llm_run_metadata:
                ...
                joined_tags = cast_dictionary(joined_tags)
