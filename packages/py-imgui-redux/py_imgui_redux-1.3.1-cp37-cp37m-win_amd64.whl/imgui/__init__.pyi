...
def GetWindowWidth() -> float:
    pass
def Image(texID: int, size: Vec2, uv0: Vec2 = Vec2(0, 0), uv1: Vec2 = Vec2(1, 1), tint_col: Vec4 = Vec4(1, 1, 1, 1), border_col: Vec4 = Vec4(0, 0, 0, 0)) -> None:
    pass
def ImageButton(str_id: str, texID: int, size: Vec2, uv0: Vec2 = Vec2(0, 0), uv1: Vec2 = Vec2(1, 1), bg_col: Vec4 = Vec4(0, 0, 0, 0), tint_col: Vec4 = Vec4(1, 1, 1, 1)) -> bool:
    pass
