...
class Client(AsyncBaseClient):
    ...
    async def client_result(
        ...
        **kwargs: Any
        ...
        response = await self.execute(
            query=query, operation_name="clientResult", variables=variables, **kwargs
        )
        data = self.get_data(response)
        return ClientResult.model_validate(data)
    ...
    async def clients(
        ...
        **kwargs: Any
        ...
        response = await self.execute(
            query=query, operation_name="clients", variables=variables, **kwargs
        )
        data = self.get_data(response)
    ...
    async def device_group_result(
        ...
        **kwargs: Any
        ...
        data = self.get_data(response)
        return DeviceGroupResult.model_validate(data)
    ...
    async def device_result(
        ...
        **kwargs: Any
        ...
        response = await self.execute(
            query=query, operation_name="deviceResult", variables=variables, **kwargs
        )
        data = self.get_data(response)
        return DeviceResult.model_validate(data)
    ...
    async def devices(
        ...
        **kwargs: Any
        ...
        response = await self.execute(
            query=query, operation_name="devices", variables=variables, **kwargs
        )
        data = self.get_data(response)
    ...
    async def interface_result(
        ...
        **kwargs: Any
        ...
        response = await self.execute(
            query=query, operation_name="interfaceResult", variables=variables, **kwargs
        )
        data = self.get_data(response)
        return InterfaceResult.model_validate(data)
    ...
    async def interfaces(
        ...
        **kwargs: Any
        ...
        response = await self.execute(
            query=query, operation_name="interfaces", variables=variables, **kwargs
        )
        data = self.get_data(response)
