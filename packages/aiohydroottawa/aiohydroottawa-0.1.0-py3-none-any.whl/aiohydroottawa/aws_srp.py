...
class AWSSRP(object):
    NEW_PASSWORD_REQUIRED_CHALLENGE: Final = "NEW_PASSWORD_REQUIRED"
    PASSWORD_VERIFIER_CHALLENGE: Final = "PASSWORD_VERIFIER"
    ...
    async def authenticate_user(self, client: Any | None = None) -> dict[str, Any]:
        """authenticate user"""
        if client is None:
    ...
    def set_new_password_challenge(
        self, new_password: str, client: boto3.Session | None = None
