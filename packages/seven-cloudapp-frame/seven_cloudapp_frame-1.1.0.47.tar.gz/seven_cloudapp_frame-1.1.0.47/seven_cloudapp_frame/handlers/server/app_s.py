...
@LastEditTime: 2024-01-09 14:22:30
...
class InstantiateAppHandler(ClientBaseHandler):
    ...
    def get_async(self):
        ...
        if invoke_result_data.success == False:
            ...
            return self.response_json_error(invoke_result_data.error_code, invoke_result_data.error_message,invoke_result_data.data)
        ref_params = {}
        if not app_id and user_nick and is_multiple == 1:
            relation_app_list = []
            ...
            if len(app_info_list) > 0:
                ...
                for app_info in app_info_list:
                    ...
                    if app_template_dict and app_template_dict['client_ver'] != app_info.client_ver:
                        relation_invoke_result_data = top_base_model.version_upgrade(app_info.app_id, app_template_dict['template_id'], 
                                                                                     app_template_dict['client_ver'], access_token, app_key, app_secret, app_info, is_log)
                        if relation_invoke_result_data.success == False:
