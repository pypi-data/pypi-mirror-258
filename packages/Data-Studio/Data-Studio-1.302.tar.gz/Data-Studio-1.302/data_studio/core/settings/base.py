...
"""
"""
Django Base settings for Data Studio.
...
from data_studio.core.utils.params import get_bool_env, get_env
...
LOGGING = {
    ...
    'formatters': {
        'json': {
            '()': 'data_studio.core.utils.formatter.CustomJsonFormatter',
...
from data_studio.core.utils.io import get_data_dir
from data_studio.core.utils.params import get_bool_env, get_env, get_env_list_int
...
DJANGO_DB = 'default'
DATABASE_NAME_DEFAULT = os.path.join(BASE_DATA_DIR, 'data_studio.sqlite3')
...
DATABASES_ALL = {
    ...
    DJANGO_DB_MYSQL: {
        ...
        'NAME': get_env('MYSQL_NAME', 'data_studio'),
    ...
    'SECURITY_DEFINITIONS': {
        'Token': {
            ...
            'description':
                ...
                'You can find your user token on the User Account page in Data Studio. Example: '
                '<br><pre><code class="language-bash">'
                'curl https://data-studio-host/api/projects -H "Authorization: Token [your-token]"'
                '</code></pre>'
        }
    },
    'APIS_SORTER': 'alpha',
...
# Email backend
FROM_EMAIL = get_env('FROM_EMAIL', 'Data Studio <hello@labelstud.io>')
...
# EDITOR = data-studio-frontend repository
