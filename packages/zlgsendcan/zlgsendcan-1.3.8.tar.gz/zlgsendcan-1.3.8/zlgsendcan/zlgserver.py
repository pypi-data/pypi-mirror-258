...
if __name__ == '__main__':
    ...
    dbc_path = {'0': 'D:/广汽项目/A8E&GMC400_Proj_IHU_PFET_CMX V1.34.dbc'}
    # 信号变化等差发送只需将对应的信号值改成{'步长':1,'最大值':1,'最小值':0}
    # 如有crc校验，请自行将项目名添加到代码中，如：A88
    msgdata = {'GW_BCS_2_B': {'GW_BCS_2_B': {'BCS_VehSpdVD': '1', 'BCS_VehSpd': '111'}, 'cycle_time': 10,
                              'msg_id': '0x260(608)', 'is_crc': '1', 'chanl': '0', 'send_num': '-1'}}
    for k, v in msgdata.items():
        ZlgSend(zlg_init, v, dbc_path['0'], chanl=0, pro_name='A88')
