...
class Group(BaseModel):
    ...
    Attributes:
        ...
        icon (Optional[str]): An optional icon for the group. Must be one of the allowed icons.
...
class Config(BaseModel):
    ...
    Attributes:
        groups (Optional[List[Group]]): A list of Group objects. Ensures uniqueness of meta_keys and slugs among groups.
        owners (Optional[List[Owner]]): A list of Owner objects.

    Methods:
        validate_unique: Validates the uniqueness of meta_keys and slugs within the groups.
    """
    ...
    def validate_unique(cls, values):
        """
        Validates the uniqueness of 'meta_key' and 'slug' for each group in the groups list.
