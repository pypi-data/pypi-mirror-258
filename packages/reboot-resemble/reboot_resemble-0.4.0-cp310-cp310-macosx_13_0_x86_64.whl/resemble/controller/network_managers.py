...
class KubernetesNetworkManager:
    ...
    def __init__(
        ...
        self._consensus_address_by_name: dict[ConsensusId,
                                              ConsensusAddress] = {}
        self._consensus_id_by_service_name: dict[ServiceName, ConsensusId] = {}
    ...
    async def _write_routing_filters_for_mesh_traffic(
        ...
        for namespace in namespaces:
            ...
            routing_filter: EnvoyFilter = generate_istio_routing_filter(
                ...
                consensuses_by_service=self._consensus_id_by_service_name,
    ...
    async def _set_consensuses(self, consensuses: list[Consensus]):
        ...
        self._consensus_id_by_service_name = {
            service_name: consensus.id for consensus in consensuses
