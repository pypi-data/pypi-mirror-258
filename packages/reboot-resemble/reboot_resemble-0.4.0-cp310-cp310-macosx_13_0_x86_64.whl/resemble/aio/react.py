...
from resemble.aio.headers import ACTOR_ID_HEADER, SERVICE_NAME_HEADER, Headers
...
class ReactServicer(react_pb2_grpc.ReactServicer):
    ...
    async def serve(self, websocket):
        service_name = websocket.request_headers[SERVICE_NAME_HEADER]
        actor_id = websocket.request_headers[ACTOR_ID_HEADER]
