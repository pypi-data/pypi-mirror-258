...
def vhdl_make_simulation_intern(entity,BuildFolder = "build/"):  
    ...
    save_file(OutputPath+ "text_io_poll1_poll.txt","")
    save_file(OutputPath+ "text_io_poll1_write_poll.txt","")
    save_file(OutputPath+ "text_io_poll1_read.txt","")
    save_file(OutputPath+ "text_io_poll1_write.txt","")    
