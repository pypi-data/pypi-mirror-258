...
class PlanResult(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["tracedata", "project", "statistics", "warnings", "unplanned_items", "progress", "info"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "project": [Operation.from_dict(_item) for _item in obj["project"]] if obj.get("project") is not None else None,
            ...
            "info": CalculationInfo.from_dict(obj["info"]) if obj.get("info") is not None else None
        })
        return _obj
