...
# Crée le chemin donné en entrée si celui ci n'existe pas
def creer_dossiers_si_manquants(chemin):
        # il faut que le chemin soit absolu
        chemin_absolu = os.path.abspath(chemin)
        
        # creation des dossiers si manquants
        try:
            os.makedirs(chemin_absolu)
            print(f"Les dossiers pour le chemin {chemin_absolu} ont été créés avec succès.")
        except FileExistsError:
            print(f"Les dossiers pour le chemin {chemin_absolu} existent déjà.")
...
if __name__ == "__main__":
    ...
    # Création du chemin si celui donné n'est pas existant
    creer_dossiers_si_manquants(args.repertoire)
