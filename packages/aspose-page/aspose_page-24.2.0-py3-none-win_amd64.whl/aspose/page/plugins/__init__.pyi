...
class PsConverterToImageOptions(aspose.page.plugins.PsConverterOptions):
    ...
    @overload
    def __init__(self, image_format: aspose.pydrawing.Imaging.ImageFormat, size: aspose.pydrawing.Size):
    ...
    @property
    def image_format(self) -> aspose.pydrawing.Imaging.ImageFormat:
        '''Gets/sets the image type.'''
        ...
    
    @image_format.setter
    def image_format(self, value: aspose.pydrawing.Imaging.ImageFormat):
        ...
