        ...
        with self._send_footprints_lock:
            ...
            if not execution_is_active:
                if has_coverage_recorded:
                    log.info("Coverage is recorded but no execution is active. Will not send footprints")
                return
            try:
                if has_coverage_recorded:
                    ...
                    log.info("Execution is active but no coverage is recorded. Will not send footprints")
