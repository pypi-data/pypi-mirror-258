...
class APIResult:
    ...
    async def export(
        ...
        if min_observation_start_ts:
            ...
            request.min_observation_start_ts = min_observation_start_timestamp
        if max_observation_start_ts:
            ...
            request.max_observation_start_ts = max_observation_start_timestamp

        if analysis_computation_ids:
            # TODO implement
            pass
