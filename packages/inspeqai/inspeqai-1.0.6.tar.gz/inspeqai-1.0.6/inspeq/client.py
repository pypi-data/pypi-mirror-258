...
class Evaluator:
    def __init__(self, sdk_api_key, projectId=None):
    ...
    def make_api_request(self, endpoint, input_data):
        ...
        return requests.post(url, params=params, json=input_data, verify=False)
    ...
    def word_limit_test(self, input_data):
        ...
        response = requests.post(
            url, params=params, json=input_data,verify=False
        )
        response.raise_for_status()
