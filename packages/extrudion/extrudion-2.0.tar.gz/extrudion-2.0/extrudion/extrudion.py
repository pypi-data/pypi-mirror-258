...
def analyzeDirectory(folder_path: str = '.', options = {}):
    ...
    print('Please download the latest version at: ')
...
def start(folder_path: str = '.'):
    ...
    TRAFolder(folder_path).analyze({'sample_area': sample_area, 'initial_length': initial_length})
        
    print("*********************************************")
    print("                EXTRUDION")
    print("*********************************************")
    print()
    print("by Paride Azzari (C) 2023")
    print()
