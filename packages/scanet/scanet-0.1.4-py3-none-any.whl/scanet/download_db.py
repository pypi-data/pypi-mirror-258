...
def download_db():
    ...
    answer=input()
    dataset_human = "https://cloud.uni-hamburg.de/s/YCJkWqebaP5poLH/download/human.zip"
    dataset_mouse = "https://cloud.uni-hamburg.de/s/YCJkWqebaP5poLH/download/mouse.zip"
