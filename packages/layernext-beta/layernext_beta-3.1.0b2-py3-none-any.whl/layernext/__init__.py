...
# Initialize a logger for the entire package
...
class LayerNextClient:
    ...
    def retrieve_documents(
        ...
        """
        logger.info(f" sdk | retrieve_documents | document_categories:{document_categories}, document_search_keys:{document_search_keys}, chunk_search_keys:{chunk_search_keys}, page_index:{page_index}, page_size:{page_size}")
    ...
    def run_mongodb_aggregation(self, source_name: str, pipeline_stages, collection):
        ...
        """
        logger.info(f" sdk | run_mongodb_aggregation | source_name:{source_name}, pipeline_stages:{pipeline_stages}, collection:{collection}")
    ...
    def run_sql_query(self, source_name: str, query: str):
        ...
        logger.info(f" sdk | run_sql_query | source_name:{source_name}, query:{query}")
        _datalake_client = datalake.DatalakeClient(
            self.encoded_key_secret, self.layernext_url)
