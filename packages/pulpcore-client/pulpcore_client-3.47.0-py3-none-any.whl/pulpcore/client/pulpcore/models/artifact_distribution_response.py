...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, hidden=False, name=None, content_guard=None, base_path=None, base_url=None, pulp_href=None, pulp_created=None, pulp_labels=None, local_vars_configuration=None):  # noqa: E501
